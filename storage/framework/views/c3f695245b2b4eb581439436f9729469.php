    ...
    <div class="contract-container">
        ...
        <table class="table-container">
            <tr>
                ...
                <td class="agreement-number"><?php echo e($agreement->reference_no); ?></td>
            </tr>
        </table>
        ...
        <div class="clause-container">
            <div class="clause">
                <p>
                    ...
                    amounting to <strong><?php echo e(number_format($totalAmount, 2)); ?></strong> AED, in the following manner:<br>
                    - First payment of <strong><?php echo e(number_format($received, 2)); ?></strong> AED upon the worker’s request.<br>
                    - Second payment of <strong><?php echo e(number_format($remaining, 2)); ?></strong> AED on the date the worker is received.
                </p>
                <p>
                    ...
                    <strong><?php echo e(number_format($totalAmount, 2)); ?></strong> درهم، موزعة على دفعتين:<br>
                    - الدفعة الأولى: <strong><?php echo e(number_format($received, 2)); ?></strong> درهم عند طلب العامل.<br>
                    - الدفعة الثانية: <strong><?php echo e(number_format($remaining, 2)); ?></strong> درهم عند استلام العامل.
                </p>
            </div>
            <div class="clause">
                <p>
...
<?php /**PATH /var/www/developmentoneso-project/resources/views/agreements/outside_agreement.blade.php ENDPATH**/ ?>