...
<div class="row g-3">
    ...
    <table class="table table-sm table-bordered mb-2">
      <tbody>
        <tr>
          ...
          <td style="width:25%"><?php echo e($startDate ?? '-'); ?></td>
          <th style="width:25%">Agreement End Date</th>
          <td style="width:25%"><?php echo e($endDate ?? '-'); ?></td>
        </tr>
        <tr>
          <th>Total Amount</th>
          <td><?php echo e(number_format($agreementTotalAmount, 2, '.', '')); ?></td>
          <th>Received Amount</th>
          <td><?php echo e(number_format($agreementReceivedAmount, 2, '.', '')); ?></td>
        </tr>
      </tbody>
    </table>
  </div>

  <input type="hidden" class="js-trial-start" name="trial_start_date" value="<?php echo e($startDate); ?>">
  <div class="col-md-4">
    <label class="form-label">LC No</label>
    <input type="text" class="form-control" value="<?php echo e($lcNo ?? ''); ?>" readonly>
  </div>
  <div class="col-md-4">
    <label class="form-label">Return Date</label>
    <input type="date" class="form-control js-trial-return" name="trial_return_date" value="<?php echo e($endDate); ?>" required>
  </div>
  <div class="col-md-4">
  ...
  <div class="col-md-4">
    ...
    <select class="form-select js-reason-select">
      ...
      <?php $__currentLoopData = $refundReasons; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rr): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <option value="<?php echo e($rr); ?>"><?php echo e($rr); ?></option>
  ...
  <div class="col-md-4">
    ...
    <input type="number" step="0.01" min="0" name="total_paid_amount" class="form-control js-total-paid" value="<?php echo e(number_format($basePaidAmount, 2, '.', '')); ?>">
  </div>
  ...
  <div class="col-md-4">
    ...
    <input type="number" step="0.01" min="0" class="form-control js-salary-amount" name="maid_salary" value="<?php echo e(number_format($maidSalary, 2, '.', '')); ?>">
  </div>
  ...
  <input type="hidden" class="js-balance-base" value="<?php echo e(number_format($basePaidAmount, 2, '.', '')); ?>">

  <div class="col-md-4">
    <label class="form-label">Refund Balance</label>
    <input type="number" step="0.01" min="0" class="form-control js-final" name="refund_balance" value="<?php echo e(number_format($initialRefundBalance, 2, '.', '')); ?>">
  </div>
...
<?php /**PATH /var/www/developmentoneso-project/resources/views/package/package/partials/refund_view.blade.php ENDPATH**/ ?>