...
<div class="row g-3">
  ...
  <div class="col-md-4">
    ...
    <input type="date" class="form-control js-trial-return" name="trial_return_date" value="<?php echo e($endDate); ?>">
  </div>
  ...
  <div class="col-md-4">
    ...
    <input type="number" step="0.01" class="form-control js-salary-amount" name="replacement_worker_salary_amount" value="<?php echo e(number_format($replacementWorkerSalaryAmount, 2, '.', '')); ?>">
  </div>
  ...
  <input type="hidden" class="js-balance-base" value="<?php echo e(number_format($replacementBalanceValue, 2, '.', '')); ?>">

  <div class="col-md-4">
    <label class="form-label">Replacement Balance</label>
    <input type="number" step="0.01" class="form-control js-final" name="replacement_balance" value="<?php echo e(number_format($replacementBalanceValue, 2, '.', '')); ?>">
  </div>
...
<?php /**PATH /var/www/developmentoneso-project/resources/views/package/package/partials/replacement_view.blade.php ENDPATH**/ ?>