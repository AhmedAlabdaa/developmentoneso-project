  ...
  <table class="table table-striped table-hover">
    ...
    <tbody>
      <?php $__empty_1 = true; $__currentLoopData = $salaries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
        ...
        <tr id="row-cand-<?php echo e($candidateId); ?>" data-candidate-id="<?php echo e($candidateId); ?>">
          <td><?php echo e($candidate); ?></td>
          <td><?php echo e($passport); ?></td>
          <td><?php echo e($nationality); ?></td>
          <td><?php echo e($clientName); ?></td>
          <td><?php echo e($decision); ?></td>
          <td class="text-center"><?php echo e($numberOfSalaries); ?></td>
          <td class="text-center"><?php echo e($workedDays); ?></td>
          <td class="text-right js-paid" data-paid="<?php echo e($paidAmountRaw); ?>"><?php echo e($paidAmount); ?></td>
          <td class="text-right js-balance" data-balance="<?php echo e($balanceRaw); ?>"><?php echo e($balance); ?></td>
          <td><?php echo e($salaryType); ?></td>
          <td><span class="badge js-status <?php echo e($statusClass); ?>"><?php echo e($statusLabel); ?></span></td>
          <td><?php echo e($created); ?></td>

          <td class="text-center">
            <button type="button" class="action-btn btn-view-salary-slip" data-candidate-id="<?php echo e($candidateId); ?>" data-url="<?php echo e(route('salaries.slip', $candidateId)); ?>" title="View salary slip">
              <i class="fa fa-eye"></i>
            </button>

            <button type="button" class="action-btn btn-add-salary" title="Add salary payment" data-candidate-id="<?php echo e($candidateId); ?>" data-pay-url="<?php echo e(route('salaries.pay', $candidateId)); ?>" data-slip-url="<?php echo e(route('salaries.slip', $candidateId)); ?>" data-candidate="<?php echo e($candidate); ?>" data-passport="<?php echo e($passport); ?>" data-nationality="<?php echo e($nationality); ?>" data-client="<?php echo e($clientName); ?>" data-salaryto="<?php echo e($salaryType); ?>" data-balance="<?php echo e($balanceRaw); ?>">
...
<nav aria-label="Page navigation">
  <div class="pagination-container">
    <span class="muted-text">Showing <?php echo e($salaries->firstItem()); ?> to <?php echo e($salaries->lastItem()); ?> of <?php echo e($salaries->total()); ?> results</span>
...
<?php /**PATH /var/www/developmentoneso-project/resources/views/package/package/partials/salaries_table.blade.php ENDPATH**/ ?>