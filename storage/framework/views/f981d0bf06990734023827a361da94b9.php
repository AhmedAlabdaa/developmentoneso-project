    ...
    <div class="card shadow-sm">
      <div class="card-header p-3 p-md-4">
        <div class="header-row">
          ...
          <div class="toolbar">
            <a href="<?php echo e(route('crm.index')); ?>" class="btn btn-outline-secondary btn-sm btn-icon"><i class="fa-solid fa-arrow-left"></i><span>Back</span></a>
            <a href="<?php echo e(route('crm.edit', $crm->slug)); ?>" class="btn btn-primary btn-sm btn-icon"><i class="fa-solid fa-pen-to-square"></i><span>Edit</span></a>
            <form action="<?php echo e(route('crm.destroy', $crm->slug)); ?>" method="POST" class="d-inline">
              <?php echo csrf_field(); ?>
      ...
      <div class="card-body p-3 p-md-4">
        <div class="tab-content" id="crmTabContent">
            ...
            <div class="row g-4">
              <div class="col-12 col-lg-6">
                ...
                <div class="table-container">
                  <table class="table">
                    <tbody>
                      <tr><th class="w-220">Customer ID</th><td class="text-mono"><?php echo e($crm->cl); ?></td></tr>
                      <tr><th>Name</th><td><?php echo e($crm->first_name); ?> <?php echo e($crm->last_name); ?></td></tr>
                      <tr><th>Slug</th><td class="text-mono"><?php echo e($crm->slug); ?></td></tr>
                      <tr><th>Address</th><td><?php echo e($crm->address); ?></td></tr>
                      <tr><th>Nationality</th><td><?php echo e($crm->nationality); ?></td></tr>
                      <tr><th>Email</th><td><?php echo e($crm->email ?? 'N/A'); ?></td></tr>
                      <tr><th>Mobile</th><td class="text-mono"><?php echo e($crm->mobile); ?></td></tr>
                      <tr><th>Emirates ID</th><td class="text-mono"><?php echo e($crm->emirates_id); ?></td></tr>
                      <tr><th>Emergency Contact</th><td><?php echo e($crm->emergency_contact_person ?? 'N/A'); ?></td></tr>
                      <tr><th>Source</th><td><?php echo e($crm->source ?? 'N/A'); ?></td></tr>
                      <tr>
                        <th>Passport Copy</th>
                        <td>
                          <a href="#" class="link-primary doc-preview"
                             data-title="Passport Copy"
                             data-url="<?php echo e(asset('storage/' . $crm->passport_copy)); ?>"
                             data-filename="passport_<?php echo e($crm->cl); ?>">View Passport Copy</a>
                        </td>
                      </tr>
                      <tr>
                        ...
                        <td>
                          <a href="#" class="link-primary doc-preview"
                             ...
                             data-url="<?php echo e(asset('storage/' . $crm->id_copy)); ?>"
                             data-filename="id_<?php echo e($crm->cl); ?>">View ID Copy</a>
                        </td>
                      </tr>
                    </tbody>
                  </table>
              ...
              <div class="col-12 col-lg-6">
                ...
                <div class="summary-grid p-3 rounded-3 border">
                  ...
                  <div class="text-mono"><?php echo e($crm->created_at->format('l, F d, Y h:i A')); ?></div>
                  <div></div>
                  <div class="label">Last Updated</div>
                  <div class="text-mono"><?php echo e($crm->updated_at->format('l, F d, Y h:i A')); ?></div>
                  <div></div>
              ...
              <table class="table">
                ...
                <tbody>
                  <?php $__empty_1 = true; $__currentLoopData = $agreements; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $agreement): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr>
                      <td class="text-mono"><?php echo e($agreement->reference_no); ?></td>
                      <td><?php echo e($agreement->candidate_name); ?></td>
                      <td class="text-end text-mono"><?php echo e(number_format($num($agreement->package),2)); ?></td>
                      ...
                      <td><?php echo e($agreement->status); ?></td>
                      <td><?php echo e(\Carbon\Carbon::parse($agreement->created_at)->format('d M Y')); ?></td>
                      <td><a href="<?php echo e(route('agreements.show', $agreement->reference_no ?? '')); ?>" target="_blank" rel="noopener" class="btn btn-sm btn-primary"><i class="fa-solid fa-eye"></i></a></td>
                    </tr>
              ...
              <table class="table">
                ...
                <tbody>
                  <?php $__empty_1 = true; $__currentLoopData = $contracts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr>
                      <td class="text-mono"><?php echo e($c->contract_number); ?></td>
                      <td><?php echo e($c->title); ?></td>
                      <td><?php echo e(\Carbon\Carbon::parse($c->start_date)->format('d M Y')); ?></td>
                      <td><?php echo e(\Carbon\Carbon::parse($c->end_date)->format('d M Y')); ?></td>
                      <td><?php echo e($c->status); ?></td>
                      <td><?php echo e(\Carbon\Carbon::parse($c->created_at)->format('d M Y')); ?></td>
                      <td><a href="<?php echo e(route('contracts.show', $c->contract_number ?? '')); ?>" target="_blank" rel="noopener" class="btn btn-sm btn-primary"><i class="fa-solid fa-eye"></i></a></td>
                    </tr>
                  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
          ...
          <div class="tab-pane fade" id="invoices" role="tabpanel" aria-labelledby="invoices-tab">
            <div class="mb-2"><span class="badge bg-light text-dark border">Tax Total: <?php echo e(number_format($invTotals['tax_total'],2)); ?></span> <span class="badge bg-light text-dark border">Proforma Receipts: <?php echo e(number_format($invTotals['proforma_received'],2)); ?></span> <span class="badge bg-light text-dark border">Grand Received: <?php echo e(number_format($invTotals['grand_received'],2)); ?></span></div>
            <div class="table-container">
              <table class="table">
                <thead>
                  <tr>
                ...
                <tbody>
                  <?php $__empty_1 = true; $__currentLoopData = $invoices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $invoice): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <?php $type = strtolower($invoice->invoice_type ?? $invoice->type ?? '') === 'proforma' ? 'Proforma' : 'Tax'; ?>
                    <tr>
                      <td class="text-mono"><?php echo e($invoice->invoice_number); ?></td>
                      <td><?php echo e($type); ?></td>
                      <td class="text-end text-mono"><?php echo e(number_format($num($type==='Tax' ? $invoice->total_amount : 0),2)); ?></td>
                      <td class="text-end text-mono"><?php echo e(number_format($num($invoice->received_amount),2)); ?></td>
                      <td class="text-end text-mono"><?php echo e(number_format($num($type==='Tax' ? $invoice->balance_due : 0),2)); ?></td>
                      <td><?php echo e($invoice->status); ?></td>
                      <td><?php echo e(\Carbon\Carbon::parse($invoice->invoice_date)->format('d M Y')); ?></td>
                      <td><a href="<?php echo e(route('invoices.show', $invoice->invoice_number ?? '')); ?>" target="_blank" rel="noopener" class="btn btn-sm btn-primary"><i class="fa-solid fa-eye"></i></a></td>
                    </tr>
                  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                ...
                <tfoot>
                  <tr>
                    ...
                    <td class="text-end text-mono"><?php echo e(number_format($invTotals['tax_total'],2)); ?></td>
                    <td class="text-end text-mono"><?php echo e(number_format($invTotals['grand_received'],2)); ?></td>
                    <td class="text-end text-mono"><?php echo e(number_format($invTotals['grand_balance'],2)); ?></td>
                    <td colspan="3"></td>
                  </tr>
                </tfoot>
              </table>
          ...
          <div class="tab-pane fade" id="govt" role="tabpanel" aria-labelledby="govt-tab">
            <div class="table-container">
              <table class="table">
                ...
                <tbody>
                  <?php $__empty_1 = true; $__currentLoopData = $govtTransactions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $transaction): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr>
                      <td class="text-mono"><?php echo e($transaction->invoice_number); ?></td>
                      <td><?php echo e($transaction->candidate_name); ?></td>
                      <td class="text-end text-mono"><?php echo e(number_format($num($transaction->total_amount),2)); ?></td>
                      <td class="text-end text-mono"><?php echo e(number_format($num($transaction->received_amount),2)); ?></td>
                      <td class="text-end text-mono"><?php echo e(number_format($num($transaction->remaining_amount),2)); ?></td>
                      <td><?php echo e($transaction->status); ?></td>
                      <td><?php echo e(\Carbon\Carbon::parse($transaction->invoice_date)->format('d M Y')); ?></td>
                      <td><a href="<?php echo e(route('govt-transactions.show', $transaction->invoice_number ?? '')); ?>" target="_blank" rel="noopener" class="btn btn-sm btn-primary"><i class="fa-solid fa-eye"></i></a></td>
                    </tr>
                  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                    <tr><td colspan="8" class="text-center py-4 subtle">No government transactions available.</td></tr>
                  <?php endif; ?>
                </tbody>
                <?php if($govtTransactions->isNotEmpty()): ?>
                  <?php
                  ...
                  <tfoot>
                    <tr>
                      <td colspan="2">Totals</td>
                      <td class="text-end text-mono"><?php echo e(number_format($govtTotal,2)); ?></td>
                      <td class="text-end text-mono"><?php echo e(number_format($govtReceived,2)); ?></td>
                      <td class="text-end text-mono"><?php echo e(number_format($govtBalance,2)); ?></td>
                      <td colspan="3"></td>
                    </tr>
                  </tfoot>
                <?php endif; ?>
          ...
          <div class="tab-pane fade printable" id="statement" role="tabpanel" aria-labelledby="statement-tab">
            <form id="statement-filter" class="row g-2 align-items-end mb-3" method="GET" action="<?php echo e(route('crm.show', $crm->slug)); ?>" data-url="<?php echo e(route('crm.show', $crm->slug)); ?>" data-default-from="<?php echo e($periodStart->format('Y-m-d')); ?>" data-default-to="<?php echo e($periodEnd->format('Y-m-d')); ?>">
              <div class="col-auto">
                <label class="form-label mb-0">From</label>
                <input type="date" name="from" value="<?php echo e($periodStart->format('Y-m-d')); ?>" class="form-control form-control-sm">
              </div>
              <div class="col-auto">
                <label class="form-label mb-0">To</label>
                <input type="date" name="to" value="<?php echo e($periodEnd->format('Y-m-d')); ?>" class="form-control form-control-sm">
              </div>
              <div class="col-auto">
            ...
            <div id="statement-area">
              <div class="d-flex justify-content-between align-items-start mb-3">
                <div>
                  ...
                  <div class="subtle">Period: <?php echo e($periodStart->format('j-M-Y')); ?> – <?php echo e($periodEnd->format('j-M-Y')); ?></div>
                  <div class="subtle">Customer: <?php echo e($crm->first_name); ?> <?php echo e($crm->last_name); ?></div>
                ...
                <div class="text-end">
                  <div class="subtle">Printed at: <?php echo e($printedAt); ?></div>
                  <div class="subtle">Printed by: <?php echo e($printedBy); ?></div>
                </div>
              </div>
                ...
                <table class="table">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td class="text-mono"><?php echo e($periodStart->format('j-M-Y')); ?></td>
                      <td>Open Balance</td>
                      <td class="text-end text-mono"><?php echo e(number_format(max($running,0),2)); ?></td>
                      <td class="text-end text-mono"><?php echo e(number_format(max(-$running,0),2)); ?></td>
                      <td class="text-end text-mono"><?php echo e(number_format($running,2)); ?></td>
                    </tr>
                    <?php $__currentLoopData = $statementEntries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      <?php
                        $d = (float)($row->debit ?? 0);
                      ...
                      <tr>
                        ...
                        <td class="text-mono"><?php echo e($row->number ?? ''); ?></td>
                        <td class="text-mono"><?php echo e(\Carbon\Carbon::parse($row->date)->format('j-M-Y')); ?></td>
                        <td><?php echo e($row->remarks ?? ''); ?></td>
                        <td class="text-end text-mono"><?php echo e(number_format($d,2)); ?></td>
                        <td class="text-end text-mono"><?php echo e(number_format($c,2)); ?></td>
                        <td class="text-end text-mono"><?php echo e(number_format($running,2)); ?></td>
                      </tr>
                  ...
                  <tfoot>
                    <tr>
                      ...
                      <td class="text-end text-mono"><?php echo e(number_format($debitTotal + max($openingBalance,0),2)); ?></td>
                      <td class="text-end text-mono"><?php echo e(number_format($creditTotal + max(-$openingBalance,0),2)); ?></td>
                      <td class="text-end text-mono"><?php echo e(number_format($running,2)); ?></td>
                    </tr>
                  </tfoot>
                </table>
...
<?php /**PATH /var/www/developmentoneso-project/resources/views/crm/show.blade.php ENDPATH**/ ?>