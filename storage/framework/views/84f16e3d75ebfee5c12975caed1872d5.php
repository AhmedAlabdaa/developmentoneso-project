...
<head>
  ...
  <meta content="Dashboard page for Finance Manager application" name="description">
  <meta content="dashboard, Finance Manager" name="keywords">
...
<body class="toggle-sidebar">
    ...
    <aside id="sidebar" class="sidebar">
        <ul class="sidebar-nav" id="sidebar-nav">
            ...
            <li class="nav-item">
              <a class="nav-link <?php echo e(request()->is('invoices') || request()->is('gov-transactions') || request()->is('payroll') ? '' : 'collapsed'); ?>" data-bs-target="#finance-nav" data-bs-toggle="collapse" href="#">
                <i class="bi bi-bank2"></i>
                <span>Finance</span>
                <i class="bi bi-chevron-down ms-auto"></i>
              </a>
              <ul id="finance-nav" class="nav-content collapse <?php echo e(request()->is('invoices') || request()->is('gov-transactions') || request()->is('payroll') ? 'show' : ''); ?>" data-bs-parent="#sidebar-nav">
                <li>
                  <a href="<?php echo e(url('invoices')); ?>" class="<?php echo e(request()->is('invoices') ? 'active' : ''); ?>">
                    <i class="bi bi-receipt-cutoff"></i>
                    <span>Invoices</span>
                  </a>
                </li>
                <li>
                  <a href="<?php echo e(url('gov-transactions')); ?>" class="<?php echo e(request()->is('gov-transactions') ? 'active' : ''); ?>">
                    <i class="bi bi-file-earmark-dollar"></i>
                    <span>G.Transaction</span>
                  </a>
                </li>
                <li>
                  <a href="<?php echo e(url('payroll')); ?>" class="<?php echo e(request()->is('payroll') ? 'active' : ''); ?>">
                ...
                <div class="col-lg-12">
                    <nav class="horizontal-nav card flex-fill">
                        <ul class="nav justify-content-center">
                            ...
                            <li class="nav-item">
                                <a class="nav-link text-center <?php echo e(request()->is('activities') ? 'active' : ''); ?>" href="<?php echo e(url('activities')); ?>">
                                    <i class="bi bi-calendar-check-fill display-6"></i>
                                    <span class="d-block">Activities</span>
                                </a>
                            </li>
                            <li class="nav-item">
                              <a class="nav-link text-center <?php echo e(request()->routeIs('employees.inside') && request('package')==='PKG-2' ? 'active' : ''); ?>" href="<?php echo e(route('employees.inside', ['package' => 'PKG-2'])); ?>"
                              >
...
<?php /**PATH /var/www/developmentoneso-project/resources/views/layout/Cashier_header.blade.php ENDPATH**/ ?>