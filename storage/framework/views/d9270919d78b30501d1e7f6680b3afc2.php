                ...
                <tr class="<?php echo e($candidate->appeal == 1 ? 'table-warning appeal-row' : ''); ?>">
                    ...
                    <td class="align-middle">
                      <a style="color: #007bff !important;" href="<?php echo e(route('candidates.show', $candidate->reference_no)); ?>" target="_blank" class="text-decoration-none text-dark">
                        <?php echo e($candidate->candidate_name 
                           ? strtoupper(\Illuminate\Support\Str::title(strtolower($candidate->candidate_name))) 
                           : 'N/A'); ?>
...
<?php /**PATH /var/www/developmentoneso-project/resources/views/candidates/partials/candidates_table_1.blade.php ENDPATH**/ ?>