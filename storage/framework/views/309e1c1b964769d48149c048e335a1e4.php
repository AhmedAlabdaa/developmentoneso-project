...
<body>
    <div class="contract-container">
        ...
        <table class="solid-table-container">
            <tr>
                <td>
                    <input type="text" value="<?php echo e($agreement->client->first_name); ?> <?php echo e($agreement->client->last_name); ?>">
                </td>
                <td><strong>اسم العميل<br>CUSTOMER NAME</strong></td>
                <td rowspan="7" class="vertical-text">Second Party الطرف الثاني</td>
                <td>
                    <input type="text" value="مركز االبداع لخدمات العمالة المساعدة">
                </td>
            ...
            <tr>
                <td>
                    <input type="text" value="<?php echo e($agreement->client->emirates_id); ?>">
                </td>
                <td><strong>رقم الهوية<br>ID NUMBER</strong></td>
                <td>
                    <input type="text" value="800-32332">
                </td>
                <td><strong>رقم الهاتف<br>Phone Number</strong></td>
            </tr>
            <tr>
                <td>
                    <input type="text" value="<?php echo e($agreement->client->address); ?>">
                </td>
                <td><strong>العنوان<br>ADDRESS</strong></td>
                <td>
                    <input type="text" value=" دبي -القرهود">
                </td>
                <td><strong>العنوان<br>Address</strong></td>
            </tr>
            <tr>
                <td>
                    <input type="text" value="<?php echo e($agreement->client->passport_number); ?>">
                </td>
                <td><strong>رقم الجواز<br>PASSPORT NUMBER</strong></td>
                <td>
                    <input type="text" value="admin@tadbeer-alebdaa.com">
                </td>
            ...
            <tr>
                <td>
                    <input type="text" value="<?php echo e($agreement->client->nationality); ?>">
                </td>
            ...
            <tr>
                <td>
                    <input type="text" value="<?php echo e($agreement->client->mobile); ?>">
                </td>
                <td><strong>رقم الهاتف<br>PHONE NUMBER</strong></td>
            ...
            <tr>
                <td>
                    <input style="width:200px;" type="text" value="<?php echo e($agreement->client->email); ?>">
                </td>
        ...
        <div class="terms-container">
            <div class="terms">
                <ul>
                    ...
                    <li>The First Party commits to providing a domestic helper registration service under the sponsorship of the First Party, who will handle the work permit and residency for the domestic helper for a period of two years in exchange for an upfront fee agreed upon as: <?php echo e($totalAmount); ?> AED.</li>
                    ...
                    <li>Handling the work contract/work card/visa issuance/status adjustment/medical examination/ID card/residency for two years.</li>
                    <li><strong>3 - Salaries:</strong></li>
                    <li>The First Party pays the worker's salary, which amounts to <?php echo e($agreement->salary); ?> AED per month through the Wage Protection System.</li>
                    ...
                    <li>The First Party is responsible for the worker's medical treatment at their expense for the duration of their work with them.</li>
                ...
                <ul class="rtl">
                    ...
                    <li>يتعهد الطرف الأول بتقديم خدمة تسجيل مساعد منزلي تحت كفالته، الذي سيتولى تصريح العمل والإقامة للعامل المساعد لمدة سنتين مقابل رسوم مسبقة يتم الاتفاق عليها بمبلغ: <?php echo e($totalAmount); ?>درهم إماراتي.</li>
                    ...
                    <li>إتمام الإجراءات المتعلقة بعقد العمل/بطاقة العمل/إصدار التأشيرة/تعديل الوضع/الفحص الطبي/بطاقة الهوية/الإقامة لمدة سنتين.</li>
                    <li><strong>3 - الرواتب:</strong></li>
                    <li>يتعهد الطرف الأول بدفع راتب العامل المساعد، والذي يبلغ  <?php echo e($agreement->salary); ?> درهم إماراتي شهريًا من خلال نظام حماية الأجور.</li>
                    <li>يدفع الطرف الثاني الرواتب للطرف الأول شهريًا، بالإضافة إلى رسم إداري قدره 160 درهم إماراتي.</li>
                    ...
                    <li>يتعهد الطرف الأول بتحمل تكاليف علاج العامل طوال فترة عمله معهم.</li>
...
<?php /**PATH /var/www/developmentoneso-project/resources/views/agreements/package4_agreement.blade.php ENDPATH**/ ?>