      ...
      <div class="card-body">
        ...
        <div class="table-responsive">
          <table id="is-table" class="table table-striped table-hover align-middle">
            ...
            <tbody>
              <?php $__currentLoopData = $invoiceServices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $is): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <?php
              ...
              ?>
              <tr>
                <td><?php echo e($is->id); ?></td>
                <td><?php echo e($is->name); ?></td>
                <td><?php echo e($is->code); ?></td>
                ...
                <td><?php echo e($firstName($is->creator)); ?></td>
                <td><?php echo e($is->created_at->format('Y-m-d')); ?></td>
                <td class="text-center">
                  <button class="btn btn-info btn-sm edit-btn" data-bs-toggle="modal" data-bs-target="#isModal"
                          data-id="<?php echo e($is->id); ?>"
                          data-name="<?php echo e($is->name); ?>"
                          data-code="<?php echo e($is->code); ?>"
                          data-note="<?php echo e($is->note); ?>"
                          data-status="<?php echo e($is->status); ?>"
                          data-type="<?php echo e($is->type); ?>"
        ...
        <div class="mt-3">
          <?php echo e($invoiceServices->links('pagination::bootstrap-5')); ?>
...
<?php /**PATH /var/www/developmentoneso-project/resources/views/invoice_services/index.blade.php ENDPATH**/ ?>