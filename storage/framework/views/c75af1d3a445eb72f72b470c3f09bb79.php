...
<head>
  ...
  <meta content="Dashboard page for Administrator application" name="description">
  <meta content="dashboard, Administrator" name="keywords">
...
<body class="toggle-sidebar">
    ...
    <aside id="sidebar" class="sidebar">
        <ul class="sidebar-nav" id="sidebar-nav">
            ...
            <?php
                $activeHrm = request()->is('staff') || request()->is('staff-visa') || request()->is('staff-payroll');
            ?>
            <li class="nav-item">
                ...
                <div class="col-lg-12">
                    <nav class="horizontal-nav card flex-fill">
                        <ul class="nav justify-content-center">
                            ...
                            <li class="nav-item">
                                <a class="nav-link text-center <?php echo e(request()->is('candidates/new') ? 'active' : ''); ?>" href="<?php echo e(url('candidates/outside')); ?>">
                                    <i class="bi bi-people display-6"></i>
                                    <span class="d-block">Candidates</span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link text-center <?php echo e(request()->is('package') ? 'active' : ''); ?>" href="<?php echo e(url('package')); ?>">
                                    <i class="bi bi-box display-6"></i>
                                    <span class="d-block">Package</span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link text-center <?php echo e(request()->is('crm') ? 'active' : ''); ?>" href="<?php echo e(url('crm')); ?>">
                                    <i class="bi bi-folder display-6"></i>
                                    <span class="d-block">CRM</span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link text-center <?php echo e(request()->is('agreements') ? 'active' : ''); ?>" href="<?php echo e(url('agreements')); ?>">
                                    <i class="bi bi-check2-circle display-6"></i>
                                    <span class="d-block">Agreements</span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link text-center <?php echo e(request()->is('invoices') ? 'active' : ''); ?>" href="<?php echo e(url('invoices')); ?>">
                                    <i class="bi bi-receipt display-6"></i>
                                    <span class="d-block">Invoices</span>
                                </a>
                            </li>
                            <li class="nav-item">
...
<?php /**PATH /var/www/developmentoneso-project/resources/views/layout/Administrator_header.blade.php ENDPATH**/ ?>