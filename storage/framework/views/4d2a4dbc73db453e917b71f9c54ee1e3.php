          ...
          <div class="row">
            ...
            <div class="col-md-6 mb-3">
              ...
              <select class="form-select" id="spacial" name="spacial" required>
                <?php $__currentLoopData = \App\Enum\Spacial::cases(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $spacial): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($spacial->value); ?>"><?php echo e($spacial->label()); ?></option>
...
<?php /**PATH /var/www/developmentoneso-project/resources/views/components/ledgers/form-modal.blade.php ENDPATH**/ ?>