      ...
      <div class="card-body mt-2">
        ...
        <div class="toolbar">
          ...
          <div class="toolbar-right">
            ...
            <a href="<?php echo e(route('crm.create')); ?>" class="btn btn-outline-info btn-sm">
              <i class="fas fa-user-plus"></i> Add Customer
            </a>

            <a href="<?php echo e(route('govt-transactions.create')); ?>" class="btn btn-create btn-sm">
...
<script>
const routes={
  index:'<?php echo e(route("govt-transactions.index")); ?>',
  export:'<?php echo e(route("govt-transactions.export")); ?>'
};
...
<?php /**PATH /var/www/developmentoneso-project/resources/views/govt_transactions/index.blade.php ENDPATH**/ ?>