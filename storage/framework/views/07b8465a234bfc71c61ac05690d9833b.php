                                ...
                                <ul class="nav nav-tabs" id="packageTabs" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link active" data-package="all" role="tab" href="#">
                                            ...
                                            <span class="badge bg-primary"><?php echo e(\App\Providers\EmployeesServiceProvider::getbyPackages('all')); ?></span>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" data-package="Package 2" role="tab" href="#">
                                            <i class="fas fa-check-circle text-success"></i> Package 2
                                            <span class="badge bg-primary"><?php echo e(\App\Providers\EmployeesServiceProvider::getbyPackages('Package 2')); ?></span>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" data-package="Package 3" role="tab" href="#">
                                            <i class="fas fa-clock text-warning"></i> Package 3
                                            <span class="badge bg-primary"><?php echo e(\App\Providers\EmployeesServiceProvider::getbyPackages('Package 3')); ?></span>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" data-package="Package 4" role="tab" href="#">
                                            <i class="fas fa-star text-info"></i> Package 4
                                            <span class="badge bg-primary"><?php echo e(\App\Providers\EmployeesServiceProvider::getbyPackages('Package 4')); ?></span>
                                        </a>
                                    </li>
                                </ul>
                            </div>
                                ...
                                <ul class="nav nav-tabs" id="visaStatusTabs" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link active" data-visa_status="new" role="tab" href="#">
                                            ...
                                            <span class="badge bg-primary"><?php echo e(\App\Providers\VisaStatusServiceProvider::getByVisaStatus('new')); ?></span>
                                        </a>
                                    </li>
                                    <?php $__currentLoopData = $visaStatus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $status): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <li class="nav-item">
                                        <a class="nav-link" data-visa_status="<?php echo e($status->id); ?>" role="tab" href="#">
                                            <i class="fas
                                                <?php switch($status->id):
                                                    ...
                                                    <?php case (13): ?> fa-times <?php break; ?>
                                                    <?php case (14): ?> fa-check-circle <?php break; ?>
                                                    <?php default: ?> fa-question-circle
                                                <?php endswitch; ?>
                                            "></i> <?php echo e($status->name); ?>

                                            <span class="badge bg-primary"><?php echo e(\App\Providers\VisaStatusServiceProvider::getByVisaStatus($status->id)); ?></span>
                                        </a>
                                    </li>
...
<script>
    ...
    function loadEmployees(page = 1) {
        ...
        $.ajax({
            url: "<?php echo e(route('employees.employee-visa-tracker')); ?>",
            type: 'GET',
            data: {
...
<?php /**PATH /var/www/developmentoneso-project/resources/views/employee/employee_visa_tracker.blade.php ENDPATH**/ ?>