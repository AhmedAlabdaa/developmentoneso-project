...
<head>
  ...
  <title>Dashboard - Finance Officer</title>
  <meta content="Dashboard page for Finance Officer application" name="description">
  <meta content="dashboard, Finance Officer" name="keywords">
        ...
        <ul class="sidebar-nav" id="sidebar-nav">
            ...
            <li class="nav-item">
                ...
                <ul id="packages-nav" class="nav-content collapse <?php echo e($activePackages ? 'show' : ''); ?>" data-bs-parent="#sidebar-nav">
                    <?php $__currentLoopData = $pkgs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $label => $href): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php
                            $isPkg1 = $label === 'PKG-1';
                            if ($label === 'PKG-3') {
            ...
            <li class="nav-item">
                ...
                <ul id="reports-nav" class="nav-content collapse <?php echo e($activeReports ? 'show' : ''); ?>" data-bs-parent="#sidebar-nav">
                    <?php $__currentLoopData = $reportLinks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $label => $href): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php $isActive = ($currentUrl === $href); ?>
                        <li>
                            <a href="<?php echo e($href); ?>" class="<?php echo e($isActive ? 'active' : ''); ?>">
                                <i class="bi bi-dot"></i>
                                <span><?php echo e($label); ?></span>
            ...
            <li class="nav-item">
                <a class="nav-link <?php echo e($activeSettings ? '' : 'collapsed'); ?>" data-bs-target="#settings-nav" data-bs-toggle="collapse" href="#">
                    <i class="bi bi-gear"></i>
                    <span>Settings</span>
                    <i class="bi bi-chevron-down ms-auto"></i>
                </a>
                <ul id="settings-nav" class="nav-content collapse <?php echo e($activeSettings ? 'show' : ''); ?>" data-bs-parent="#sidebar-nav">
                    <li>
            ...
            <li class="nav-item">
                <a href="<?php echo e(url('complains')); ?>" class="nav-link <?php echo e(request()->is('complains') ? 'active' : ''); ?>">
                    <i class="bi bi-chat-dots"></i>
                    <span>Complains</span>
                </a>
            </li>
            <li class="nav-item">
                <a id="saveAllDatabases" class="nav-link" href="javascript:void(0)">
                    <i class="bi bi-cloud-arrow-up"></i>
                    <span>Backup</span>
                </a>
            </li>
            <li class="nav-item">
                <a id="resetRecord" class="nav-link" href="javascript:void(0)">
...
<?php /**PATH /var/www/developmentoneso-project/resources/views/layout/Finance_header.blade.php ENDPATH**/ ?>