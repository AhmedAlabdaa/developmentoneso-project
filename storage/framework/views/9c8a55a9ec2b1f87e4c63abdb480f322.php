    ...
    <div class="row mb-4 animate__animated animate__fadeInDown">
        <div class="col-12 d-flex justify-content-between align-items-center">
            <div>
                ...
                <div class="text-muted"><?php echo e(date('l, F d, Y h:i A')); ?></div>
            </div>
    ...
    <div class="card shadow-sm mb-4" id="content-section" style="display: none;">
        ...
        <div class="card-footer bg-light py-3">
             <div class="d-flex justify-content-between align-items-center">
                <span class="text-muted small">Generated on <?php echo e(date('d M Y, h:i A')); ?></span>
...
$(document).ready(function() {
    const ledgerId = "<?php echo e($ledgerId); ?>";
...
<?php /**PATH /var/www/developmentoneso-project/resources/views/finance_module/statement_of_account.blade.php ENDPATH**/ ?>