...
<body>
    <div class="contract-container">
        ...
        <table class="table-container bg-table">
            <tr>
                <td>
                    <input type="text" value="<?php echo e($agreement && $agreement->created_at ? $agreement->created_at->format('d-m-Y') : ''); ?>">
                </td>
                <td>
                ...
                <td>
                    <input type="text" readonly value="<?php echo e($agreement->reference_no ?? ($contract->reference_no ?? '')); ?>">
                </td>
                <td>
        ...
        <table class="solid-table-container">
            ...
            <tr>
                ...
                <td><?php echo e(($contract->replaced_by_name ?? null) ? $contract->replaced_by_name : ($agreement->candidate_name ?? '')); ?></td>
            ...
            <tr>
                <td><input type="text" value="<?php echo e(($agreement && $agreement->agreement_start_date) ? \Carbon\Carbon::parse($agreement->agreement_start_date)->format('d-m-Y') : ''); ?>"></td>
                <td><strong>تاريخ بدء الاتفاقية<br>Agreement Start Date</strong></td>
                <td><input type="text" value="<?php echo e(($agreement && $agreement->agreement_end_date) ? \Carbon\Carbon::parse($agreement->agreement_end_date)->format('d-m-Y') : ''); ?>"></td>
        ...
        <div class="terms-container">
            <div class="terms">
                <ul>
                    ...
                    <li>The First Party commits to providing a domestic helper registration service under the sponsorship of the First Party, who will handle the work permit and residency for the domestic helper for a certian period in exchange for an upfront fee agreed upon as: <?php echo e($totalAmount); ?> AED.</li>
                ...
                <ul class="rtl">
                    ...
                    <li> يتعهد الطرف الثاني بدفع راتب العامل المساعد، والذي يبلغ <?php echo e($agreement->salary); ?> درهم إماراتي شهرياً مباشرة إلى العامل.</li>
...
<?php /**PATH /var/www/developmentoneso-project/resources/views/contracts/show3.blade.php ENDPATH**/ ?>