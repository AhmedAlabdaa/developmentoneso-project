    ...
    <div class="container">
                ...
                <td style="width: 50%; padding-right: 10px;">
                    <table class="table">
                        ...
                        <tr>
                            ...
                            <td><?php echo e($invoice->customer->first_name); ?> <?php echo e($invoice->customer->last_name); ?></td>
                        </tr>
                        <tr>
                            <th>EID No</th>
                            <td><?php echo e($invoice->customer->emirates_id); ?></td>
                        </tr>
                        <tr>
                            <th>Nationality</th>
                            <td><?php echo e($invoice->customer->nationality); ?></td>
                        </tr>
                        <tr>
                            <th>Contact No</th>
                            <td><?php echo e($invoice->customer->mobile); ?></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td><?php echo e($invoice->creator->first_name); ?> <?php echo e($invoice->creator->last_name); ?></td>
                        </tr>
                    </table>
                </td>
                    ...
                    <table class="table">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <?php echo e($invoice->agreement->agreement_type); ?>

                            </td>
                        </tr>
                        <tr>
                            <th>Maid Name</th>
                            <td><?php echo e($invoice->agreement->candidate_name); ?></td>
                        </tr>
                        <tr>
                            <th>Passport No</th>
                            <td><?php echo e($invoice->agreement->passport_no); ?></td>
                        </tr>
                        <tr>
                            <th>Nationality</th>
                            <td>
                        ...
                        <tr>
                            <th>Contract Date</th>
                            <td><?php echo e(date('d M Y', strtotime($invoice->agreement->created_at))); ?></td>
                        </tr>
                        <tr>
                            <th>Contract From</th>
                            <td><?php echo e(!empty($invoice->agreement->agreement_start_date) ? date('d M Y', strtotime($invoice->agreement->agreement_start_date)) : '-'); ?></td>
                        </tr>
                        <tr>
                            <th>Contract To</th>
                            <td><?php echo e(!empty($invoice->agreement->agreement_end_date) ? date('d M Y', strtotime($invoice->agreement->agreement_end_date)) : '-'); ?></td>
                        </tr>
                        <tr>
                            <th>Payment</th>
        ...
        <table class="totals-table">
            <tr>
                ...
                <td><?php echo e($invoice->total_amount); ?> AED</td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td><?php echo e($invoice->received_amount); ?> AED</td>
            </tr>
            <tr>
                <td><strong>BALANCE AMOUNT  المبلغ المتبقي</strong></td>
                <td><?php echo e($invoice->total_amount - $invoice->received_amount); ?>.00 AED</td>
            </tr>
        </table>
...
<?php /**PATH /var/www/developmentoneso-project/resources/views/invoices/download.blade.php ENDPATH**/ ?>