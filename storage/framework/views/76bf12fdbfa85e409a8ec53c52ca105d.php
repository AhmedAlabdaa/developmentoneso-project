...
<head>
  ...
  <meta content="Dashboard page for PRO application" name="description">
  <meta content="dashboard, PRO" name="keywords">
                ...
                <div class="col-lg-12">
                    <nav class="horizontal-nav card flex-fill">
                        <ul class="nav justify-content-center">
                            ...
                            <li class="nav-item">
                              <a class="nav-link text-center <?php echo e(request()->is('staff*') ? 'active' : ''); ?>" href="<?php echo e(url('staff')); ?>" <?php if(request()->is('staff*')): ?> aria-current="page" <?php endif; ?> title="Staff">
                                <i class="bi bi-people display-6" aria-hidden="true"></i>
                                <span class="d-block">Staff</span>
                              </a>
                            </li>
                            <li class="nav-item">
                              <a
...
<?php /**PATH /var/www/developmentoneso-project/resources/views/layout/PRO_header.blade.php ENDPATH**/ ?>