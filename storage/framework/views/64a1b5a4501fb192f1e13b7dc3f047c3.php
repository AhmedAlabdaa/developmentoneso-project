...
<div class="button-container">
    <a href="<?php echo e(route('candidates.download', $candidate->reference_no)); ?>" class="btn btn-primary">
        <i class="bi bi-download"></i> Download
    </a>
    <a href="<?php echo e(route('candidates.share', $candidate->reference_no)); ?>" class="btn btn-success">
        <i class="bi bi-whatsapp"></i> Share on WhatsApp
    </a>
    <!-- <a href="<?php echo e(route('candidates.index')); ?>" class="btn btn-secondary">
...
<div class="cv-container">
    ...
    <div class="row">
        <div class="col-lg-9">
            <table class="table section-table">
                <tr>
                    ...
                    <td class="info-column"><?php echo e($candidate->ref_no ?? 'N/A'); ?></td>
        ...
        <div class="col-lg-3 text-center">
           <?php
            ...
            ?>
            <?php if($fileUrl): ?>
                <img src="<?php echo e($fileUrl); ?>" alt="Passport Size Photo" class="img-thumbnail" style="width: 150px; height: auto;">
            <?php else: ?>
    ...
    <div class="full-width-name">
        <span style="font-weight: bold;"> Name :</span> <span class="ltr"><?php echo e($candidate->candidate_name); ?></span>
    </div>
    <div class="row">
        <div class="col-lg-7">
            <table class="table section-table">
        ...
        <div class="col-lg-5">
            ...
            <div class="text-center">
                ...
                ?>
                <?php if($fileUrl): ?>
                    <img src="<?php echo e($fileUrl); ?>" alt="Passport Size Photo" class="img-thumbnail" style="width: 300px; height: auto;">
                <?php else: ?>
...
<?php /**PATH /var/www/developmentoneso-project/resources/views/candidates/cv.blade.php ENDPATH**/ ?>