          ...
          <?php $__currentLoopData = $cards; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $card): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="col-xxl-4 col-md-6 mb-3">
              <div class="card info-card">
                <div class="card-body">
                  <h5 class="card-title" style="font-weight: bold; color: black;"><?php echo e($card['title']); ?></h5>
                  <div class="d-flex align-items-center">
                    <div class="card-icon rounded-circle d-flex align-items-center justify-content-center" style="background-color: <?php echo e($card['color']); ?>; width: 80px; height: 80px;">
                      <i class="<?php echo e($card['icon']); ?>" style="color: white; font-size: 36px;"></i>
                    </div>
                    <div class="ps-3">
                      <h6><?php echo e(number_format($card['count'])); ?></h6>
                      <span class="text-muted small" style="font-weight: bold; color: black;"><?php echo e($card['subtitle']); ?></span>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div class="card-body">
            ...
            <div class="table-responsive">
              <table class="table table-striped align-middle">
                ...
                <tbody>
                  <?php $i = 1; ?>
                  <?php $__currentLoopData = $nationalityStats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                      <td><?php echo e($i++); ?></td>
                      <td><?php echo e($row->name); ?></td>
                      <td class="text-end"><?php echo e($row->arabic_name); ?></td>
                      <td class="text-end"><span class="badge bg-primary"><?php echo e(number_format($row->total)); ?></span></td>
                      <td>
                        <?php
                          $pct = $totalActive > 0 ? round(($row->total / max(1,$totalActive)) * 100) : 0;
                        ?>
                        <div class="progress" style="height: 10px;">
                          <div class="progress-bar" role="progressbar" style="width: <?php echo e($pct); ?>%;" aria-valuenow="<?php echo e($pct); ?>" aria-valuemin="0" aria-valuemax="100"></div>
                        </div>
                      </td>
                    </tr>
                  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                  <?php if($nationalityStats->isEmpty()): ?>
                    <tr>
                ...
                <tfoot class="table-light">
                  <tr>
                    ...
                    <th class="text-end"><?php echo e(number_format($totalActive)); ?></th>
                    <th></th>
                  </tr>
                </tfoot>
              </table>
...
<?php /**PATH /var/www/developmentoneso-project/resources/views/Web_Manager.blade.php ENDPATH**/ ?>