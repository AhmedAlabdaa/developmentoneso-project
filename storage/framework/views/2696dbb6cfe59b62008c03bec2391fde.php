        ...
        <div class="card">
          <div class="card-body pt-3">
            ...
            <ul class="nav nav-tabs nav-tabs-bordered">
              ...
              <li class="nav-item">
                <button class="nav-link <?php echo e(old('settings_type') == 'notifications' ? 'active' : ''); ?>" data-bs-toggle="tab" data-bs-target="#notifications">Notifications</button>
              </li>
              <li class="nav-item">
                <button class="nav-link <?php echo e(old('settings_type') == 'system' ? 'active' : ''); ?>" data-bs-toggle="tab" data-bs-target="#system-settings">System Settings</button>
              </li>
            </ul>
            <div class="tab-content pt-2">
              ...
              <div class="tab-pane fade show active" id="user-management">
                ...
                <form action="<?php echo e(route('settings.users.update')); ?>" method="POST">
                  <?php echo csrf_field(); ?>
                  ...
                  <div class="row mb-3">
                    ...
                    <div class="col-md-8 col-lg-9">
                      <div class="form-check">
                        <input class="form-check-input" type="checkbox" id="userApproval" name="user_approval" <?php echo e(old('user_approval', $settings->user_approval ?? false) ? 'checked' : ''); ?>>
              ...
              <!-- Notifications -->
              <div class="tab-pane fade <?php echo e(old('settings_type') == 'notifications' ? 'show active' : ''); ?>" id="notifications">
                ...
                <form action="<?php echo e(route('settings.notifications.update')); ?>" method="POST">
                  ...
                  <div class="row mb-3">
                    ...
                    <div class="col-md-8 col-lg-9">
                      <div class="form-check">
                        <input class="form-check-input" type="checkbox" id="emailNotifications" name="email_notifications" <?php echo e(old('email_notifications', $settings->email_notifications ?? false) ? 'checked' : ''); ?>>
                  ...
                  <div class="row mb-3">
                    ...
                    <div class="col-md-8 col-lg-9">
                      <div class="form-check">
                        <input class="form-check-input" type="checkbox" id="pushNotifications" name="push_notifications" <?php echo e(old('push_notifications', $settings->push_notifications ?? false) ? 'checked' : ''); ?>>
              ...
              <!-- System Settings -->
              <div class="tab-pane fade <?php echo e(old('settings_type') == 'system' ? 'show active' : ''); ?>" id="system-settings">
                  ...
                  <div class="row mb-3">
                    ...
                    <div class="col-md-8 col-lg-9">
                      <select name="timezone" id="timezone" class="form-select">
                        ...
                        <option value="America/New_York" <?php echo e(old('timezone', $settings->timezone ?? '') == 'America/New_York' ? 'selected' : ''); ?>>America/New York</option>
                        <option value="Europe/London" <?php echo e(old('timezone', $settings->timezone ?? '') == 'Europe/London' ? 'selected' : ''); ?>>Europe/London</option>
                  ...
                  <div class="row mb-3">
                    ...
                    <div class="col-md-8 col-lg-9">
                      <select name="language" id="language" class="form-select">
                        ...
                        <option value="es" <?php echo e(old('language', $settings->language ?? '') == 'es' ? 'selected' : ''); ?>>Spanish</option>
                        <option value="fr" <?php echo e(old('language', $settings->language ?? '') == 'fr' ? 'selected' : ''); ?>>French</option>
                        <option value="ar" <?php echo e(old('language', $settings->language ?? '') == 'ar' ? 'selected' : ''); ?>>Arabic</option>
                        <!-- Add more options as needed -->
                      </select>
                    </div>
                  </div>
...
<?php /**PATH /var/www/developmentoneso-project/resources/views/settings/index.blade.php ENDPATH**/ ?>