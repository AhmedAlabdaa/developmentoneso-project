...
<div class="wrap">
    <div class="header">
        <img src="<?php echo e(asset('assets/img/' . $headerFileName)); ?>" alt="">
    </div>
    <div class="footer">
        <img src="<?php echo e(asset('assets/img/' . $footerFileName)); ?>" alt="">
    </div>
    <div class="content">
        <h1>
        ...
        <table class="table">
            <tr>
                ...
                <td class="value"><?php echo e($val($record->ref_no ?? ($record->reference_no ?? null))); ?></td>
                <td class="label-ar">رقم المرجع</td>
            </tr>
            <tr>
                <td class="label">Date</td>
                <td class="value"><?php echo e($fmt($record->form_date ?? ($record->request_date ?? ($record->date ?? null)))); ?></td>
                <td class="label-ar">التاريخ</td>
            </tr>
            <tr>
                <td class="label">CN-NO.</td>
                <td class="value"><?php echo e($val($record->cn_no ?? null)); ?></td>
                <td class="label-ar">رقم الملف</td>
            </tr>
            <tr>
                <td class="label">SPONSOR NAME</td>
                <td class="value"><?php echo e($val($record->sponsor_name ?? null)); ?></td>
                <td class="label-ar">اسم الكفيل</td>
            </tr>
            <tr>
                <td class="label">QID NO.</td>
                <td class="value"><?php echo e($val($record->sponsor_qid ?? null)); ?></td>
                <td class="label-ar">الرقم الشخصي</td>
            </tr>
            <tr>
                <td class="label">PHONE NO.</td>
                <td class="value"><?php echo e($val($record->sponsor_phone ?? null)); ?></td>
                <td class="label-ar">رقم الهاتف</td>
            </tr>
            <tr>
                <td class="label">SALES NAME</td>
                <td class="value"><?php echo e($val($record->sales_name ?? null)); ?></td>
        ...
        <table class="table" style="margin-top:10px">
            ...
            <tr>
                ...
                <td class="value"><?php echo e($val($record->contract_type ?? ($record->visa_type ?? null))); ?></td>
                <td class="label-ar">نوع العقد</td>
            </tr>
            <tr>
                <td class="label">CANDIDATE NAME</td>
                <td class="value"><?php echo e($val($record->candidate_name ?? null)); ?></td>
                <td class="label-ar">اسم العاملة</td>
            </tr>
            <tr>
                <td class="label">NATIONALITY</td>
                <td class="value"><?php echo e($val($record->nationality_name ?? null)); ?></td>
                <td class="label-ar">الجنسية</td>
            </tr>
            <tr>
                <td class="label">PASSPORT NO.</td>
                <td class="value"><?php echo e($val($record->passport_no ?? null)); ?></td>
                <td class="label-ar">رقم جواز السفر</td>
            </tr>
            <tr>
                <td class="label">CONTRACT AMOUNT</td>
                <td class="value money"><?php echo e($qar($record->contract_amount ?? null)); ?></td>
                <td class="label-ar">قيمة العقد</td>
            </tr>
            <tr>
                <td class="label">CONTRACT START DATE</td>
                <td class="value"><?php echo e($fmt($record->contract_start_date ?? null)); ?></td>
                <td class="label-ar">تاريخ بداية العقد</td>
            </tr>
            <tr>
                <td class="label">WORKER RETURNED DATE</td>
                <td class="value"><?php echo e($fmt($record->worker_returned_date ?? null)); ?></td>
                <td class="label-ar">تاريخ إرجاع العاملة</td>
            </tr>
            <tr>
                <td class="label">NO. OF DAYS WORK</td>
                <td class="value">
                    <?php echo e($days($record->maid_worked_days ?? $record->number_of_days ?? null)); ?>
            ...
            <tr>
                ...
                <td class="value money"><?php echo e($qar($record->refund_amount ?? null)); ?></td>
                <td class="label-ar">المبلغ المستحق للاسترجاع</td>
            </tr>
            <tr>
                <td class="label">DUE DATE</td>
                <td class="value"><?php echo e($fmt($record->refund_replace_date ?? null)); ?></td>
                <td class="label-ar">تاريخ الاستحقاق</td>
            </tr>
            <tr>
                <td class="label">REASON</td>
                <td class="value"><?php echo e($val($record->return_reason ?? null)); ?></td>
        ...
        <table class="table file-details" style="margin-top:10px">
            ...
            <tr>
                ...
                <td class="value"><?php echo e($val($record->noc_status ?? null)); ?></td>
            </tr>
            <tr>
                <td class="label">
                    NOC EXPIRY DATE
                ...
                <td class="value"><?php echo e($fmt($record->noc_expiry ?? null)); ?></td>
                <td class="label">
                    WORKER BELONGINGS
            ...
            <tr>
                ...
                <td class="value money"><?php echo e($qar($record->worker_salary_amount ?? null)); ?></td>
            </tr>
            <tr>
                <td class="label">
                    CUSTOMER DECISION
...
<?php /**PATH /var/www/developmentoneso-project/resources/views/package/package/refund_form.blade.php ENDPATH**/ ?>