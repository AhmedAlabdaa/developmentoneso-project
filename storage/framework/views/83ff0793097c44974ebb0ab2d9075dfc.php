      ...
      <div class="col-lg-12">
        <div class="card">
          <div class="card-body">
            ...
            <form action="<?php echo e(route('crm.update', $crm->slug)); ?>"
                  method="POST"
...
unset($__errorArgs, $__bag); ?>"
                         value="<?php echo e(old('first_name', $crm->first_name)); ?>"
                         required>
...
unset($__errorArgs, $__bag); ?>"
                         value="<?php echo e(old('last_name', $crm->last_name)); ?>"
                         required>
              ...
              <div class="col-md-6">
                ...
                <div class="input-group">
                  <select name="nationality"
                          class="form-select select2 <?php $__errorArgs = ['nationality'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                    ...
                    <?php $__currentLoopData = $countries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $country): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      <option value="<?php echo e($country['name']); ?>"
                        <?php echo e(old('nationality', $crm->nationality) === $country['name'] ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>"
                         value="<?php echo e(old('address', $crm->address)); ?>"
                         required>
...
unset($__errorArgs, $__bag); ?>"
                    ...
                    <?php $__currentLoopData = [
                      ...
                      <option value="<?php echo e($st); ?>"
                        <?php echo e(old('state', $crm->state) === $st ? 'selected' : ''); ?>>
                        <?php echo e($st); ?>
...
unset($__errorArgs, $__bag); ?>"
                         value="<?php echo e(old('email', $crm->email)); ?>">
...
unset($__errorArgs, $__bag); ?>"
                         ...
                         value="<?php echo e(old('mobile', $crm->mobile)); ?>"
                         required>
              ...
              <div class="col-md-6">
                ...
                <div class="input-group">
                  ...
                  <input type="text"
                         name="emirates_id"
                         id="inputEmiratesId"
                         class="form-control <?php $__errorArgs = ['emirates_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                         ...
                         value="<?php echo e(old('emirates_id', $crm->emirates_id)); ?>"
                         required>
                  <?php $__errorArgs = ['emirates_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?><div class="invalid-feedback"><?php echo e($message); ?></div><?php unset($message);
              ...
              <div class="col-md-6">
                ...
                <div class="input-group">
                  ...
                  <input type="text"
                         ...
                         class="form-control <?php $__errorArgs = ['emergency_contact_person'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                         value="<?php echo e(old('emergency_contact_person', $crm->emergency_contact_person)); ?>">
                  <?php $__errorArgs = ['emergency_contact_person'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?><div class="invalid-feedback"><?php echo e($message); ?></div><?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                    ...
                    <?php $__currentLoopData = ['Social Media','Referral','Walk-in','Others']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $src): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      <option value="<?php echo e($src); ?>"
                        <?php echo e(old('source', $crm->source) === $src ? 'selected' : ''); ?>>
                        <?php echo e($src); ?>
...
unset($__errorArgs, $__bag); ?>"
                         value="<?php echo e(old('passport_number', $crm->passport_number)); ?>"
                         required>
...
unset($__errorArgs, $__bag); ?>
              ...
              <div class="col-md-6">
                ...
                <div class="input-group">
                  ...
                  <input type="file"
                         name="passport_copy"
                         class="form-control <?php $__errorArgs = ['passport_copy'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                ...
                <small class="text-muted">Current: <a href="<?php echo e(asset('storage/'.$crm->passport_copy)); ?>" target="_blank">View</a></small>
              </div>
              ...
              <div class="col-md-6">
                ...
                <div class="input-group">
                  ...
                  <input type="file"
                         name="id_copy"
                         class="form-control <?php $__errorArgs = ['id_copy'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                ...
                <small class="text-muted">Current: <a href="<?php echo e(asset('storage/'.$crm->id_copy)); ?>" target="_blank">View</a></small>
              </div>
              ...
              <div class="col-12">
                ...
                <div id="paymentMethodsContainer">
                  <?php $methods = old('payment_methods', $crm->payment_methods ?? [['iban'=>'','bank'=>'','note'=>'']]); ?>
                  <?php $__currentLoopData = $methods; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $pm): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <div class="row g-2 mb-2 payment-method-row">
                    <div class="col-md-4">
                      <div class="input-group input-group-sm">
                        <span class="input-group-text"><i class="fas fa-university"></i></span>
                        <input type="text"
                               name="payment_methods[<?php echo e($i); ?>][iban]"
                               class="form-control"
                               placeholder="IBAN"
                               value="<?php echo e($pm['iban'] ?? ''); ?>">
                      </div>
                    </div>
                    <div class="col-md-3">
                      <div class="input-group input-group-sm">
                        ...
                        <input type="text"
                               name="payment_methods[<?php echo e($i); ?>][bank]"
                               class="form-control"
                               placeholder="Bank Name"
                               value="<?php echo e($pm['bank'] ?? ''); ?>">
                      </div>
                    </div>
                    <div class="col-md-4">
                      <div class="input-group input-group-sm">
                        ...
                        <input type="text"
                               name="payment_methods[<?php echo e($i); ?>][note]"
                               class="form-control"
                               placeholder="Note"
                               value="<?php echo e($pm['note'] ?? ''); ?>">
                      </div>
                    </div>
                    <div class="col-md-1 d-flex align-items-center">
                      <button type="button"
                              ...
                              title="Remove"
                              <?php if(count($methods) <= 1): ?> style="display:none;" <?php endif; ?>>
...
<script>
  $(function(){
    ...
    let pmIndex = <?php echo e(count($methods)); ?>;
...
<?php /**PATH /var/www/developmentoneso-project/resources/views/crm/edit.blade.php ENDPATH**/ ?>