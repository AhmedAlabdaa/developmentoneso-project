...
<body class="toggle-sidebar">
    ...
    <aside id="sidebar" class="sidebar">
        <ul class="sidebar-nav" id="sidebar-nav">
            ...
            <li class="nav-item">
              <a class="nav-link text-center <?php echo e(request()->is('monthly-contract*') ? 'active' : ''); ?>" href="<?php echo e(url('monthly-contract')); ?>">
...
<?php /**PATH /var/www/developmentoneso-project/resources/views/layout/Sales_Manager_header.blade.php ENDPATH**/ ?>