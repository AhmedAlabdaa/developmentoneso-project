...
<body style="margin:0;padding:0;font-family:Arial,sans-serif;font-size:14px;line-height:1.5;background:#f9f9f9;">
    <div style="width:100%;margin:0 auto;background:#fff;">
        <div style="text-align:center;margin-bottom:20px;">
            <img src="<?php echo e(asset('assets/img/' . $headerFileName)); ?>" alt="Header Image" style="width:100%;height:auto;">
        </div>
        <table style="width:100%;border-collapse:collapse;background:#21ace0;margin-bottom:20px;">
            <tr>
                <td style="padding:10px;text-align:center;">
                    <input type="text" value="<?php echo e($createdAt); ?>"
                ...
                <td style="padding:10px;text-align:center;">
                    <input type="text" value="<?php echo e($agreement->reference_no); ?>" readonly
                        style="width:90%;padding:5px;font-size:12px;border:none;background:transparent;pointer-events:none;">
                </td>
                <td style="padding:10px;text-align:center;">
        ...
        <table style="width:100%;border-collapse:collapse;margin-bottom:20px;">
            <tr>
                <td style="border:1px solid #000;padding:10px;text-align:center;font-size:12px;">
                    <input type="text" value="<?php echo e($agreement->client->name); ?>" style="width:90%;padding:5px;border:none;background:transparent;pointer-events:none;">
                </td>
            ...
            <tr>
                <td style="border:1px solid #000;padding:10px;text-align:center;font-size:12px;">
                    <input type="text" value="<?php echo e($agreement->client->emirates_id); ?>" style="width:90%;padding:5px;border:none;background:transparent;pointer-events:none;">
                </td>
            ...
            <tr>
                <td style="border:1px solid #000;padding:10px;text-align:center;font-size:12px;">
                    <input type="text" value="<?php echo e($agreement->client->address); ?>" style="width:90%;padding:5px;border:none;background:transparent;pointer-events:none;">
                </td>
            ...
            <tr>
                <td style="border:1px solid #000;padding:10px;text-align:center;font-size:12px;">
                    <input type="text" value="<?php echo e($agreement->client->passport_number); ?>" style="width:90%;padding:5px;border:none;background:transparent;pointer-events:none;">
                </td>
            ...
            <tr>
                <td style="border:1px solid #000;padding:10px;text-align:center;font-size:12px;">
                    <input type="text" value="<?php echo e($agreement->client->nationality); ?>" style="width:90%;padding:5px;border:none;background:transparent;pointer-events:none;">
                </td>
                <td style="border:1px solid #000;padding:10px;text-align:center;font-size:12px;"><strong>الجنسية<br>NATIONALITY</strong></td>
                <td style="border:1px solid #000;padding:10px;text-align:center;font-size:12px;">
                    <input type="text" value="<?php echo e($agreement->candidate_name); ?>" style="width:90%;padding:5px;border:none;background:transparent;pointer-events:none;">
                </td>
                <td style="border:1px solid #000;padding:10px;text-align:center;font-size:12px;"><strong>اسم العامل<br>Name</strong></td>
            </tr>
            <tr>
                <td style="border:1px solid #000;padding:10px;text-align:center;font-size:12px;">
                    <input type="text" value="<?php echo e($agreement->client->mobile); ?>" style="width:90%;padding:5px;border:none;background:transparent;pointer-events:none;">
                </td>
                <td style="border:1px solid #000;padding:10px;text-align:center;font-size:12px;"><strong>رقم الهاتف<br>PHONE&nbsp;NUMBER</strong></td>
                <td style="border:1px solid #000;padding:10px;text-align:center;font-size:12px;">
                    <input type="text" value="<?php echo e($agreement->passport_no); ?>" style="width:90%;padding:5px;border:none;background:transparent;pointer-events:none;">
                </td>
                <td style="border:1px solid #000;padding:10px;text-align:center;font-size:12px;"><strong>رقم جواز السفر<br>Passport</strong></td>
            </tr>
            <tr>
                <td style="border:1px solid #000;padding:10px;text-align:center;font-size:12px;">
                    <input type="text" value="<?php echo e($agreement->client->email); ?>" style="width:90%;padding:5px;border:none;background:transparent;pointer-events:none;">
                </td>
                <td style="border:1px solid #000;padding:10px;text-align:center;font-size:12px;"><strong>البريد الإلكتروني<br>EMAIL</strong></td>
                <td style="border:1px solid #000;padding:10px;text-align:center;font-size:12px;">
                    <input type="text" value="<?php echo e($agreement->Nationality->name ?? $agreement->nationality); ?>" style="width:90%;padding:5px;border:none;background:transparent;pointer-events:none;">
                </td>
                <td style="border:1px solid #000;padding:10px;text-align:center;font-size:12px;"><strong>الجنسية<br>Nationality</strong></td>
            </tr>
            <tr>
                <td style="border:1px solid #000;padding:10px;text-align:center;font-size:12px;">
                    <input type="text" value="<?php echo e(\Carbon\Carbon::parse($agreement->agreement_start_date)->format('d-m-Y')); ?>" style="width:90%;padding:5px;border:none;background:transparent;pointer-events:none;">
                </td>
                ...
                <td style="border:1px solid #000;padding:10px;text-align:center;font-size:12px;">
                    <input type="text" value="<?php echo e(\Carbon\Carbon::parse($agreement->agreement_end_date)->format('d-m-Y')); ?>" style="width:90%;padding:5px;border:none;background:transparent;pointer-events:none;">
                </td>
        ...
        <div style="width:48%;float:left;padding-left:20px;margin-bottom:20px;font-size:14px;">
            <ul style="margin:0;padding:0;list-style:disc inside;">
                ...
                <li>The First Party commits to providing a domestic helper service under the sponsorship of the First Party, who will handle the work permit and residency for the domestic helper for a period of two years in exchange for an upfront fee agreed upon as: <span style="font-weight:bold;"><?php echo e($totalAmount); ?> AED</span>.</li>
        ...
        <div style="width:48%;float:left;margin-bottom:20px;direction:rtl;font-size:14px;">
            <ul style="margin:0;padding:0;list-style:disc inside;">
                ...
                <li>يتعهد الطرف الأول بتقديم خدمة عامل مساعد على كفالته، ويتولى إصدار تصريح العمل والإقامة للعامل المساعد لمدة سنتين مقابل رسوم مقدمة تم الاتفاق عليها وقدرها: <span style="font-weight:bold;"><?php echo e($totalAmount); ?> درهم إماراتي</span>.</li>
        ...
        <div style="text-align:center;">
            <img src="<?php echo e(asset('assets/img/' . $footerFileName)); ?>" alt="Footer Image" style="width:100%;height:auto;">
        </div>
    </div>
</body>
</html>
<?php /**PATH /var/www/developmentoneso-project/resources/views/agreements/package3_agreement_download.blade.php ENDPATH**/ ?>