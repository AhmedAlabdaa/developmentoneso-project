...
<head>
    <meta charset="UTF-8">
    <title><?php echo e($employee->name); ?>'s Exit Form</title>
...
<body>
    ...
    <div class="container" id="printContainer">
        ...
        <img src="<?php echo e(asset('assets/img/' . $footerFileName)); ?>" style="width:100%;margin-top:20px">
    </div>
...
<?php /**PATH /var/www/developmentoneso-project/resources/views/employee/exit.blade.php ENDPATH**/ ?>