...
<body>
    <div class="contract-container">
        ...
        <div style="text-align:center; margin-bottom:20px">
            <a href="<?php echo e(route('download.agreement', $agreement->reference_no)); ?>" class="btn btn-download">
                <i class="fa fa-download"></i> Download Agreement
            </a>
            <a href="<?php echo e(route('agreements.index')); ?>" class="btn btn-back">
        ...
        <table class="table">
            <tr>
                <td><?php echo e($agreement->created_at ? $agreement->created_at->format('d/m/Y') : ''); ?></td>
                <td>
        ...
        <div>
            ...
            <div class="clause">
                <p>
                    ...
                    <strong><?php echo e(number_format($totalAmount, 2)); ?></strong> Dirhams
                    (received: <strong><?php echo e(number_format($received, 2)); ?></strong>,
                    remaining: <strong><?php echo e(number_format($remaining, 2)); ?></strong>).
                    Payment will be made in <?php echo e($payEn); ?>
                ...
                <p>
                    ...
                    <strong><?php echo e(number_format($totalAmount, 2)); ?></strong> درهم
                    (المستلم: <strong><?php echo e(number_format($received, 2)); ?></strong>،
                    المتبقي: <strong><?php echo e(number_format($remaining, 2)); ?></strong>).
                    <?php echo e($payAr); ?>
        ...
        <div class="signature-section">
            <div class="signature-box">
                ...
                <p><span class="signature-label">Name:</span> <span class="signature-line"><?php echo e($agreement->client->name); ?></span></p>
                <p><span class="signature-label">Signature:</span> <span class="signature-line"></span></p>
                <p><span class="signature-label">Date:</span> <span class="signature-line"><?php echo e($fmt(now())); ?></span></p>
            </div>
            <div class="signature-box">
...
<?php /**PATH /var/www/developmentoneso-project/resources/views/agreements/trial_contract.blade.php ENDPATH**/ ?>