...
<div class="table-container">
  <table class="table table-striped table-hover">
    ...
    <tbody>
      <?php $__empty_1 = true; $__currentLoopData = $packages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
        <?php
        ...
        <tr>
          <td><?php echo e($cn); ?></td>
          <td><?php echo e($cand); ?></td>
          <td>
            <button
              type="button"
              class="btn btn-outline-primary btn-sm js-open-sales-modal"
              style="font-size:10px"
              data-can-change="<?php echo e($canChange ? '1' : '0'); ?>"
              data-candidate-id="<?php echo e($candidateKey); ?>"
              data-trial-id="<?php echo e($trialKey); ?>"
              data-current-id="<?php echo e($currentSid); ?>"
              data-current-label="<?php echo e($salesName); ?>"
            >
              <i class="fas fa-user-edit me-1"></i>
              <span class="js-sales-label"><?php echo e($salesName); ?></span>
            </button>
          </td>
          <td>
            <span class="badge badge-status <?php echo e($statusClass); ?>">
              <i class="<?php echo e($statusIcon); ?>"></i> <?php echo e($row->trial_status ?? '-'); ?>

            </span>
          </td>
          <td><?php echo e($statusDate); ?></td>
          <td><?php echo e($chgSponDate); ?></td>
          <td><?php echo e($sponsorName); ?></td>
          <td><?php echo e($qid); ?></td>
          <td><?php echo e(!is_null($penAmt) ? number_format($penAmt,2) : '-'); ?></td>
          <td><?php echo e($row->penalty_paid_by ?: '-'); ?></td>
          <td>
            <?php if($csProof): ?>
              <button class="btn-view" onclick="openChangeStatusFiles('<?php echo e($csProof); ?>','')">
          ...
          <td>
            <?php if($penProof): ?>
              <button class="btn-view" onclick="openChangeStatusFiles('','<?php echo e($penProof); ?>')">
                <i class="fas fa-eye"></i> View
              </button>
            <?php else: ?>
              —
          ...
          <td>
            <div class="icon-bar">
              <button
                ...
                title="Change Status"
                onclick="openDropdown('<?php echo e($candidateKey); ?>',this,'<?php echo e($cand); ?>','<?php echo e($cn); ?>')"
              >
                <i class="fas fa-train"></i>
              </button>
            </div>
            <div class="dropdown-container" id="dropdownContainer-<?php echo e($candidateKey); ?>">
              ...
              <div class="dropdown-header">
                ...
                <p>candidate <span class="employee-name"><?php echo e($cand); ?></span>?</p>
              </div>
              <select
                class="form-control status-dropdown"
                data-trial-id="<?php echo e($trialKey); ?>"
                data-client-id="<?php echo e($row->client_id); ?>"
                onchange="confirmStatusChange(this,'<?php echo e($candidateKey); ?>','<?php echo e($cand); ?>','<?php echo e($cn); ?>','<?php echo e($passportNo); ?>')"
              >
          ...
          <div class="row g-3 mb-2">
            ...
            <div class="col-md-4">
              ...
              <input
                ...
                name="return_date"
                value="<?php echo e(\Carbon\Carbon::now('Asia/Qatar')->format('Y-m-d')); ?>"
              >
            </div>
          </div>
          <div class="mb-2">
...
<script>
  ...
  var routes={
    ...
    saveSalesReturn:'<?php echo e(route("packages.saveSalesReturn")); ?>',
    updateSalesName:'<?php echo e(route("packages.updateTrialSalesName")); ?>',
    refundSalesView:'<?php echo e(route("packages.refund-sales-view")); ?>',
    replacementSalesView:'<?php echo e(route("packages.replacement-sales-view")); ?>',
    incidentData:'<?php echo e(route("package.incidentData",":id")); ?>',
    saveIncident:'<?php echo e(route("package.incidentSave")); ?>'
  };
...
<?php /**PATH /var/www/developmentoneso-project/resources/views/package/package/partials/change_status_table.blade.php ENDPATH**/ ?>