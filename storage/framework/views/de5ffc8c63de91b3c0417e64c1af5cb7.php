          ...
          <table id="candidates-table" class="table table-striped table-hover align-middle">
            ...
            <tbody>
              <?php $__currentLoopData = $candidates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr id="cand-<?php echo e($c->id); ?>">
                  <td><?php echo e($loop->iteration); ?></td>
                  <td><?php echo e($c->ref_no); ?></td>
                  <td><?php echo e($c->candidate_name); ?></td>
                  <td><?php echo e($c->passport_no); ?></td>
                  <td class="cell-slug"><?php echo e($c->slug); ?></td>
                  <td class="cell-title">
                    <div><span class="lang-chip">EN</span> <span class="val-en"><?php echo e($c->meta_title); ?></span></div>
                    <div class="mt-1"><span class="lang-chip ar">AR</span> <span class="val-ar"><?php echo e($c->meta_title_ar); ?></span></div>
                  </td>
                  <td class="cell-keywords">
                    <div class="text-truncate"><span class="lang-chip">EN</span> <span class="val-en"><?php echo e($c->meta_keywords); ?></span></div>
                    <div class="text-truncate mt-1"><span class="lang-chip ar">AR</span> <span class="val-ar"><?php echo e($c->meta_keywords_ar); ?></span></div>
                  </td>
                  <td class="cell-description">
                    <div class="text-truncate"><span class="lang-chip">EN</span> <span class="val-en"><?php echo e($c->meta_description); ?></span></div>
                    <div class="text-truncate mt-1"><span class="lang-chip ar">AR</span> <span class="val-ar"><?php echo e($c->meta_description_ar); ?></span></div>
                  </td>
                  <td class="text-center">
                    <button
                      ...
                      data-row="#cand-<?php echo e($c->id); ?>"
                      data-ref="<?php echo e($c->ref_no); ?>"
                      data-name="<?php echo e($c->candidate_name); ?>"
                      data-passport="<?php echo e($c->passport_no); ?>"
                      data-slug="<?php echo e(e($c->slug)); ?>"
                      data-title-en="<?php echo e(e($c->meta_title)); ?>"
                      data-title-ar="<?php echo e(e($c->meta_title_ar)); ?>"
                      data-keywords-en="<?php echo e(e($c->meta_keywords)); ?>"
                      data-keywords-ar="<?php echo e(e($c->meta_keywords_ar)); ?>"
                      data-description-en="<?php echo e(e($c->meta_description)); ?>"
                      data-description-ar="<?php echo e(e($c->meta_description_ar)); ?>"
                      title="Edit SEO/Slug"
                    >
...
<script>
  ...
  const updateUrlTemplate="<?php echo e(route('available-candidates.update', ':id')); ?>";
...
<?php /**PATH /var/www/developmentoneso-project/resources/views/web_manager/available-candidates.blade.php ENDPATH**/ ?>