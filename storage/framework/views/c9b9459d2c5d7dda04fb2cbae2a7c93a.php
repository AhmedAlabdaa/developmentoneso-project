            ...
            <?php else: ?>
                <?php $__currentLoopData = $employees; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $employee): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        ...
                        <td><?php echo e(\Carbon\Carbon::parse($employee->updated_at)->format('d M Y h:i A')); ?></td>
                        <td>
                        ...
                        <td>
                            ...
                            <a href="javascript:void(0);" class="btn btn-primary btn-icon-only"
                               title="Change Status"
                               onclick="openDropdown('<?php echo e($employee->id); ?>', this, '<?php echo e($employee->name); ?>')">
                                <i class="fas fa-train"></i>
                            </a>
                            <div class="fullscreen-overlay" id="fullscreenOverlay" onclick="closeAllDropdowns()"></div>
                            <div class="dropdown-container" id="dropdownContainer-<?php echo e($employee->id); ?>" style="display: none;">
                                ...
                                <div class="dropdown-header">
                                    ...
                                    <p>employee <span id="candidateName-<?php echo e($employee->id); ?>" class="candidate-name"></span>?</p>
                                </div>
                                <select class="form-control status-dropdown" id="statusDropdown-<?php echo e($employee->id); ?>"
                                        name="current_status"
                                        onchange="confirmStatusChange(this, '<?php echo e($employee->id); ?>', '<?php echo e($employee->name); ?>')">
                                    <?php
                                        $allowedStatuses = [
                                            0 => 'Change Status',
                                            1 => 'Office',
                                    ...
                                    <?php $__currentLoopData = $allowedStatuses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $statusId => $statusName): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($statusId); ?>" <?php echo e($employee->_status == $statusId ? 'selected' : ''); ?>>
                            ...
                            <?php if(Auth::user()->role === 'Admin'): ?>
                                <form action="<?php echo e(route('employees.destroy', $employee->reference_no)); ?>"
                                      method="POST" style="display:inline;"
                                      id="delete-form-<?php echo e($employee->reference_no); ?>">
                                    <?php echo csrf_field(); ?>
                                    <?php echo method_field('DELETE'); ?>
                                    <button type="button"
                                            class="btn btn-danger btn-icon-only"
                                            onclick="confirmDelete('<?php echo e($employee->reference_no); ?>')"
                                            title="Delete">
...
<script>
    ...
    function openOfficeModal(employeeId) {
        ...
        $('#officeForm')[0].reset();
        $.ajax({
            url: "<?php echo e(route('employees.officeData', ':id')); ?>".replace(':id', employeeId),
            type: "GET",
    ...
    function saveOfficeData() {
        ...
        $.ajax({
            url: "<?php echo e(route('employees.officeSave')); ?>",
            type: "POST",
            data: formData,
            processData: false,
            contentType: false,
...
<?php /**PATH /var/www/developmentoneso-project/resources/views/candidates/partials/employees_table_inside.blade.php ENDPATH**/ ?>