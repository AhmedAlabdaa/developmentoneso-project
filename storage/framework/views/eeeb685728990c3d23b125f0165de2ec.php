    ...
    <table style="width:100%; border-collapse:collapse; margin-bottom:20px;">
      <tr>
        <td style="border:1px dotted #000; padding:10px; text-align:center;">
          <?php echo e($agreement->created_at ? $agreement->created_at->format('d-m-Y') : ''); ?>
        ...
        <td style="border:1px dotted #000; padding:10px; text-align:center; font-weight:bold;">
          <?php echo e($agreement->reference_no); ?>
    ...
    <table style="width:100%; border-collapse:collapse; margin-bottom:20px;">
      <tr>
          <td style="border:1px solid #000; padding:10px; text-align:center;">
              <?php echo e($agreement->client->first_name); ?> <?php echo e($agreement->client->last_name); ?>
      ...
      <tr>
          <td style="border:1px solid #000; padding:10px; text-align:center;">
              <?php echo e($agreement->client->emirates_id); ?>
      ...
      <tr>
          <td style="border:1px solid #000; padding:10px; text-align:center;">
              <?php echo e($agreement->client->address); ?>
      ...
      <tr>
          <td style="border:1px solid #000; padding:10px; text-align:center;">
              <?php echo e($agreement->client->nationality); ?>
          ...
          <td style="border:1px solid #000; padding:10px; text-align:center;">
              <?php echo e($agreement->candidate_name); ?>
      ...
      <tr>
          <td style="border:1px solid #000; padding:10px; text-align:center;">
              <?php echo e($agreement->client->mobile); ?>
          ...
          <td style="border:1px solid #000; padding:10px; text-align:center;">
              <?php echo e($agreement->passport_no); ?>
      ...
      <tr>
          <td style="border:1px solid #000; padding:10px; text-align:center;">
              <?php echo e($agreement->client->state); ?>
          ...
          <td style="border:1px solid #000; padding:10px; text-align:center;">
              <?php echo e($agreement->Nationality->name ?? ''); ?>
      ...
      <tr>
          <td style="border:1px solid #000; padding:10px; text-align:center;">
              <?php echo e(\Carbon\Carbon::parse($agreement->agreement_start_date)->format('d-m-Y')); ?>
    ...
    <div style="width:100%; margin-bottom:20px; overflow:auto;">
      <div style="float:left; width:47%;">
        <p style="margin:0; direction:ltr; text-align:left;">
          ...
          It was agreed that the second party would pay the recruitment fees, amounting to <?php echo e(number_format($totalAmount,2)); ?> AED, as follows:<br>
          - First payment of <?php echo e(number_format($received,2)); ?> AED when requesting the worker.<br>
          - Second payment of the remaining amount <?php echo e(number_format($remaining,2)); ?> AED upon the worker’s arrival.
        </p>
      </div>
      <div style="float:left; width:47%; margin-left:5%;">
        <p style="margin:0; direction:rtl; text-align:right;">
          ...
          تم الاتفاق على أن يدفع الطرف الثاني أتعاب مكتب الاستقدام للطرف الأول وقدرها <?php echo e(number_format($totalAmount,2)); ?> درهم موزعة على دفعتين:<br>
          - الدفعة الأولى: <?php echo e(number_format($received,2)); ?> درهم عند طلب العامل.<br>
          - الدفعة الثانية: المبلغ المتبقي وقدره <?php echo e(number_format($remaining,2)); ?> درهم عند استلام العامل.
        </p>
      </div>
    </div>
...
<?php /**PATH /var/www/developmentoneso-project/resources/views/agreements/outside_agreement_download.blade.php ENDPATH**/ ?>