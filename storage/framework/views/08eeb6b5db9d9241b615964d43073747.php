...
<div class="table-container">
  <table class="table table-striped table-hover">
    ...
    <tbody>
      <?php $__empty_1 = true; $__currentLoopData = $packages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $trial): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
        <?php
        ...
        <tr>
          ...
          <td>
            <button class="btn <?php echo e($st['class']); ?> btn-sm">
              <i class="<?php echo e($st['icon']); ?>"></i> <?php echo e($trial->trial_status); ?>

            </button>
          </td>
          <td><?php echo e(strtoupper($trial->nationality)); ?></td>
          <td title="<?php echo e(strtoupper($trial->foreign_partner)); ?>">
            <?php echo e(strtoupper(strtok($trial->foreign_partner, ' '))); ?>

          </td>
          <td>
            <a href="#" class="text-dark text-decoration-none" target="_blank">
              <?php echo e(strtoupper($trial->crm_CL_Number ?? '')); ?>

            </a>
          </td>
          <td>
            <a href="#" class="text-dark text-decoration-none" target="_blank">
              <?php echo e(strtoupper($trial->first_name ?? '')); ?>  <?php echo e(strtoupper($trial->last_name ?? '')); ?>
          ...
          <td><?php echo e($trial->confirmed_date 
          ...
          <td class="actions">
            <a href="javascript:void(0);" class="btn btn-primary btn-icon-only" title="Change Status"
               onclick="openDropdown('<?php echo e($trial->id); ?>', this, '<?php echo e(strtoupper($trial->candidate_name)); ?>')">
            ...
            <div class="dropdown-container" id="dropdownContainer-<?php echo e($trial->id); ?>" style="display:none;">
              ...
              <div class="dropdown-header">
                ...
                <p><strong><?php echo e(strtoupper($trial->candidate_name)); ?></strong>?</p>
              </div>
              <select class="form-control status-dropdown" 
                      onchange="trialChangeStatus(this, <?php echo e($trial->trial_id); ?>, <?php echo e($trial->id); ?>, <?php echo e($trial->client_id); ?>)">
...
<?php /**PATH /var/www/developmentoneso-project/resources/views/package/partials/confirm_table.blade.php ENDPATH**/ ?>