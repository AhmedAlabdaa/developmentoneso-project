...
<head>
  ...
  <title>Dashboard - Digital Marketing Specialist</title>
  <meta content="Dashboard page for Digital Marketing Specialist application" name="description">
  <meta content="dashboard, Digital Marketing Specialist" name="keywords">
...
<body class="toggle-sidebar">
    ...
    <aside id="sidebar" class="sidebar">
        <ul class="sidebar-nav" id="sidebar-nav">
            ...
            <li class="nav-item">
                <a href="<?php echo e(url('package')); ?>" class="nav-link <?php echo e(request()->is('package') ? 'active' : ''); ?>">
                    <i class="bi bi-box"></i>
                    <span>Package 1</span>
                </a>
            </li>
...
<?php /**PATH /var/www/developmentoneso-project/resources/views/layout/Digital_Marketing_Specialist_header.blade.php ENDPATH**/ ?>