...
<script>
    $(document).ready(function () {
        ...
        function loadAgreements(page = 1) {
            ...
            $.ajax({
                url: "<?php echo e(route('agreements.agreement-contract-tracker')); ?>",
                type: 'GET',
                data: {
...
<?php /**PATH /var/www/developmentoneso-project/resources/views/agreements/agreement_contract_tracker.blade.php ENDPATH**/ ?>