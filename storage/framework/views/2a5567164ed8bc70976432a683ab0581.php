        ...
        <tbody>
            ...
            <?php else: ?>
                <?php $__currentLoopData = $candidates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $candidate): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr class="<?php echo e($candidate->appeal == 1 ? 'table-warning appeal-row' : ''); ?>">
                        <td><a style="color: #007bff !important;" href="<?php echo e(route('candidates.show', $candidate->reference_no)); ?>" target="_blank" class="text-decoration-none text-dark"><?php echo e(strtoupper($candidate->ref_no)); ?></a></td>
                        <td><a style="color: #007bff !important;" href="<?php echo e(route('candidates.show', $candidate->reference_no)); ?>" target="_blank" class="text-decoration-none text-dark"><?php echo e(strtoupper($candidate->CN_Number)); ?></a></td>
                        <td>
                            ...
                            <i class="bi bi-box-arrow-in-up-right" onclick="showCandidateModal('<?php echo e($candidate->candidate_name); ?>', '<?php echo e($candidate->id); ?>', '<?php echo e($candidate->reference_no); ?>')"></i>
                        </td>
                        <td><button class="btn btn-danger"><?php echo e(\Carbon\Carbon::parse($candidate->arrived_in_office_date)->format('d M Y')); ?></button></td>
                        <td><?php echo e(strtoupper(optional($candidate->sales)->first_name . ' ' . optional($candidate->sales)->last_name) ?? 'N/A'); ?></td>
                        <td><?php echo e(\Carbon\Carbon::parse($candidate->updated_at)->format('d M Y, h:i A')); ?></td>
                        <td><?php echo e(strtoupper($candidate->passport_status) ?? 'N/A'); ?></td>
                        <td><?php echo e(\Carbon\Carbon::parse($candidate->visa_issue_date)->format('d M Y') ?? 'N/A'); ?></td>
                        <td><?php echo e(\Carbon\Carbon::parse($candidate->visa_expiry_date)->format('d M Y') ?? 'N/A'); ?></td>
                        <td><?php echo e($candidate->overstay_days ?? 0); ?></td>
                        <td><?php echo e($candidate->fine_amount ?? 0); ?> QR</td>
                        <td><?php echo e(strtoupper($candidate->passport_no) ?? 'N/A'); ?></td>
                        <td><?php echo e(strtoupper(optional($candidate->Nationality)->name) ?? 'N/A'); ?></td>
                        <td><?php echo e(strtoupper($candidate->foreign_partner) ?? 'N/A'); ?></td>
                        <td><?php echo e($candidate->age ?? 'N/A'); ?></td>
                        <td><?php echo e($candidate->CandidatesExperience->count() > 0 ? $candidate->CandidatesExperience->sum('experience_years') : 'N/A'); ?></td>
                        <td><?php echo e($candidate->work_skills->count() > 0 ? 'Available' : 'No skills'); ?></td>
                        <td><?php echo e(strtoupper(optional($candidate->appliedPosition)->position_name) ?? 'N/A'); ?></td>
                        <td><?php echo e(strtoupper($candidate->religion) ?? 'N/A'); ?></td>
                        <td><?php echo e(strtoupper(optional($candidate->maritalStatus)->status_name) ?? 'N/A'); ?></td>
                        <td><?php echo e($candidate->number_of_children ?? 0); ?></td>
                        <td><?php echo e(strtoupper(optional($candidate->educationLevel)->level_name) ?? 'N/A'); ?></td>
                        <td><?php echo e(strtoupper($candidate->phone_number) ?? 'N/A'); ?></td>
                        <td><?php echo e(strtoupper($candidate->family_contact_number_1) ?? 'N/A'); ?></td>
                        ...
                        <td><?php echo e(strtoupper($candidate->gender) ?? 'N/A'); ?></td>
                        <td><?php echo e(strtoupper($candidate->english_skills) ?? 'N/A'); ?></td>
                        <td><?php echo e(strtoupper($candidate->arabic_skills) ?? 'N/A'); ?></td>
                        <td><?php echo e($candidate->height ?? 'N/A'); ?> CM</td>
                        <td><?php echo e($candidate->weight ?? 'N/A'); ?> KG</td>
                        <td><?php echo e(strtoupper($candidate->preferred_package) ?? 'N/A'); ?></td>
                        <td><?php echo e(strtoupper($candidate->place_of_birth) ?? 'N/A'); ?></td>
                        <td><?php echo e(strtoupper($candidate->candidate_current_address) ?? 'N/A'); ?></td>
                        <td><?php echo e(\Carbon\Carbon::parse($candidate->labour_id_date)->format('d M Y')); ?></td>
                        <td><?php echo e($candidate->labour_id_number ?? 'N/A'); ?></td>
                        <td><?php echo e(strtoupper($candidate->family_name) ?? 'N/A'); ?></td>
                        <td><?php echo e($candidate->family_contact_number_1 ?? 'N/A'); ?></td>
                        <td><?php echo e($candidate->family_contact_number_2 ?? 'N/A'); ?></td>
                        <td><?php echo e(strtoupper($candidate->relationship_with_candidate) ?? 'N/A'); ?></td>
                        <td><?php echo e(strtoupper($candidate->family_current_address) ?? 'N/A'); ?></td>
                        <td class="actions">
                            <a href="javascript:void(0);" class="btn btn-primary btn-icon-only" title="Change Status" onclick="openDropdown('<?php echo e($candidate->id); ?>', this, '<?php echo e($candidate->candidate_name ? strtoupper(\Illuminate\Support\Str::title(strtolower($candidate->candidate_name))) : 'N/A'); ?>')">
                                <i class="fas fa-train"></i>
                            </a>
                            <div class="fullscreen-overlay" id="fullscreenOverlay" onclick="closeAllDropdowns()"></div>
                            <div class="dropdown-container" id="dropdownContainer-<?php echo e($candidate->id); ?>" style="display: none;">
                                ...
                                <div class="dropdown-header">
                                    ...
                                    <p>candidate <span id="candidateName-<?php echo e($candidate->id); ?>" class="candidate-name"></span>?</p>
                                </div>
                                <select class="form-control status-dropdown" id="statusDropdown-<?php echo e($candidate->id); ?>" name="current_status" onchange="confirmStatusChange(this, '<?php echo e($candidate->id); ?>', '<?php echo e($candidate->candidate_name); ?>')">
                                    <?php
                                        $allowedStatuses = [
                                            0 => 'Change Status',
                                            2 => 'Trial',
                                    ...
                                    <?php $__currentLoopData = $allowedStatuses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $statusId => $statusName): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($statusId); ?>" <?php echo e($candidate->_status == $statusId ? 'selected' : ''); ?>>
...
<script>
    ...
    function updateStatus(selectElement, candidateId) {
        ...
        const updateStatusUrl = "<?php echo e(route('candidates.update-status-inside', ['candidate' => ':reference_no'])); ?>".replace(':reference_no', candidateId);
        $.ajax({
            url: updateStatusUrl,
            type: 'POST',
    ...
    $(document).ready(function () {
        $('#saveDetailsBtn').on('click', function (event) {
            ...
            $.ajax({
                url: '<?php echo e(route('candidates.updateCandidateDetails')); ?>',
                type: 'POST',
                data: formData,
                processData: false,
                contentType: false,
...
<?php /**PATH /var/www/developmentoneso-project/resources/views/candidates/partials/office.blade.php ENDPATH**/ ?>