...
<div class="wrapper">
    <div class="container">
        ...
        <div class="content">
            ...
            <p>
                Action performed: <strong><?php echo e($action); ?></strong>
            </p>
            ...
            <table class="details-table">
                <tr>
                    ...
                    <td><?php echo e($candidate_name); ?></td>
                </tr>
                <tr>
                    <th>Passport No.</th>
                    <td><?php echo e($passport_no ?: '-'); ?></td>
                </tr>
                <tr>
                    <th>Reference No.</th>
                    <td><?php echo e($ref_no ?: '-'); ?></td>
                </tr>
                <tr>
                    <th>Foreign Partner</th>
                    <td><?php echo e($foreign_partner ?: '-'); ?></td>
                </tr>
                <tr>
                    <th>Action</th>
...
<?php /**PATH /var/www/developmentoneso-project/resources/views/emails/action_notification.blade.php ENDPATH**/ ?>