...
<script>
$(function(){
  function loadData(scope,url='<?php echo e(route("agreements.index")); ?>'){
  ...
  $('#filter_export').click(function(){
    let s = activeScope(),
        ...
        url = '<?php echo e(route("agreements.index")); ?>',
...
<?php /**PATH /var/www/developmentoneso-project/resources/views/agreements/index.blade.php ENDPATH**/ ?>