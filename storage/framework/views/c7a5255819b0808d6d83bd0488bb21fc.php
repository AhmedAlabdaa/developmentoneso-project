            ...
            <?php $__currentLoopData = $candidates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $candidate): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr class="<?php echo e($candidate->appeal == 1 ? 'table-warning appeal-row' : ''); ?>">
                    ...
                    <td class="actions">
                        ...
                        <?php endif; ?>
                        <?php if(in_array(Auth::user()->role, ['Sales Officer', 'Sales Coordinator','Sales Manager']) && $candidate->current_status == 5): ?>
...
<?php /**PATH /var/www/developmentoneso-project/resources/views/candidates/partials/candidates_table_14.blade.php ENDPATH**/ ?>