...
<script>
    $(document).ready(function () {
        $('#csvUploadForm').on('submit', function (e) {
            ...
            $.ajax({
                url: '<?php echo e(route('staff.process_csv_upload')); ?>',
                method: 'POST',
                data: formData,
                contentType: false,
                processData: false,
...
</script><?php /**PATH /var/www/developmentoneso-project/resources/views/candidates/upload_staff_csv_file.blade.php ENDPATH**/ ?>