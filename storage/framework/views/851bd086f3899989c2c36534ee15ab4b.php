                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <select class="form-select" id="parent_account_code_form" name="parent_account_code">
                                ...
                                <?php $__currentLoopData = $parentAccounts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $account): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($account->account_code); ?>">
...
<script>
    ...
    function loadAccounts(url = null) {
        ...
        $.ajax({
            url: url || '<?php echo e(route("chart-of-accounts.index")); ?>',
            type: 'GET',
            data: formData,
    ...
    $(document).ready(function () {
        ...
        $('#saveAccountBtn').on('click', function () {
            ...
            $.ajax({
                url: '<?php echo e(route("chart-of-accounts.store")); ?>',
                method: 'POST',
                data: payload,
...
<?php /**PATH /var/www/developmentoneso-project/resources/views/chart_of_accounts/index.blade.php ENDPATH**/ ?>