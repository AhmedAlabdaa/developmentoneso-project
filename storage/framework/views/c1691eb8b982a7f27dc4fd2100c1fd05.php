...
<div class="row" style="margin-bottom:10px;">
    <div class="float-l col-80">
        <table class="section-table">
            <tr><th class="ltr">Reference No</th><td><?php echo e($candidate->ref_no ?: 'N/A'); ?></td><th class="rtl">الرقم المرجعي</th></tr>
    ...
    <div class="float-l col-20 text-center">
        <img src="<?php echo e($passportUrl ?: ''); ?>" class="img-thumb" style="width:170px;height:138px;margin-left:10px;">
    </div>
</div>
...
<div class="row" style="align-items:flex-start">
    ...
    <div class="float-l col-40">
        ...
        <div class="text-center">
            <img src="<?php echo e($fullBodyUrl ?: ''); ?>" class="img-thumb" style="width:350px;height:630px;margin-left: 10px;margin-top:10px;">
        </div>
    </div>
</div>
<?php /**PATH /var/www/developmentoneso-project/resources/views/candidates/download_cv.blade.php ENDPATH**/ ?>