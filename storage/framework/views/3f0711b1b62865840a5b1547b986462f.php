                        ...
                        <form action="<?php echo e(route('crm.store')); ?>" method="POST" enctype="multipart/form-data" class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="address" class="form-control" id="address" value="<?php echo e(old('address')); ?>" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="passport_number" class="form-control" id="passport_number" value="<?php echo e(old('passport_number')); ?>" required>
                                </div>
                            </div>
                            <div class="col-md-6">
...
<?php /**PATH /var/www/developmentoneso-project/resources/views/incidents/create.blade.php ENDPATH**/ ?>