    ...
    <table class="clause-table">
      <tr>
        <td class="eng">
          ...
          <strong><?php echo e($totalAmount); ?> AED</strong> in the following manner:<br>
          Two payments: the first payment upon receipt of the worker: <strong><?php echo e($received); ?></strong>.
          The second payment: <strong><?php echo e($remaining); ?></strong> before the end of the probationary period (four days from the date of receiving the worker).
        </td>
        <td class="ara">
          <span class="clause-title">
          ...
          <strong><?php echo e($totalAmount); ?> درهم</strong> بالطريقة التالية:<br>
          دفعتين: الدفعة الأولى عند تسلم العامل: <strong><?php echo e($received); ?></strong>.
          الدفعة الثانية: <strong><?php echo e($remaining); ?></strong> قبل نهاية فترة التجربة (أربعة أيام من تاريخ استلام العامل).
        </td>
      </tr>
      <tr>
        <td class="eng">
          ...
          <strong><?php echo e($agreementStart); ?></strong> the date the worker received it until the date of
          <strong><?php echo e($agreementEnd); ?></strong>.
        </td>
        <td class="ara">
          <span class="clause-title">البند الثاني: "فترة التجربة"</span><br>
          يوضع العامل تحت التجربة لمدة 4 أيام تبدأ من
          <strong><?php echo e($agreementStart); ?></strong> حتى <strong><?php echo e($agreementEnd); ?></strong>.
        </td>
      </tr>
      <tr>
        <td class="eng">
...
<?php /**PATH /var/www/developmentoneso-project/resources/views/agreements/trial_agreement_download.blade.php ENDPATH**/ ?>