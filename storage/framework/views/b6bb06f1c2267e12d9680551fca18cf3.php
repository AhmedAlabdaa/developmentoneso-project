...
<div class="button-container">
    ...
    <a href="<?php echo e(url('employee-with-information')); ?>" class="btn btn-secondary">
        ...
        <div class="col-lg-9">
            <table class="table section-table">
                <tr>
                    ...
                    <td class="info-column"><?php echo e($candidate->cn_number_series ?? 'N/A'); ?></td>
...
<?php /**PATH /var/www/developmentoneso-project/resources/views/employee/cv.blade.php ENDPATH**/ ?>