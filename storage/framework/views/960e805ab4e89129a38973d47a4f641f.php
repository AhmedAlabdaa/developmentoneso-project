            ...
            <?php $__currentLoopData = $candidates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $candidate): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr class="<?php echo e($candidate->appeal == 1 ? 'table-warning appeal-row' : ''); ?>">
                    ...
                    <td class="text-center">
                        ...
                        ?>
                        <div><?php echo e(strtoupper(\Carbon\Carbon::parse($dateToShow)->timezone('Asia/Qatar')->format('d-M-Y'))); ?></div>
                        <div><?php echo e(strtoupper(\Carbon\Carbon::parse($dateToShow)->timezone('Asia/Qatar')->format('h:i A'))); ?></div>
                    </td>
...
<?php /**PATH /var/www/developmentoneso-project/resources/views/candidates/partials/candidates_table_inside.blade.php ENDPATH**/ ?>