        ...
        <tbody>
            ...
            <?php else: ?>
                <?php $__currentLoopData = $invoices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $invoice): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                       <td><a href="<?php echo e(route('invoices.show', $invoice->invoice_number)); ?>" class="text-primary" target="_blank"><?php echo e($invoice->invoice_number); ?></a></td>
                        <td><a href="<?php echo e(route('agreements.show', $invoice->agreement_reference_no)); ?>" class="text-primary" target="_blank"><?php echo e($invoice->agreement_reference_no); ?></a></td>
                        <td><a href="<?php echo e(route('crm.show', $invoice->customer->slug ?? '')); ?>" class="text-primary" target="_blank"><?php echo e($invoice->CL_Number); ?></a></td>
                        <td><a href="<?php echo e(route('candidates.show', $invoice->candidate->reference_no ?? '')); ?>" class="text-primary" target="_blank"><?php echo e($invoice->CN_Number); ?></a></td>
                        <td>
                          <?php $cust = optional($invoice->customer); ?>
                          <a href="<?php echo e($cust->slug ? route('crm.show', $cust->slug) : '#'); ?>"
                             class="text-primary"
                             target="_blank">
                        ...
                        <td><a href="<?php echo e(route('candidates.show', $invoice->candidate->reference_no ?? '')); ?>"><?php echo e(optional($invoice->candidate)->candidate_name ?: optional($invoice->candidate)->name); ?></a></td>
                        <td>
                            <select class="status-dropdown" data-invoice-id="<?php echo e($invoice->invoice_id); ?>" onchange="confirmInvoiceStatusChangeofEmployees(this, <?php echo e($invoice->invoice_id); ?>, '<?php echo e($invoice->customer->first_name ?? ''); ?>', '<?php echo e($invoice->received_amount); ?>', '<?php echo e($invoice->agreement_reference_no); ?>' , '<?php echo e($invoice->invoice_type); ?>')">
                        ...
                        <td class="actions">
                            <button type="button" class="btn btn-success btn-icon-only" title="View Payment Proof" data-bs-toggle="modal" data-bs-target="#paymentProofModal<?php echo e($invoice->invoice_number); ?>">
                                <i class="fas fa-receipt"></i>
                            </button>
                            <a href="<?php echo e(route('invoices.show', $invoice->invoice_number)); ?>" class="btn btn-info btn-icon-only" title="View">
                        ...
                        <div class="modal-dialog modal-dialog-centered modal-lg">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="paymentProofLabel<?php echo e($invoice->invoice_number); ?>">Payment Proof</h5>
                                ...
                                <div class="modal-body text-center">
                                    <?php if(!empty($invoice->payment_proof)): ?>
                                        ...
                                        ?>
                                        <?php if(in_array($fileExtension, ['jpg', 'jpeg', 'png', 'gif', 'bmp'])): ?>
                                            <div id="lightGallery<?php echo e($invoice->invoice_number); ?>" class="lightgallery">
...
<?php /**PATH /var/www/developmentoneso-project/resources/views/employee/partials/rvo_table.blade.php ENDPATH**/ ?>