    ...
    <table class="table table-striped table-hover">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <?php switch((int) $agreement->status):
                        case (1): ?>
                ...
                <td>
                    <a href="<?php echo e(route('candidates.show', $agreement->reference_of_candidate)); ?>" class="text-primary" target="_blank">
                        <?php echo e($agreement->CN_Number); ?>

                    </a>
                </td>
                <td>-</td>
                <td>
                    <a href="<?php echo e(route('crm.show', $agreement->client->slug)); ?>" class="text-primary" target="_blank">
                        <?php echo e($agreement->CL_Number); ?>

                    </a>
                </td>
                <td><?php echo e(\Carbon\Carbon::parse($agreement->created_at)->format('d-m-Y H:i:s')); ?></td>
                <td>
                    <?php if($agreement->client): ?>
                        <a href="<?php echo e(route('crm.show', $agreement->client->slug)); ?>" class="text-primary">
                            <?php echo e($agreement->client->name ?? ''); ?>
                ...
                <td><?php echo e($agreement->Nationality->name ?? ''); ?></td>
                ...
                <td><?php echo e($agreement->agreement_end_date ? \Carbon\Carbon::parse($agreement->agreement_end_date)->format('d-m-Y') : 'N/A'); ?></td>
                <td><?php echo e($agreement->number_of_days ?? 'NA'); ?></td>
                ...
                <td class="actions">
                    ...
                    <a href="<?php echo e(route('agreements.print', $agreement->reference_no)); ?>" class="btn btn-primary btn-icon-only" title="Print">
...
<nav aria-label="Page navigation">
    <div class="pagination-container">
        <span class="muted-text">
            Showing <?php echo e($agreements->firstItem()); ?> to <?php echo e($agreements->lastItem()); ?> of <?php echo e($agreements->total()); ?> results
        </span>
        <ul class="pagination justify-content-center">
            <?php echo e($agreements->links('vendor.pagination.bootstrap-4')); ?>
...
<?php /**PATH /var/www/developmentoneso-project/resources/views/agreements/partials/agreement_contract_tracker_table.blade.php ENDPATH**/ ?>