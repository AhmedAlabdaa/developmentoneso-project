...
<head>
  ...
  <link rel="icon" href="<?php echo e(asset('assets/img/' . $logoFileName)); ?>">
  <link rel="apple-touch-icon" href="<?php echo e(asset('assets/img/' . $logoFileName)); ?>">
  ...
  <style>
    ...
    .top-buttons .btn { font-size:14px; display:flex; align-items:center; gap:6px; transition:background .3s; }
    ...
    .comments-section h3 { font-size:16px; margin-bottom:5px; }
    .comments-section p { padding:8px; border:1px solid #ddd; min-height:80px; }
    ...
    .custom-modal .modal-body { background:#f9f9f9; padding:20px; max-height:400px; overflow-y:auto; }
    .custom-modal .modal-footer { background:#f1f9f1; padding:15px; border-radius:0 0 12px 12px; justify-content:center; }
...
<body>
  <div class="container">
    <div class="top-buttons">
      <a href="<?php echo e(route('invoices.download',$invoice->invoice_number)); ?>" class="btn btn-sm btn-outline-primary">
        <i class="fas fa-download"></i> Download
      </a>
      <button class="btn btn-sm btn-outline-info" onclick="shareInvoice('<?php echo e($invoice->invoice_number); ?>')">
    ...
    <img src="<?php echo e(asset('assets/img/' . $headerFileName)); ?>" class="img-fluid mb-3">

    <div class="tax-invoice"><?php echo e($invoice->invoice_type); ?> Invoice</div>
    ...
    <table class="outer-table">
      <tr>
        ...
        <td style="width:50%;padding-left:10px">
          <table class="inner-table w-100">
            <tr><th>Contract Ref.</th><td><?php echo e($invoice->agreement->reference_no); ?></td></tr>
            <tr><th>Contract Type</th><td><?php echo e($invoice->agreement->agreement_type); ?></td></tr>
            <tr><th>Maid Name</th><td><?php echo e($invoice->agreement->candidate_name); ?></td></tr>
    ...
    <table class="totals-table">
      <tr><td><strong>Subtotal</strong></td><td><?php echo e(number_format($net,2)); ?> AED</td></tr>
      <tr><td><strong>VAT (5%)</strong></td><td><?php echo e(number_format($vat,2)); ?> AED</td></tr>
      <tr><td><strong>Total</strong></td><td><?php echo e(number_format($total,2)); ?>  AED</td></tr>
      <tr><td><strong>Received</strong></td><td><?php echo e(number_format($received,2)); ?>  AED</td></tr>
      <tr><td><strong>Balance</strong></td><td><?php echo e(number_format($balance,2)); ?> AED</td></tr>
    </table>
    ...
    <div class="footer"><img src="<?php echo e(asset('assets/img/' . $footerFileName)); ?>" class="img-fluid"></div>
  </div>
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
      <div class="modal-content">
        <div class="modal-header">
          <i class="fas fa-edit me-2"></i><h5 class="modal-title" id="editInvoiceLabel">Edit Invoice</h5>
        ...
        <div class="modal-body scrollable-modal-body">
          <form id="edit_invoice_form" enctype="multipart/form-data">
            ...
            <div class="alert-note mb-3">Updating these will reflect in agreements and contracts.</div>
            <div class="mb-3">
              <label><i class="fas fa-calculator"></i> Total Amount</label>
              <input type="number" name="total_amount" class="form-control form-control-sm" value="<?php echo e(number_format($invoice->total_amount,2,'.','')); ?>" step="0.01" required>
            </div>
            <div class="mb-3">
              <label><i class="fas fa-money-bill-wave"></i> Received Amount</label>
              <input type="number" name="received_amount" class="form-control form-control-sm" value="<?php echo e(number_format($invoice->received_amount,2,'.','')); ?>" step="0.01" required>
            </div>
            <div class="mb-3">
              <label><i class="fas fa-credit-card"></i> Payment Method</label>
              <select name="payment_method" class="form-select form-select-sm" required>
                <?php $__currentLoopData = $paymentMethods; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $method): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <option value="<?php echo e($method); ?>" <?php if($invoice->payment_method==$method): ?> selected <?php endif; ?>><?php echo e($method); ?></option>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
              </select>
            </div>
            <?php if($invoice->payment_proof): ?>
            <div class="text-center mb-3">
              <img src="<?php echo e(Storage::url($invoice->payment_proof)); ?>" class="img-thumbnail" alt="Proof">
            </div>
            <div class="text-center mb-3">
              <a href="<?php echo e(Storage::url($invoice->payment_proof)); ?>" download class="btn btn-sm btn-outline-info">
        ...
        <div class="modal-footer">
          ...
          <button type="submit" form="edit_invoice_form" class="btn btn-primary btn-sm"><i class="fas fa-sync-alt"></i> Update</button>
        </div>
      </div>
    </div>
  </div>
  ...
  <script>
    ...
    $('#edit_invoice_form').submit(function(e){
      ...
      $.ajax({
        url: `<?php echo e(url('invoices/update-invoice')); ?>`,
        method: 'POST',
        data: fd,
        processData: false,
        contentType: false
...
<?php /**PATH /var/www/developmentoneso-project/resources/views/invoices/show.blade.php ENDPATH**/ ?>