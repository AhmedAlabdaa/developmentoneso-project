    ...
    <table class="table table-striped table-hover">
        ...
        <tbody>
            <?php $__empty_1 = true; $__currentLoopData = $histories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $history): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <tr>
                    <td> 
                        <a href="<?php echo e(route('contracts.show', $history->contract_number)); ?>" class="text-primary" target="_blank">
                            REP-CT-E-<?php echo e($history->id); ?>

                        </a>
                    <td>
                        <a href="<?php echo e(route('contracts.show', $history->contract_number)); ?>" class="text-primary" target="_blank">
                            <?php echo e($history->contract_number); ?>

                        </a>
                    </td>
                    <td>
                        <?php if($history->client): ?>
                            <a href="<?php echo e(route('crm.show', $history->client->slug)); ?>" class="text-primary" target="_blank">
                                <?php echo e($history->client->first_name); ?> <?php echo e($history->client->last_name); ?>
                    ...
                    <td>
                        <?php if($history->oldCandidate): ?>
                            <a href="<?php echo e(route('employees.show', $history->oldCandidate->id)); ?>" class="text-primary" target="_blank">
                                <?php echo e($history->oldCandidate->name); ?>
                    ...
                    <td>
                        <?php if($history->newCandidate): ?>
                            <a href="<?php echo e(route('employees.show', $history->newCandidate->id)); ?>" class="text-primary" target="_blank">
                                <?php echo e($history->newCandidate->name); ?>
                    ...
                    <td><?php echo e(Carbon::parse($history->replacement_date)->format('d M Y')); ?></td>
                    <td><?php echo e(Carbon::parse($history->created_at)->format('d M Y h:i A')); ?></td>
                </tr>
...
<nav aria-label="Page navigation">
    <div class="d-flex justify-content-between align-items-center">
        <span class="text-muted small">
            Showing <?php echo e($histories->firstItem()); ?>–<?php echo e($histories->lastItem()); ?> of <?php echo e($histories->total()); ?> results
        </span>
...
<?php /**PATH /home/developmentoneso/public_html/resources/views/employee/partials/replacements_table.blade.php ENDPATH**/ ?>