...
<div class="wrap">
  <div class="header">
    <img src="<?php echo e(asset('assets/img/' . $headerFile)); ?>" alt="">
  </div>
  <div class="footer">
    <img src="<?php echo e(asset('assets/img/' . $footerFile)); ?>" alt="">
  </div>
  <div class="content">
    <h1>
    ...
    <table class="table">
      <tr>
        ...
        <td class="value"><?php echo e($val($record->ref_no ?? null)); ?></td>
        <td class="label-ar">رقم المرجع</td>
      </tr>
      <tr>
        <td class="label">Date</td>
        <td class="value"><?php echo e($fmt($record->date ?? now())); ?></td>
    ...
    <table class="table" style="margin-top:10px">
      ...
      <tr>
        ...
        <td class="value"><?php echo e($fmt($record->work_start_date ?? null)); ?></td>
        <td class="label-ar">تاريخ بداية العمل</td>
      </tr>
      <tr>
        <td class="label">RETURN DATE</td>
        <td class="value"><?php echo e($fmt($record->return_date ?? null)); ?></td>
        <td class="label-ar">تاريخ إرجاع العاملة</td>
      </tr>
      <tr>
        <td class="label">CONTRACT AMOUNT</td>
        <td class="value"><?php echo e($qar($record->total_amount ?? null)); ?></td>
        <td class="label-ar">قيمة العقد</td>
      </tr>
      <tr>
        <td class="label">ADVANCE AMOUNT</td>
        <td class="value"><?php echo e($qar($record->received_amount ?? null)); ?></td>
        <td class="label-ar">دفعة مقدمة</td>
      </tr>
      <tr>
        <td class="label">PAYMENT METHOD</td>
        <td class="value"><?php echo e($val($record->payment_method ?? null)); ?></td>
        <td class="label-ar">طريقة الدفع</td>
      </tr>
      <tr>
        <td class="label">BALANCE DUE</td>
        <td class="value"><?php echo e($qar($record->remaining_amount ?? null)); ?></td>
        <td class="label-ar">المبلغ المستحق</td>
      </tr>
      <tr>
        <td class="label">SALES OFFICER NAME</td>
        <td class="value"><?php echo e($val($record->sales_officer_name ?? null)); ?></td>
    ...
    <table class="table" style="margin-top:10px">
      ...
      <tr>
        <td colspan="3" style="height:70px;text-align:center;vertical-align:top;padding-top:8px">
          <?php echo e($val($record->remarks ?? null)); ?>
...
<?php /**PATH /var/www/developmentoneso-project/resources/views/package/package/trial_form.blade.php ENDPATH**/ ?>