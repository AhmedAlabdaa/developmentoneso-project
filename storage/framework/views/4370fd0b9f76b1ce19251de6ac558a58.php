...
<div id="salary-slip-print">
  <div class="salary-slip-wrapper">
    <?php if($headerPath): ?>
      <img src="<?php echo e($headerPath); ?>" alt="Header" class="salary-slip-header-img">
    <?php endif; ?>

    <div class="salary-slip-meta">
      <span>Date of Issuing: <?php echo e($issueDate->format('d-m-Y')); ?></span>
      <span>Reference No.: <?php echo e($refNo); ?></span>
    </div>
    ...
    <table class="salary-slip-table">
      ...
      <?php $__currentLoopData = $rows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        ?>
        <tr>
          <td><?php echo e(strtoupper($row->client_name ?? '-')); ?></td>
          <td class="salary-slip-text-center"><?php echo e($days); ?></td>
          <td class="salary-slip-text-center"><?php echo e($mode); ?></td>
    ...
    <div class="salary-slip-ack">
      I, <?php echo e($candidateName); ?>, hereby acknowledge that I have received the above-mentioned salary amount from Company Name.
    </div>
    ...
    <?php if($footerPath): ?>
      <img src="<?php echo e($footerPath); ?>" alt="Footer" class="salary-slip-footer-img">
    <?php endif; ?>
  </div>
</div>
...
<?php /**PATH /var/www/developmentoneso-project/resources/views/package/package/partials/print.blade.php ENDPATH**/ ?>