    ...
    <table class="table table-striped table-hover">
        <thead>
            <tr>
                ...
                <th title="MOL Issued Date">MOL-Issued</th>
        ...
        <tbody>
            ...
            <?php $__currentLoopData = $candidates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $candidate): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr class="<?php echo e($candidate->appeal == 1 ? 'table-warning appeal-row' : ''); ?>">
                    ...
                    <td><button class="btn btn-primary"><?php echo e(strtoupper(\Carbon\Carbon::parse($candidate->mol_issued_date)->format('d M Y'))); ?></button></td>
...
<?php /**PATH /var/www/developmentoneso-project/resources/views/candidates/partials/candidates_table_12.blade.php ENDPATH**/ ?>