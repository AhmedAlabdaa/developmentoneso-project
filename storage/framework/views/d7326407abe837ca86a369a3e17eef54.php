          ...
          <table id="packages-table" class="table table-striped table-hover align-middle">
            ...
            <tbody>
              <?php $__currentLoopData = $packages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                ?>
                <tr id="pkg-row-<?php echo e($p->id); ?>">
                  <td><?php echo e($loop->iteration); ?></td>
                  <td class="cell-cn"><?php echo e($cand->CN_Number ?? $p->CN_Number ?? ''); ?></td>
                  <td class="cell-name"><?php echo e($cand->candidate_name ?? $p->candidate_name ?? ''); ?></td>
                  <td class="cell-passport"><?php echo e($cand->passport_no ?? $p->passport_no ?? ''); ?></td>
                  <td class="cell-slug"><?php echo e($p->slug); ?></td>

                  
                  <td class="cell-title">
                    <div><span class="lang-chip">EN</span> <span class="val-en"><?php echo e($p->meta_title); ?></span></div>
                    <div class="mt-1"><span class="lang-chip ar">AR</span> <span class="val-ar"><?php echo e($p->meta_title_ar); ?></span></div>
                  </td>

                  
                  <td class="cell-keywords">
                    <div class="text-truncate"><span class="lang-chip">EN</span> <span class="val-en"><?php echo e($p->meta_keywords); ?></span></div>
                    <div class="text-truncate mt-1"><span class="lang-chip ar">AR</span> <span class="val-ar"><?php echo e($p->meta_keywords_ar); ?></span></div>
                  </td>

                  
                  <td class="cell-description">
                    <div class="text-truncate"><span class="lang-chip">EN</span> <span class="val-en"><?php echo e($p->meta_description); ?></span></div>
                    <div class="text-truncate mt-1"><span class="lang-chip ar">AR</span> <span class="val-ar"><?php echo e($p->meta_description_ar); ?></span></div>
                  </td>
                  ...
                  <td class="text-center">
                    <button
                      ...
                      data-row="#pkg-row-<?php echo e($p->id); ?>"
                      data-cn="<?php echo e($cand->CN_Number ?? $p->CN_Number ?? ''); ?>"
                      data-name="<?php echo e($cand->candidate_name ?? $p->candidate_name ?? ''); ?>"
                      data-passport="<?php echo e($cand->passport_no ?? $p->passport_no ?? ''); ?>"
                      data-slug="<?php echo e(e($p->slug)); ?>"
                      data-title-en="<?php echo e(e($p->meta_title)); ?>"
                      data-title-ar="<?php echo e(e($p->meta_title_ar)); ?>"
                      data-keywords-en="<?php echo e(e($p->meta_keywords)); ?>"
                      data-keywords-ar="<?php echo e(e($p->meta_keywords_ar)); ?>"
                      data-description-en="<?php echo e(e($p->meta_description)); ?>"
                      data-description-ar="<?php echo e(e($p->meta_description_ar)); ?>"
                      title="Edit SEO/Slug"
                    >
...
<script>
  ...
  const updateUrlTemplate = "<?php echo e(route('available-packages.update', ':id')); ?>";
  let dt;
...
<?php /**PATH /var/www/developmentoneso-project/resources/views/web_manager/available-packages.blade.php ENDPATH**/ ?>