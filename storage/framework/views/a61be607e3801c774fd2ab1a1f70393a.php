    ...
    <table class="table table-striped table-hover">
        <thead>
            <tr>
                ...
                <th title="Departure Date">Departure Date</th>
                ...
                <th title="Labour ID #">Labour ID #</th>
                ...
                <th title="PCC Date">PCC Date</th>
                <th title="PCC Status">PCC Status</th>
                <th title="EMBASSY SUBMITTED">EMBASSY SUBMITTED</th>
                <th title="PEMBASSY RELEASED">EMBASSY RELEASED</th>
                <th title="INSURANCE DATE">INSURANCE DATE</th>
                <th title="INSURANCE STATUS">INSURANCE STATUS</th>
            ...
            <?php $__currentLoopData = $candidates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $candidate): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr class="<?php echo e($candidate->appeal == 1 ? 'table-warning appeal-row' : ''); ?>">
                    ...
                    <td>
                        ...
                        <img src="<?php echo e(asset('assets/img/attach.png')); ?>" alt="Attachment Icon" style="cursor: pointer; margin-left: 8px; vertical-align: middle; height: 20px;" title="View Attachments of the Candidate" onclick="showCandidateModal('<?php echo e($candidate->candidate_name); ?>', '<?php echo e($candidate->id); ?>', '<?php echo e($candidate->reference_no); ?>')"/>
                    </td>
                    <td><button class="btn btn-primary"><?php echo e(strtoupper(\Carbon\Carbon::parse($candidate->departure_date)->format('d M Y'))); ?></button></td>
                    ...
                    <td><?php echo e($candidate->wc_date ? \Carbon\Carbon::parse($candidate->wc_date)->format('d M Y') : 'N/A'); ?></td>
                    ...
                    <td><?php echo e(strtoupper(explode(' ', $candidate->foreign_partner, 2)[0] . '-' . (trim(str_replace('-', '', substr($candidate->foreign_partner, strrpos($candidate->foreign_partner, '-') + 1))) ? implode('', array_map(fn($word) => strtoupper($word[0]), explode(' ', trim(substr($candidate->foreign_partner, strrpos($candidate->foreign_partner, '-') + 1))))) : 'HO'))); ?></td>
                    ...
                    <td><?php echo e(strtoupper(\Carbon\Carbon::parse($candidate->passport_expiry_date)->format('d M Y'))); ?></td>
                    <td><?php echo e(strtoupper(\Carbon\Carbon::parse($candidate->date_of_birth)->format('d M Y'))); ?></td>
                    ...
                    <td><?php echo e(strtoupper($candidate->pcc_date)); ?></td>
                    <td><?php echo e(strtoupper($candidate->pcc_status)); ?></td>
                    <td><?php echo e(strtoupper($candidate->embassy_submitted_date)); ?></td>
                    <td><?php echo e(strtoupper($candidate->embassy_released_date)); ?></td>
                    <td><?php echo e(strtoupper($candidate->insurance_date)); ?></td>
                    <td><?php echo e(strtoupper($candidate->insurance_status)); ?></td>
                    <?php
                        ...
                        if (in_array($userRole, ['Admin', 'Operations Manager','Managing Director','Sales Manager'], true)) {
                            ...
                            } elseif (in_array($candidateStatus, [13])) {
                                $dropdownStatuses = [
                                    6 => 'Departure Date',
                                    15 => 'Arrived Date',
                                    16 => 'Incident After Arrival (IAA)'
                    ...
                    ?>
                    <td class="actions">
                        <a href="/<?php echo e($candidate->reference_no); ?>/cv" target="_blank" class="btn btn-info btn-icon-only ms-1" title="View CV">
                        ...
                        <a href="javascript:void(0);" class="btn btn-primary btn-icon-only" title="Change Status"
                           onclick="openDropdown('<?php echo e($candidate->id); ?>', this, '<?php echo e($candidate->candidate_name ? strtoupper(\Illuminate\Support\Str::title(strtolower($candidate->candidate_name))) : 'N/A'); ?>')">
                        ...
                        <div class="dropdown-container" id="dropdownContainer-<?php echo e($candidate->id); ?>" style="display: none;">
                            ...
                            <select class="form-control status-dropdown"
                                    id="statusDropdown-<?php echo e($candidate->id); ?>"
                                    name="current_status"
                                    onchange="confirmStatusChange(this, '<?php echo e($candidate->id); ?>', '<?php echo e($candidate->candidate_name); ?>')">
                                <?php $__currentLoopData = $dropdownStatuses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $statusId => $statusName): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($statusId); ?>" <?php echo e($candidateStatus == $statusId ? 'selected' : ''); ?>>
                        ...
                        <?php if($candidate->appeal == 1): ?>
                            <a href="javascript:void(0);"
                               ...
                               data-bs-target="#appealModal-<?php echo e($candidate->reference_no); ?>">
                                ⚠️
                            </a>
                        <?php endif; ?>
                        <?php if(in_array(Auth::user()->role, ['Sales Officer', 'Sales Coordinator']) && $candidate->current_status == 5): ?>
...
<?php /**PATH /var/www/developmentoneso-project/resources/views/candidates/partials/candidates_table_13.blade.php ENDPATH**/ ?>