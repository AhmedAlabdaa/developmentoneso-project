...
<head>
<meta charset="utf-8">
<title><?php echo e($formTitle ?? 'Worker Return Form'); ?></title>
...
<div class="wrap">
  ...
  <div class="content">
    <h1>
      <span><?php echo e($formTitle ?? 'WORKER RETURN FORM'); ?></span>
    ...
    <table class="table mt file-details">
      ...
      <tr>
        ...
        <td class="value"><?php echo e($v($record->maid_worked_days ?? '0')); ?></td>
        <td class="label">
      ...
      <tr>
        ...
        <td class="value money"><?php echo e($q($record->refund_amount ?? null)); ?></td>
        <td class="label">
          DUE DATE
          <span style="font-weight:400;direction:rtl;text-align:right;font-size:10px;display:block">
            تاريخ الاستحقاق
        ...
        <td class="value" colspan="3"><?php echo e($d($record->refund_replace_date ?? null)); ?></td>
      </tr>
    </table>
    <table class="table mt file-details">
      ...
      <tr>
        ...
        <td class="value money"><?php echo e($q($workerSalaryAmount)); ?></td>
      </tr>
      <tr>
        <td class="label">
          NOC STATUS
      ...
      <tr>
        ...
        <td class="value" colspan="3"><?php echo e($decision); ?></td>
      </tr>
    </table>
    ...
    <table class="table mt">
      <tr>
        ...
        <td class="value" style="text-align:left;font-weight: bold;color: red;"><?php echo e($v($record->return_reason ?? '')); ?></td>
      </tr>
    </table>
...
<?php /**PATH /var/www/developmentoneso-project/resources/views/package/package/trial_return_form.blade.php ENDPATH**/ ?>