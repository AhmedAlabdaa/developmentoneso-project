        ...
        <tbody>
            ...
            <?php $__currentLoopData = $candidates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $candidate): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr class="<?php echo e($candidate->appeal == 1 ? 'table-warning appeal-row' : ''); ?>">
                    ...
                    <td><?php echo e($candidate->visa_date ? \Carbon\Carbon::parse($candidate->visa_date)->format('d M Y') : 'N/A'); ?></td>
                    ...
                    <?php
                        ...
                        if (in_array($userRole, ['Admin', 'Operations Manager','Managing Director','Sales Manager'], true)) {
                            ...
                            } elseif (in_array($candidateStatus, [5, 6 , 7])) {
                                $dropdownStatuses = [
                                    5 => 'WC-Date',
                                    6 => 'Incident Before Visa (IBV)',
                                    7 => 'Visa Date',
...
<?php /**PATH /var/www/developmentoneso-project/resources/views/candidates/partials/candidates_table_7.blade.php ENDPATH**/ ?>