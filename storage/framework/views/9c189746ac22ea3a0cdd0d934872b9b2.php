...
<style>
  ...
  @media print {
    ...
    .slip-header {
      ...
      height: <?php echo e($headerPrintHeight); ?>;
      width: 100%;
      object-fit: cover;
      z-index: 1000;
    }
    ...
    .slip-footer {
      ...
      height: <?php echo e($footerPrintHeight); ?>;
      width: 100%;
      object-fit: cover;
      z-index: 1000;
    }
    ...
    .slip-body {
      padding: 0;
      margin-top: <?php echo e($headerPrintHeight); ?>;
      margin-bottom: <?php echo e($footerPrintHeight); ?>;
      padding-top: 12mm;
      padding-right: 12mm;
      padding-bottom: 10mm;
      padding-left: 12mm;
...
<div id="salary-slip-print">
  <div class="slip-page">
    <img src="<?php echo e($headerFileName); ?>" alt="Header" class="slip-header">

    <div class="slip-body">
      <div class="slip-row">
        <div class="slip-col-left">
          <div class="slip-title">SALARY SLIP</div>
          <div class="slip-muted">Salary Date: <?php echo e($salaryDate); ?></div>
          <div class="slip-slipno">Slip No: <?php echo e($slipNo); ?></div>
          <div class="slip-muted">Printed: <?php echo e($printedAt); ?></div>
        </div>

        <div class="slip-col-right">
          <div class="slip-kv">
            <div><strong>Candidate:</strong> <?php echo e($candidateName); ?></div>
            <div><strong>Passport:</strong> <?php echo e($passportFinal); ?></div>
            <div><strong>Nationality:</strong> <?php echo e($nationality); ?></div>
            <div><strong>Salary To:</strong> <?php echo e($salaryType); ?></div>
            <?php if($lastPaymentMethodDisplay): ?>
              <div><strong>Salary Paid By:</strong> <?php echo e($lastPaymentMethodDisplay); ?></div>
            <?php endif; ?>
          </div>
        </div>
      </div>
      ...
      <div class="slip-card">
        ...
        <table class="slip-table">
          ...
          <tbody>
            <?php $__empty_1 = true; $__currentLoopData = $refundRows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $r): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
              <?php
              ...
              <tr>
                <td class="nowrap" style="font-weight:800;"><?php echo e($i + 1); ?></td>
                <td class="wrap"><?php echo e($sponsor); ?></td>
                <td class="wrap"><?php echo e($agreement); ?></td>
                <td class="text-center nowrap" style="font-weight:800;"><?php echo e($days); ?></td>
                <td class="text-right nowrap" style="font-weight:900;"><?php echo e(number_format($monthly, 2)); ?></td>
                <td class="text-right nowrap"><?php echo e(number_format($perDay, 2)); ?></td>
                <td class="text-right nowrap" style="font-weight:900;"><?php echo e(number_format($rowAmount, 2)); ?></td>
                <td class="nowrap"><?php echo e($rowDate); ?></td>
              </tr>
          ...
          <tfoot>
            <tr>
              ...
              <th class="text-center"><?php echo e($totalRefundDays); ?></th>
              <th></th>
              <th></th>
              <th class="text-right"><?php echo e(number_format($totalRowAmountV, 2)); ?></th>
              <th></th>
            </tr>
            <tr>
              <th colspan="6" class="text-right">Total Salary</th>
              <th colspan="2" class="text-right"><?php echo e($totalSalaryF); ?></th>
            </tr>
          </tfoot>
        </table>
      </div>
      ...
      <div class="slip-card">
        ...
        <table class="slip-table">
          ...
          <tbody>
            <?php $__empty_1 = true; $__currentLoopData = $payments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k => $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
              <?php
                $pid = (int)($p->id ?? 0);
              ...
              <tr>
                <td class="nowrap" style="font-weight:800;"><?php echo e($k + 1); ?></td>
                <td class="nowrap"><?php echo e($payDate); ?></td>
                <td class="wrap"><?php echo e($refNo); ?></td>
                <td class="wrap"><?php echo e($method); ?></td>
                <td class="wrap" style="line-height:1.35;"><?php echo e($note !== '' ? $note : '-'); ?></td>
                <td class="text-right nowrap" style="font-weight:900;"><?php echo e($amtF); ?></td>
                <td class="text-center no-print">
                  <button type="button" class="btn btn-sm btn-dark btn-print-ledger" data-payment-id="<?php echo e($pid); ?>" style="font-size:12px;font-weight:900;padding:4px 10px;border-radius:10px;">Print</button>
                </td>
              </tr>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
              <tr>
          ...
          <tfoot>
            <tr>
              ...
              <th class="text-right"><?php echo e($totalPaidF); ?></th>
              <th class="no-print"></th>
            </tr>
            <tr>
              <th colspan="5" class="text-right">Balance</th>
              <th class="text-right"><?php echo e($balanceF); ?></th>
              <th class="no-print"></th>
            </tr>
          </tfoot>
        </table>
      ...
      <div style="margin-top:14px;font-size:12px;line-height:1.55;">
        I, <strong><?php echo e($candidateName); ?></strong>, hereby acknowledge that I have received the above-mentioned salary amount from <strong><?php echo e($companyName); ?></strong>.
      </div>
    ...
    <img src="<?php echo e($footerFileName); ?>" alt="Footer" class="slip-footer">
  </div>
  ...
  <div id="print-templates" style="display:none;">
    <?php $__currentLoopData = $payments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
      ...
      <template id="ledger-print-<?php echo e($pid); ?>">
        <link rel="preconnect" href="https://fonts.googleapis.com">
        <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
        <link href="https://fonts.googleapis.com/css2?family=Montserrat:wght@400;600;700;800;900&display=swap" rel="stylesheet">
        ...
        <div class="p-slip-page">
          <img src="<?php echo e($headerFileName); ?>" alt="Header" class="p-slip-header">
          ...
          <div class="p-slip-body">
            <div style="display:flex;justify-content:space-between;align-items:flex-start;gap:14px;margin:0 0 14px 0;">
              <div style="font-weight:800;line-height:1.35;">
                <div>Date of Issuing: <?php echo e($issueDateP); ?></div>
                <div class="p-slipno">Slip No: <?php echo e($slipNoP); ?></div>
              </div>
              <div style="text-align:right;font-size:12px;line-height:1.45;">
                <div class="p-title">SALARY SLIP</div>
                <div>Salary Date: <?php echo e($salaryDate); ?></div>
                <div>Paid Date: <?php echo e($payDateP); ?></div>
                <div>Printed: <?php echo e($printedAt); ?></div>
              </div>
            </div>
            ...
            <table style="margin-bottom:14px;">
              ...
              <tr>
                ...
                <td style="text-align:right;width:22%;"><?php echo e(number_format($monthlySalary, 2)); ?></td>
              </tr>
              <tr>
                <td style="font-weight:800;">Passport No</td>
                <td><?php echo e($passportFinal); ?></td>
            ...
            <table style="margin-bottom:16px;">
              ...
              <tr>
                <td style="font-weight:700;"><?php echo e($particularRefP); ?></td>
                <td style="text-align:center;font-weight:700;">-</td>
                <td style="text-align:center;font-weight:700;"><?php echo e($methodP); ?></td>
                <td style="text-align:center;font-weight:800;"><?php echo e($amtP); ?></td>
              ...
              <tr>
                ...
                <td></td>
                <td></td>
                <td style="text-align:center;font-weight:900;"><?php echo e($amtP); ?></td>
                <td style="text-align:center;font-weight:900;">PAID</td>
              </tr>
            </table>
          ...
          <img src="<?php echo e($footerFileName); ?>" alt="Footer" class="p-slip-footer">
        </div>
      </template>
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
  </div>
</div>
<?php /**PATH /var/www/developmentoneso-project/resources/views/package/package/partials/slip.blade.php ENDPATH**/ ?>