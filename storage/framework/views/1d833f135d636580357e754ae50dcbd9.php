    ...
    <div class="card">
      <div class="card-body">
        ...
        <div class="action-buttons">
          <a href="<?php echo e(route('agreements.index')); ?>" class="btn btn-primary btn-sm">
            <i class="fas fa-arrow-left"></i> Back to Agreements
          </a>
          <?php $isApproved = ($agreement->marked === 'Yes'); ?>
        ...
        <div class="agreement-info text-start">
          ...
          <strong><?php echo e($agreement->reference_no); ?></strong>
        </div>
        ...
        <div class="table-responsive mt-3">
          <table class="table table-striped table-hover">
            ...
            <tbody>
              <tr>
                <td><?php echo e(strtoupper($agreement->candidate_name)); ?></td>
                <td><?php echo e(strtoupper(optional($agreement->client)->first_name . ' ' . optional($agreement->client)->last_name)); ?></td>
...
<script>
  (function () {
    ...
    const refNo = <?php echo json_encode($agreement->reference_no, 15, 512) ?>;
    ...
    btn.addEventListener('click',function(){
      ...
      setLoading(true);
      fetch(`<?php echo e(route('agreements.update-marked')); ?>`,{
        method:'POST',
...
<?php /**PATH /var/www/developmentoneso-project/resources/views/agreements/agreement_non_approved_page.blade.php ENDPATH**/ ?>