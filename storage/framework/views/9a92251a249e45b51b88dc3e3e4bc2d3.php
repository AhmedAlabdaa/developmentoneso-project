      ...
      <div class="col-lg-12">
        <div class="card">
          <div class="card-body">
            ...
            <form action="<?php echo e(route('package.update', $package->id)); ?>" method="POST" class="row g-3" enctype="multipart/form-data" id="packageFormEdit">
              <?php echo csrf_field(); ?>
              ...
              <div class="col-md-6">
                ...
                <div class="input-group">
                  ...
                  <input type="text" name="candidate_name" id="candidate_name" class="form-control" value="<?php echo e(old('candidate_name', $package->candidate_name)); ?>" required>
                </div>
              </div>
              ...
              <div class="col-md-6">
                ...
                <div class="input-group">
                  ...
                  <input type="text" name="passport_no" id="passport_no" class="form-control" value="<?php echo e(old('passport_no', $package->passport_no)); ?>" required>
                </div>
              </div>
              ...
              <div class="col-md-6">
                ...
                <div class="input-group">
                  ...
                  <input type="date" name="passport_expiry_date" id="passport_expiry_date" class="form-control" value="<?php echo e(old('passport_expiry_date', $package->passport_expiry_date)); ?>">
                </div>
              </div>
              ...
              <div class="col-md-6">
                ...
                <div class="input-group">
                  ...
                  <input type="date" name="date_of_birth" id="date_of_birth" class="form-control" value="<?php echo e(old('date_of_birth', $package->date_of_birth)); ?>">
                </div>
              </div>
              ...
              <div class="col-md-6">
                ...
                <select name="visa_type" id="visa_type" class="form-select select2-visa">
                  <option value="" <?php echo e(old('visa_type', $package->visa_type)=='' ? 'selected' : ''); ?>>Select Visa Type</option>
                  ...
                  <option value="C-SPO"     <?php echo e(old('visa_type', $package->visa_type)=='C-SPO' ? 'selected' : ''); ?>>C-SPO</option>
                  <option value="OFFICE-V"  <?php echo e(old('visa_type', $package->visa_type)=='OFFICE-V' ? 'selected' : ''); ?>>OFFICE-V</option>
                  <option value="HAYYA"     <?php echo e(old('visa_type', $package->visa_type)=='HAYYA' ? 'selected' : ''); ?>>HAYYA</option>
              ...
              <div class="col-md-6">
                ...
                <div class="input-group">
                  ...
                  <input type="text" name="CL_Number" id="CL_Number" class="form-control" value="<?php echo e(old('CL_Number', $package->CL_Number)); ?>">
                </div>
              </div>
                ...
                <select name="sponsor_name" id="sponsor_name" class="form-select select2-sponsor">
                  ...
                  <?php $__currentLoopData = $crmCustomers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $customer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <option value="<?php echo e($full); ?>"
                      ...
                      <?php echo e(old('sponsor_name', $package->sponsor_name) === $full ? 'selected' : ''); ?>>
                      <?php echo e($full); ?>
              ...
              <div class="col-md-6">
                ...
                <div class="input-group">
                  ...
                  <input type="text" name="eid_no" id="eid_no" class="form-control" value="<?php echo e(old('eid_no', $package->eid_no)); ?>">
                </div>
              </div>
              ...
              <div class="col-md-6">
                ...
                <select name="CL_nationality" id="CL_nationality" class="form-select select2-country">
                  ...
                  <?php $__currentLoopData = $allCountries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $country): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($country->NAME); ?>" <?php echo e(old('CL_nationality', $package->CL_nationality) == $country->NAME ? 'selected' : ''); ?>><?php echo e($country->NAME); ?></option>
                  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
              </div>
              ...
              <div class="col-md-6">
                ...
                <div class="input-group">
                  ...
                  <input type="date" name="wc_date" id="wc_date" class="form-control" value="<?php echo e(old('wc_date', $package->wc_date)); ?>">
                </div>
              </div>
              ...
              <div class="col-md-6">
                ...
                <div class="input-group">
                  <span class="input-group-text"><i class="fas fa-calendar-alt"></i></span>
                  <input type="date" name="visa_date" id="visa_date" class="form-control" value="<?php echo e(old('visa_date', $package->visa_date)); ?>">
                </div>
              </div>
              ...
              <div class="col-md-6">
                ...
                <div class="input-group">
                  ...
                  <input type="text" name="incident_type" id="incident_type" class="form-control" value="<?php echo e(old('incident_type', $package->incident_type)); ?>">
                </div>
              </div>
              ...
              <div class="col-md-6">
                ...
                <div class="input-group">
                  <span class="input-group-text"><i class="fas fa-calendar-alt"></i></span>
                  <input type="date" name="incident_date" id="incident_date" class="form-control" value="<?php echo e(old('incident_date', $package->incident_date)); ?>">
                </div>
              </div>
              ...
              <div class="col-md-6">
                ...
                <div class="input-group">
                  ...
                  <input type="date" name="arrived_date" id="arrived_date" class="form-control" value="<?php echo e(old('arrived_date', $package->arrived_date)); ?>">
                </div>
              </div>
              ...
              <div class="col-md-6">
                ...
                <div class="input-group">
                  ...
                  <input type="text" name="package" id="package" class="form-control" value="<?php echo e(old('package', $package->package)); ?>" readonly>
                </div>
              </div>

              <div class="col-md-6">
                <?php $selectedSalesComm = old('sales_comm_status', $package->sales_comm_status ?? '') ?>
                ...
                <div class="attachments-card p-3">
                  ...
                  <div class="table-responsive">
                    <table class="table align-middle mb-0" id="attachmentsTable">
                      ...
                      <tbody>
                        <?php $__currentLoopData = $attachments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $doc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                          <?php
                          ...
                          <tr class="doc-row doc-row-existing">
                            <td>
                              <select name="existing_documents[<?php echo e($doc->id); ?>][type]" class="form-select select2-doc-type doc-type-existing">
                                ...
                                <?php $__currentLoopData = $documentTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                  <option value="<?php echo e($dt); ?>" <?php echo e(old("existing_documents.$doc->id.type", $doc->attachment_type)==$dt ? 'selected' : ''); ?>><?php echo e($dt); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                              </select>
                            </td>
                            <td>
                              <input type="text" name="existing_documents[<?php echo e($doc->id); ?>][document_no]" class="form-control doc-number-existing" value="<?php echo e(old("existing_documents.$doc->id.document_no", $doc->attachment_number)); ?>">
                            </td>
                            <td>
                              <input type="date" name="existing_documents[<?php echo e($doc->id); ?>][issued_at]" class="form-control doc-issued-existing" value="<?php echo e($issuedVal); ?>">
                            </td>
                            <td>
                              <input type="date" name="existing_documents[<?php echo e($doc->id); ?>][expires_at]" class="form-control doc-expiry-existing" value="<?php echo e($expiredVal); ?>">
                            </td>
                            <td>
                              <input type="file" name="existing_documents[<?php echo e($doc->id); ?>][file]" class="form-control doc-file-existing" accept=".pdf,.jpg,.jpeg,.png">
                              <?php
                              ...
                              <?php if($hasFile): ?>
                                ...
                                ?>
                                <a href="<?php echo e($fileUrl); ?>" target="_blank" rel="noopener" class="btn btn-outline-secondary btn-sm mt-2 btn-eye">
                            ...
                            <td class="text-center">
                              <button type="button" class="btn btn-outline-danger btn-sm btn-remove-existing" data-id="<?php echo e($doc->id); ?>"><i class="fas fa-trash"></i></button>
                            </td>
                          </tr>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php /**PATH /var/www/developmentoneso-project/resources/views/package/package/edit.blade.php ENDPATH**/ ?>