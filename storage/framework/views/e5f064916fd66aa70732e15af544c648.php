...
<table>
    ...
    <tr>
        <td><?php echo e($contract->client->mobile); ?></td>
        <td><strong>رقم الهاتف<br>PHONE</strong></td>
        <td><?php echo e($agr->passport_no); ?></td>
        <td><strong>رقم جواز السفر<br>Passport</strong></td>
    </tr>
    <tr>
        <td><?php echo e($contract->client->state ?? ''); ?></td>
        <td><strong>الإمارة<br>EMIRATE</strong></td>
        <td><?php echo e($agr->Nationality->name ?? $agr->nationality); ?></td>
        <td><strong>الجنسية<br>Nationality</strong></td>
    </tr>
    <tr>
        <td><?php echo e($agreementStart); ?></td>
        <td><strong>تاريخ البدء<br>Start&nbsp;Date</strong></td>
        <td><?php echo e($agreementEnd); ?></td>
...
<div style="width:100%;margin:20px 0;overflow:auto">
    <div style="float:left;width:47%">
        <p style="margin:0;text-align:left"><strong>Article&nbsp;1 – Financial Terms</strong><br><?php echo e($clauseEn); ?></p>
    </div>
    <div style="float:left;width:47%;margin-left:2%">
        <p style="margin:0;direction:rtl;text-align:right"><strong>البند&nbsp;الأول – الشروط المالية</strong><br><?php echo e($clauseAr); ?></p>
    </div>
</div>
<div class="clear"></div>
...
<div style="margin:30px 0;overflow:auto">
    <div class="sig" style="float:left">
        ...
        <p><strong>Name&nbsp;:</strong> <span style="border-bottom:1px solid #000;display:inline-block;width:75%"><?php echo e($contract->client->first_name); ?> <?php echo e($contract->client->last_name); ?></span></p>
...
<?php /**PATH /var/www/developmentoneso-project/resources/views/contracts/show.blade.php ENDPATH**/ ?>