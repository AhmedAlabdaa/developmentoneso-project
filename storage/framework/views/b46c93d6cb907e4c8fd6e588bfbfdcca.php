    ...
    <tbody>
      <?php $__empty_1 = true; $__currentLoopData = $packages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
        ...
        <tr class="pad-compact">
          <td class="nowrap">
            <span class="count-chip"><i class="fas fa-hashtag"></i><strong><?php echo e($rowNum); ?></strong></span>
          </td>

          <td>
            <div class="cell-head"><i class="fas fa-user"></i><?php echo e($cand !== '' ? $cand : 'N/A'); ?></div>
            <div class="kv" style="margin-top:10px">
              <div class="k">CN Number</div><div class="v"><?php echo e($cn !== '' ? $cn : 'N/A'); ?></div>
              <div class="k">Sales Name</div><div class="v"><span class="badge-pill"><?php echo e($salesDisplay); ?></span></div>
              <div class="k">Status Date</div><div class="v"><?php echo e($statusDate); ?></div>
              <div class="k">Passport No</div><div class="v"><?php echo e($pp !== '' ? $pp : 'N/A'); ?></div>
              <div class="k">Nationality</div><div class="v"><?php echo e($nat !== '' ? $nat : 'N/A'); ?></div>
              <div class="k">Partner</div><div class="v"><?php echo e($partner !== '' ? $partner : 'N/A'); ?></div>
            </div>
          </td>

          <td>
            <div class="cell-head"><i class="fas fa-building"></i><?php echo e($customer !== '' ? $customer : 'N/A'); ?></div>
            <div class="kv" style="margin-top:10px">
              <div class="k">CL Number</div><div class="v"><?php echo e($cl !== '' ? $cl : 'N/A'); ?></div>
              <div class="k">QID</div><div class="v"><?php echo e($qid !== '' ? $qid : 'N/A'); ?></div>
              <div class="k">Arrived Date</div><div class="v"><?php echo e($arrived); ?></div>
            </div>
          </td>
          ...
          <td>
            ...
            <div class="kv" style="margin-top:10px">
              <div class="k">Incident Date</div><div class="v"><?php echo e($incidentDate); ?></div>
              <div class="k">Incident Type</div><div class="v"><?php echo e($incidentType !== '' ? $incidentType : 'N/A'); ?></div>
              <div class="k">Remarks</div>
              <div class="v">
                <?php if($remarksRaw !== ''): ?>
                  <div class="remark-box"><?php echo e(strtoupper($remarksRaw)); ?></div>
                <?php else: ?>
          ...
          <td class="nowrap" style="text-align:center">
            <div style="display:flex;justify-content:center;gap:6px">
              <?php if($proofUrl): ?>
                <a href="javascript:void(0)" class="icon-btn" title="View Proof" onclick="openIncidentProof('<?php echo e($proofUrl); ?>')">
                  <i class="fas fa-eye"></i>
                </a>
              <?php else: ?>
                <span class="proof-empty">N/A</span>
              <?php endif; ?>
              <a href="javascript:void(0)" class="icon-btn" title="Incident Report Form" onclick="openIncidentForm('incident-form-<?php echo e($p->id); ?>')">
        ...
        <tr style="display:none">
          <td colspan="5">
            <div id="incident-form-<?php echo e($p->id); ?>" class="incident-form-html">
              <div class="ipr-page">
                <div class="ipr-wrap">
                  <div class="ipr-header"><img src="<?php echo e($iprHeader); ?>" alt=""></div>
                  <div class="ipr-footer"><img src="<?php echo e($iprFooter); ?>" alt=""></div>
                  <div class="ipr-content">
                    ...
                    <table class="ipr-table">
                      <tr>
                        ...
                        <td class="ipr-value"><?php echo e($formDate); ?></td>
                        <td class="ipr-label-ar">التاريخ</td>
                      </tr>
                      <tr>
                        <td class="ipr-label">CN-NO.</td>
                        <td class="ipr-value"><?php echo e($formCn); ?></td>
                    ...
                    <div class="ipr-grid ipr-mt">
                      <table class="ipr-table">
                        ...
                        <tr>
                          ...
                          <td class="ipr-value" style="text-align:left"><?php echo e($formCandidate); ?></td>
                          <td class="ipr-label-ar">اسم العاملة</td>
                        </tr>
                        <tr>
                          <td class="ipr-label">PASSPORT NO.</td>
                          <td class="ipr-value"><?php echo e($formPassport); ?></td>
                          <td class="ipr-label-ar">رقم جواز السفر</td>
                        </tr>
                        <tr>
                          <td class="ipr-label">NATIONALITY</td>
                          <td class="ipr-value"><?php echo e($formNat); ?></td>
                          <td class="ipr-label-ar">الجنسية</td>
                        </tr>
                        <tr>
                          <td class="ipr-label">AGENT NAME</td>
                          <td class="ipr-value" style="text-align:left"><?php echo e($formAgent); ?></td>
                      ...
                      <table class="ipr-table">
                        ...
                        <tr>
                          ...
                          <td class="ipr-value"><?php echo e($formCL); ?></td>
                          <td class="ipr-label-ar">رقم العقد</td>
                        </tr>
                        <tr>
                          <td class="ipr-label">SPONSOR NAME</td>
                          <td class="ipr-value" style="text-align:left"><?php echo e($formCustomer); ?></td>
                          <td class="ipr-label-ar">اسم الكفيل</td>
                        </tr>
                        <tr>
                          <td class="ipr-label">QID NO.</td>
                          <td class="ipr-value"><?php echo e($formQid); ?></td>
                          <td class="ipr-label-ar">الرقم الشخصي</td>
                        </tr>
                        <tr>
                          <td class="ipr-label">SALES OFFICER NAME</td>
                          <td class="ipr-value" style="text-align:left"><?php echo e($formSales); ?></td>
                    ...
                    <table class="ipr-table ipr-mt">
                      ...
                      <tr>
                        ...
                        <td class="ipr-value"><?php echo e($formIncDate); ?></td>
                        <td class="ipr-label-ar">تاريخ الحادث</td>
                      </tr>
                      <tr>
                        <td class="ipr-label">INCIDENT TYPE</td>
                        <td class="ipr-value"><?php echo e($formIncType); ?></td>
                        <td class="ipr-label-ar">نوع الحادث</td>
                      </tr>
                      <tr>
                        <td class="ipr-label">REMARKS</td>
                        <td class="ipr-value" colspan="2" style="text-align:left;height:60px"><?php echo e($formRemarks); ?></td>
                      </tr>
                    </table>
...
<nav aria-label="Page navigation" style="margin-top:10px">
  <div style="display:flex;justify-content:space-between;align-items:center;padding:12px 0">
    <span style="color:#6b7280">Showing <?php echo e($packages->firstItem()); ?> to <?php echo e($packages->lastItem()); ?> of <?php echo e($packages->total()); ?> results</span>
...
<?php /**PATH /var/www/developmentoneso-project/resources/views/package/package/partials/incident_table.blade.php ENDPATH**/ ?>