    ...
    <table class="table table-striped table-hover">
        <thead>
            <tr>
                ...
                <th title="Medical Status">Medical Status</th>
        ...
        <tbody>
            ...
            <?php $__currentLoopData = $candidates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $candidate): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr class="<?php echo e($candidate->appeal == 1 ? 'table-warning appeal-row' : ''); ?>">
                    ...
                    <td>
                        <?php switch($candidate->medical_status):
                            case ('Approved'): ?>
                                <button style="font-size:12px;" class="btn btn-success">Approved</button>
                                <?php break; ?>

                            <?php case ('Not Rested'): ?>
                                <button style="font-size:12px;" class="btn btn-warning">Not Rested</button>
                                <?php break; ?>

                            <?php case ('Unfit'): ?>
                                <button style="font-size:12px;" class="btn btn-danger">Unfit</button>
                                <?php break; ?>

                            <?php case ('Rejected'): ?>
                                <button style="font-size:12px;" class="btn btn-dark">Rejected</button>
                                <?php break; ?>

                            <?php case ('Not Examined'): ?>
                                <button style="font-size:12px;" class="btn btn-secondary">Not Examined</button>
                                <?php break; ?>

                            <?php case ('Examined'): ?>
                                <button style="font-size:12px;" class="btn btn-primary">Examined</button>
                                <?php break; ?>

                            <?php case ('Pending'): ?>
                                <button style="font-size:12px;" class="btn btn-info">Pending</button>
                                <?php break; ?>

                            <?php default: ?>
                                <button style="font-size:12px;" class="btn btn-light">Unknown</button>
                        <?php endswitch; ?>
                    </td>
...
<script>
    const CV_ROUTE_TEMPLATE = <?php echo json_encode(route('candidates.showCV', ['candidate' => '___REF___']), 512) ?>;
...
<?php /**PATH /var/www/developmentoneso-project/resources/views/candidates/partials/candidates_table_9.blade.php ENDPATH**/ ?>