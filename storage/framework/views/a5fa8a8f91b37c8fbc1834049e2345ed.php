...
<head>
    <meta charset="UTF-8">
    <title><?php echo e($contract->reference_no); ?></title>
...
<body>
    ...
    <img src="<?php echo e($headerFileName); ?>" style="width:100%">
    <table class="dotted my-4">
        <tr>
            <td><?php echo e(Carbon::parse($contract->created_at)->format('d/m/Y')); ?></td>
            ...
            <td style="font-weight:bold"><?php echo e($contract->reference_no); ?></td>
        </tr>
    </table>
    ...
    <table>
        <tr><td><?php echo e($contract->client->first_name); ?> <?php echo e($contract->client->last_name); ?></td><td><strong>اسم صاحب العمل<br>SPONSOR NAME</strong></td><td rowspan="8"><span class="rotate90">SECOND PARTY<br>الطرف الثاني</span></td><td>AL EBDAA DOMESTIC WORKERS CENTRE</td><td><strong>مكتب الاستقدام<br>Tadbeer Center</strong></td><td rowspan="3"><span class="rotate-90">FIRST PARTY<br>الطرف الأول</span></td></tr>
        <tr><td><?php echo e($contract->client->emirates_id); ?></td><td><strong>رقم الهوية<br>ID NUMBER</strong></td><td>800 32332</td><td><strong>رقم الهاتف<br>Phone</strong></td></tr>
        <tr><td><?php echo e($contract->client->address); ?></td><td><strong>العنوان<br>ADDRESS</strong></td><td>AL GARHOUD, DUBAI, UAE</td><td><strong>العنوان<br>Address</strong></td></tr>
        <tr><td><?php echo e($contract->client->nationality); ?></td><td><strong>الجنسية<br>NATIONALITY</strong></td><td><?php echo e($contract->replaced_by_name ?: $agr->candidate_name); ?></td><td><strong>اسم العامل<br>Name</strong></td><td rowspan="4"><strong>العامل المساعد<br>Domestic worker</strong></td></tr>
        <tr><td><?php echo e($contract->client->mobile); ?></td><td><strong>رقم الهاتف<br>PHONE</strong></td><td><?php echo e($agr->passport_no); ?></td><td><strong>رقم جواز السفر<br>Passport</strong></td></tr>
        <tr><td><?php echo e($contract->client->state ?? ''); ?></td><td><strong>الإمارة<br>EMIRATE</strong></td><td><?php echo e($agr->Nationality->name ?? $agr->nationality); ?></td><td><strong>الجنسية<br>Nationality</strong></td></tr>
        <tr><td><?php echo e($agreementStart); ?></td><td><strong>تاريخ البدء<br>Start Date</strong></td><td><?php echo e($agreementEnd); ?></td><td><strong>تاريخ الانتهاء<br>End Date</strong></td></tr>
    </table>
    <div style="width:100%;margin:20px 0;overflow:auto"><div style="float:left;width:47%"><p style="margin:0;text-align:left"><strong>Article 1 – Financial Terms</strong><br><?php echo e($clauseEn); ?></p></div><div style="float:left;width:47%;margin-left:2%"><p style="margin:0;direction:rtl;text-align:right"><strong>البند الأول – الشروط المالية</strong><br><?php echo e($clauseAr); ?></p></div></div>
    <div class="clear"></div>
    <!-- Articles 2–8 unchanged -->
    <div style="margin:30px 0;overflow:auto">
        <div class="sig" style="float:left"><span class="title-box">SECOND PARTY (Employer) / الطرف الثاني</span><p><strong>Name :</strong> <span style="border-bottom:1px solid #000;display:inline-block;width:75%"><?php echo e($contract->client->first_name); ?> <?php echo e($contract->client->last_name); ?></span></p><p><strong>Signature :</strong> <span style="border-bottom:1px solid #000;display:inline-block;width:75%"></span></p><p><strong>Date :</strong> <span style="border-bottom:1px solid #000;display:inline-block;width:75%"></span></p></div>
    ...
    <div class="clear"></div>
    <img src="<?php echo e($footerFileName); ?>" style="width:100%">
      ...
      <div class="modal-dialog modal-dialog-centered animate__animated animate__zoomIn">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <table>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td><?php echo e(Carbon::parse($h['sent_at'])->format('d M Y H:i')); ?></td>
            ...
            <table>
              <tr><th>Maid Name</th><td><?php echo e($agr->candidate_name); ?></td></tr>
              <tr><th>Sponsor Name</th><td><?php echo e($contract->client->first_name); ?> <?php echo e($contract->client->last_name); ?></td></tr>
              <tr><th>Start Date</th><td><?php echo e($agreementStart); ?></td></tr>
              <tr><th>End Date</th><td><?php echo e($agreementEnd); ?></td></tr>
              <tr><th>Contract Value</th><td><?php echo e(number_format($totalAmount,2)); ?> AED</td></tr>
            </table>
            ...
            <div class="mb-3">
              ...
              <input type="text" id="waPhone" name="phone" class="form-control" placeholder="+974XXXXXXXX" value="<?php echo e($contract->client->mobile); ?>">
            </div>
          </div>
    ...
    <script>
      ...
      btnShare.addEventListener('click', () => {
        ...
        fetch('<?php echo e(route("contracts.shareWhatsapp", $contract)); ?>', {
          method: 'POST',
...
<?php /**PATH /var/www/developmentoneso-project/resources/views/contracts/show1.blade.php ENDPATH**/ ?>