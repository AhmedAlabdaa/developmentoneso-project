...
<div class="refund-wrap" data-refund-root="1">
  ...
  <div class="refund-stats">
    <div class="refund-card refund-card-open">
      ...
      <div class="refund-r">
        <div class="refund-cnt"><?php echo e((int)($stat['open']['count'] ?? 0)); ?></div>
        <div class="refund-amt"><strong>QAR <?php echo e(number_format((float)($stat['open']['amount'] ?? 0), 2)); ?></strong></div>
      </div>
    </div>
    ...
    <div class="refund-card refund-card-closed">
      ...
      <div class="refund-r">
        <div class="refund-cnt"><?php echo e((int)($stat['closed']['count'] ?? 0)); ?></div>
        <div class="refund-amt"><strong>QAR <?php echo e(number_format((float)($stat['closed']['amount'] ?? 0), 2)); ?></strong></div>
      </div>
    </div>
    ...
    <div class="refund-card refund-card-cancelled">
      ...
      <div class="refund-r">
        <div class="refund-cnt"><?php echo e((int)($stat['cancelled']['count'] ?? 0)); ?></div>
        <div class="refund-amt"><strong>QAR <?php echo e(number_format((float)($stat['cancelled']['amount'] ?? 0), 2)); ?></strong></div>
      </div>
    </div>
  </div>
        ...
        <?php $__empty_1 = true; $__currentLoopData = $refunds; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $r): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
          ...
          <tr>
            ...
            <td>
              <?php if($canManage): ?>
                <select
                  class="refund-status-select <?php echo e($cls[$st] ?? ''); ?>"
              ...
              <?php else: ?>
                <span class="refund-status-text <?php echo e($cls[$st] ?? ''); ?>"><?php echo e(strtoupper($st)); ?></span>
              <?php endif; ?>
            </td>
            ...
            <td>
              <a class="refund-btn refund-btn-info" href="<?php echo e(route('refunds.view', $r->id)); ?>" title="View Refund Form">
  ...
  <nav aria-label="Page navigation">
    <div class="refund-pagination">
      <span class="refund-muted">
        Showing <?php echo e($refunds->firstItem() ?? 0); ?> to <?php echo e($refunds->lastItem() ?? 0); ?> of <?php echo e($refunds->total() ?? 0); ?> results
      </span>
...
(function(){
  ...
  document.addEventListener('change', function(e){
    ...
    confirmBox('Change status for '+name+'?', 'Switch to "'+label+'"?').then(function(res){
      ...
      fetch("<?php echo e(route('refunds.updateStatus')); ?>",{
        method:'POST',
...
<?php /**PATH /var/www/developmentoneso-project/resources/views/package/partials/refund_table.blade.php ENDPATH**/ ?>