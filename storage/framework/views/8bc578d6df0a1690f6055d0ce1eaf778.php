                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <div>
                                ...
                                <a href="<?php echo e(route('staff.upload-staff-csv-file')); ?>" class="btn btn-csv-upload">
...
$(document).ready(function() {
    ...
    function loadStaff(status = 'all') {
        ...
        $.ajax({
            url: '<?php echo e(route("staff.index")); ?>',
            type: 'GET',
            data: dataString,
...
<?php /**PATH /var/www/developmentoneso-project/resources/views/staff/index.blade.php ENDPATH**/ ?>