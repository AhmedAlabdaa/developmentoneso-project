...
<head>
    ...
    <title><?php echo e($candidate->candidate_name); ?>'s Exit Form</title>
...
<body>
    ...
    <div class="container" id="printContainer">
        ...
        <div class="text-end mb-3">
            <label>Date: __________________________</label>
        </div>
        ...
        <table class="form-table mb-4">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="checkbox-center">TRIAL <input type="checkbox"></td>
...
<?php /**PATH /var/www/developmentoneso-project/resources/views/candidates/exit.blade.php ENDPATH**/ ?>