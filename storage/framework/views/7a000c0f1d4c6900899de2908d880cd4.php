      ...
      <div class="col-lg-12">
        <div class="card">
          <div class="card-body">
            ...
            <form class="row g-3" action="<?php echo e(route('employees.update', $employee->reference_no)); ?>" method="POST" enctype="multipart/form-data" id="employee-edit-form">
              <?php echo csrf_field(); ?>
              ...
              <div class="col-lg-6">
                ...
                <div class="input-group">
                  ...
                  <input type="text" class="form-control" name="reference_no" value="<?php echo e(old('reference_no', $employee->reference_no)); ?>" readonly>
                </div>
              </div>
              ...
              <div class="col-lg-6">
                ...
                <div class="input-group">
                  ...
                  <input type="text" class="form-control" name="personal_no" value="<?php echo e(old('personal_no', $employee->personal_no)); ?>">
                </div>
              </div>
              ...
              <div class="col-lg-6">
                ...
                <div class="input-group">
                  ...
                  <select class="form-select" name="package" required>
                    ...
                    <option value="PKG-2" <?php echo e(old('package', $employee->package) == 'PKG-2' ? 'selected' : ''); ?>>PKG-2</option>
                    <option value="PKG-3" <?php echo e(old('package', $employee->package) == 'PKG-3' ? 'selected' : ''); ?>>PKG-3</option>
                    <option value="PKG-4" <?php echo e(old('package', $employee->package) == 'PKG-4' ? 'selected' : ''); ?>>PKG-4</option>
                  </select>
                </div>
              </div>
              ...
              <div class="col-lg-6">
                ...
                <div class="input-group">
                  ...
                  <input type="text" class="form-control" name="name" value="<?php echo e(old('name', $employee->name)); ?>" required>
                </div>
              </div>
              ...
              <div class="col-lg-6">
                ...
                <div class="input-group">
                  ...
                  <input type="text" class="form-control" name="slug" value="<?php echo e(old('slug', $employee->slug)); ?>" readonly>
                </div>
              </div>
              ...
              <div class="col-lg-6">
                ...
                <div class="input-group">
                  ...
                  <select class="form-select" name="nationality" required>
                    ...
                    <option value="ETHIOPIA" <?php echo e(old('nationality', $employee->nationality) == 'ETHIOPIA' ? 'selected' : ''); ?>>ETHIOPIA</option>
                    <option value="INDIA" <?php echo e(old('nationality', $employee->nationality) == 'INDIA' ? 'selected' : ''); ?>>INDIA</option>
                    <option value="PAKISTAN" <?php echo e(old('nationality', $employee->nationality) == 'PAKISTAN' ? 'selected' : ''); ?>>PAKISTAN</option>
                    <option value="INDONESIA" <?php echo e(old('nationality', $employee->nationality) == 'INDONESIA' ? 'selected' : ''); ?>>INDONESIA</option>
                    <option value="KENYA" <?php echo e(old('nationality', $employee->nationality) == 'KENYA' ? 'selected' : ''); ?>>KENYA</option>
                    <option value="MYANMAR" <?php echo e(old('nationality', $employee->nationality) == 'MYANMAR' ? 'selected' : ''); ?>>MYANMAR</option>
                    <option value="PHILIPPINES" <?php echo e(old('nationality', $employee->nationality) == 'PHILIPPINES' ? 'selected' : ''); ?>>PHILIPPINES</option>
                    <option value="SRI LANKA" <?php echo e(old('nationality', $employee->nationality) == 'SRI LANKA' ? 'selected' : ''); ?>>SRI LANKA</option>
                    <option value="UGANDA" <?php echo e(old('nationality', $employee->nationality) == 'UGANDA' ? 'selected' : ''); ?>>UGANDA</option>
              ...
              <div class="col-lg-6">
                ...
                <div class="input-group">
                  ...
                  <input type="text" class="form-control date-field" name="date_of_birth" value="<?php echo e(old('date_of_birth', $employee->date_of_birth)); ?>" required>
                </div>
              </div>
              ...
              <div class="col-lg-6">
                ...
                <div class="input-group">
                  ...
                  <input type="text" class="form-control" name="passport_no" value="<?php echo e(old('passport_no', $employee->passport_no)); ?>" required>
                </div>
              </div>
              ...
              <div class="col-lg-6">
                ...
                <div class="input-group">
                  ...
                  <input type="text" class="form-control date-field" name="passport_expiry_date" value="<?php echo e(old('passport_expiry_date', $employee->passport_expiry_date)); ?>" required>
                </div>
              </div>
              ...
              <div class="col-lg-6">
                ...
                <div class="input-group">
                  ...
                  <input type="text" class="form-control date-field" name="date_of_joining" value="<?php echo e(old('date_of_joining', $employee->date_of_joining)); ?>">
                </div>
              </div>
              ...
              <div class="col-lg-6">
                ...
                <div class="input-group">
                  ...
                  <input type="text" class="form-control" name="visa_designation" value="<?php echo e(old('visa_designation', $employee->visa_designation)); ?>">
                </div>
              </div>
              ...
              <div class="col-lg-6">
                ...
                <div class="input-group">
                  ...
                  <input type="text" class="form-control date-field" name="residence_visa_start_date" value="<?php echo e(old('residence_visa_start_date', $employee->residence_visa_start_date)); ?>">
                </div>
              </div>
              ...
              <div class="col-lg-6">
                ...
                <div class="input-group">
                  ...
                  <input type="text" class="form-control date-field" name="residence_visa_expiry_date" value="<?php echo e(old('residence_visa_expiry_date', $employee->residence_visa_expiry_date)); ?>">
                </div>
              </div>
              ...
              <div class="col-lg-6">
                ...
                <div class="input-group">
                  ...
                  <input type="text" class="form-control" name="file_entry_permit_no" value="<?php echo e(old('file_entry_permit_no', $employee->file_entry_permit_no)); ?>">
                </div>
              </div>
              ...
              <div class="col-lg-6">
                ...
                <div class="input-group">
                  <span class="input-group-text"><i class="fas fa-calendar-plus"></i></span>
                  <input type="text" class="form-control date-field" name="file_entry_permit_issued_date" value="<?php echo e(old('file_entry_permit_issued_date', $employee->file_entry_permit_issued_date)); ?>">
                </div>
              </div>
              ...
              <div class="col-lg-6">
                ...
                <div class="input-group">
                  <span class="input-group-text"><i class="fas fa-calendar-times"></i></span>
                  <input type="text" class="form-control date-field" name="file_entry_permit_expired_date" value="<?php echo e(old('file_entry_permit_expired_date', $employee->file_entry_permit_expired_date)); ?>">
                </div>
              </div>
              ...
              <div class="col-lg-6">
                ...
                <div class="input-group">
                  ...
                  <input type="text" class="form-control" name="emirates_id_number" value="<?php echo e(old('emirates_id_number', $employee->emirates_id_number)); ?>">
                </div>
              </div>
              ...
              <div class="col-lg-6">
                ...
                <div class="input-group">
                  <span class="input-group-text"><i class="fas fa-calendar-plus"></i></span>
                  <input type="text" class="form-control date-field" name="eid_issued_date" value="<?php echo e(old('eid_issued_date', $employee->eid_issued_date)); ?>">
                </div>
              </div>
              ...
              <div class="col-lg-6">
                ...
                <div class="input-group">
                  <span class="input-group-text"><i class="fas fa-calendar-times"></i></span>
                  <input type="text" class="form-control date-field" name="eid_expiry_date" value="<?php echo e(old('eid_expiry_date', $employee->eid_expiry_date)); ?>">
                </div>
              </div>
              ...
              <div class="col-lg-6">
                ...
                <div class="input-group">
                  ...
                  <input type="text" class="form-control" name="labor_card_no" value="<?php echo e(old('labor_card_no', $employee->labor_card_no)); ?>">
                </div>
              </div>
              ...
              <div class="col-lg-6">
                ...
                <div class="input-group">
                  <span class="input-group-text"><i class="fas fa-calendar-plus"></i></span>
                  <input type="text" class="form-control date-field" name="labor_card_issued_date" value="<?php echo e(old('labor_card_issued_date', $employee->labor_card_issued_date)); ?>">
                </div>
              </div>
              ...
              <div class="col-lg-6">
                ...
                <div class="input-group">
                  <span class="input-group-text"><i class="fas fa-calendar-times"></i></span>
                  <input type="text" class="form-control date-field" name="labor_card_expiry_date" value="<?php echo e(old('labor_card_expiry_date', $employee->labor_card_expiry_date)); ?>">
                </div>
              </div>
              ...
              <div class="col-lg-6">
                ...
                <div class="input-group">
                  ...
                  <input type="text" class="form-control" name="iloe_number" value="<?php echo e(old('iloe_number', $employee->iloe_number)); ?>">
                </div>
              </div>
              ...
              <div class="col-lg-6">
                ...
                <div class="input-group">
                  <span class="input-group-text"><i class="fas fa-calendar-plus"></i></span>
                  <input type="text" class="form-control date-field" name="iloe_issued_date" value="<?php echo e(old('iloe_issued_date', $employee->iloe_issued_date)); ?>">
                </div>
              </div>
              ...
              <div class="col-lg-6">
                ...
                <div class="input-group">
                  <span class="input-group-text"><i class="fas fa-calendar-times"></i></span>
                  <input type="text" class="form-control date-field" name="iloe_expired_date" value="<?php echo e(old('iloe_expired_date', $employee->iloe_expired_date)); ?>">
                </div>
              </div>
              ...
              <div class="col-lg-6">
                ...
                <div class="input-group">
                  ...
                  <input type="text" class="form-control" name="insurance_policy_number" value="<?php echo e(old('insurance_policy_number', $employee->insurance_policy_number)); ?>">
                </div>
              </div>
              ...
              <div class="col-lg-6">
                ...
                <div class="input-group">
                  <span class="input-group-text"><i class="fas fa-calendar-plus"></i></span>
                  <input type="text" class="form-control date-field" name="insurance_policy_issued_date" value="<?php echo e(old('insurance_policy_issued_date', $employee->insurance_policy_issued_date)); ?>">
                </div>
              </div>
              ...
              <div class="col-lg-6">
                ...
                <div class="input-group">
                  <span class="input-group-text"><i class="fas fa-calendar-times"></i></span>
                  <input type="text" class="form-control date-field" name="insurance_policy_expired_date" value="<?php echo e(old('insurance_policy_expired_date', $employee->insurance_policy_expired_date)); ?>">
                </div>
              </div>
              ...
              <div class="col-lg-6">
                ...
                <div class="input-group">
                  <span class="input-group-text"><i class="fas fa-calendar-plus"></i></span>
                  <input type="text" class="form-control date-field" name="employment_contract_start_date" value="<?php echo e(old('employment_contract_start_date', $employee->employment_contract_start_date)); ?>">
                </div>
              </div>
              ...
              <div class="col-lg-6">
                ...
                <div class="input-group">
                  <span class="input-group-text"><i class="fas fa-calendar-times"></i></span>
                  <input type="text" class="form-control date-field" name="employment_contract_end_date" value="<?php echo e(old('employment_contract_end_date', $employee->employment_contract_end_date)); ?>">
                </div>
              </div>
              ...
              <div class="col-lg-6">
                ...
                <div class="input-group">
                  ...
                  <select class="form-select" name="contract_type">
                    ...
                    <option value="Permanent" <?php echo e(old('contract_type', $employee->contract_type) == 'Permanent' ? 'selected' : ''); ?>>Permanent</option>
                    <option value="Temporary" <?php echo e(old('contract_type', $employee->contract_type) == 'Temporary' ? 'selected' : ''); ?>>Temporary</option>
                  </select>
                </div>
              </div>
              ...
              <div class="col-lg-6">
                ...
                <div class="input-group">
                  ...
                  <input type="number" class="form-control" name="salary_as_per_contract" value="<?php echo e(old('salary_as_per_contract', $employee->salary_as_per_contract)); ?>">
                </div>
              </div>
              ...
              <div class="col-lg-6">
                ...
                <div class="input-group">
                  ...
                  <input type="number" class="form-control salary-input" id="basic" name="basic" value="<?php echo e(old('basic', $employee->basic)); ?>">
                </div>
              </div>
              ...
              <div class="col-lg-6">
                ...
                <div class="input-group">
                  ...
                  <input type="number" class="form-control salary-input" id="housing" name="housing" value="<?php echo e(old('housing', $employee->housing)); ?>">
                </div>
              </div>
              ...
              <div class="col-lg-6">
                ...
                <div class="input-group">
                  ...
                  <input type="number" class="form-control salary-input" id="transport" name="transport" value="<?php echo e(old('transport', $employee->transport)); ?>">
                </div>
              </div>
              ...
              <div class="col-lg-6">
                ...
                <div class="input-group">
                  ...
                  <input type="number" class="form-control salary-input" id="other_allowances" name="other_allowances" value="<?php echo e(old('other_allowances', $employee->other_allowances)); ?>">
                </div>
              </div>
              ...
              <div class="col-lg-6">
                ...
                <div class="input-group">
                  ...
                  <input type="number" class="form-control" id="total_salary" name="total_salary" value="<?php echo e(old('total_salary', $employee->total_salary)); ?>" readonly>
                </div>
              </div>
              ...
              <div class="col-lg-6">
                ...
                <div class="input-group">
                  ...
                  <select class="form-select" name="payment_type">
                    ...
                    <option value="WPS" <?php echo e(old('payment_type', $employee->payment_type) == 'WPS' ? 'selected' : ''); ?>>WPS</option>
                    <option value="CASH" <?php echo e(old('payment_type', $employee->payment_type) == 'CASH' ? 'selected' : ''); ?>>CASH</option>
                  </select>
                </div>
              </div>
              ...
              <div class="col-lg-6">
                ...
                <div class="input-group">
                  ...
                  <input type="text" class="form-control" name="bank_name" value="<?php echo e(old('bank_name', $employee->bank_name)); ?>">
                </div>
              </div>
              ...
              <div class="col-lg-6">
                ...
                <div class="input-group">
                  ...
                  <input type="text" class="form-control" name="iban" value="<?php echo e(old('iban', $employee->iban)); ?>">
                </div>
              </div>
              ...
              <div class="col-lg-6">
                ...
                <div class="input-group">
                  ...
                  <input type="text" class="form-control" name="current_status" value="<?php echo e(old('current_status', $employee->current_status)); ?>">
                </div>
              </div>
              ...
              <div class="col-lg-6">
                ...
                <div class="input-group">
                  ...
                  <select class="form-select" name="inside_status" id="inside_status" required>
                    ...
                    <option value="0" <?php echo e((string)old('inside_status', $employee->inside_status) === '0' ? 'selected' : ''); ?>>All</option>
                    <option value="1" <?php echo e((string)old('inside_status', $employee->inside_status) === '1' ? 'selected' : ''); ?>>Office</option>
                    <option value="2" <?php echo e((string)old('inside_status', $employee->inside_status) === '2' ? 'selected' : ''); ?>>Contracted</option>
                    <option value="3" <?php echo e((string)old('inside_status', $employee->inside_status) === '3' ? 'selected' : ''); ?>>Incidented</option>
                    <option value="4" <?php echo e((string)old('inside_status', $employee->inside_status) === '4' ? 'selected' : ''); ?>>Outside</option>
                  </select>
                </div>
              ...
              <div class="col-lg-6">
                ...
                <div class="input-group">
                  ...
                  <select class="form-select" name="inside_country_or_outside" required>
                    <option value="">Select Status</option>
                    <option value="2" <?php echo e((string)old('inside_country_or_outside', $employee->inside_country_or_outside) === '2' ? 'selected' : ''); ?>>Inside</option>
                    <option value="1" <?php echo e((string)old('inside_country_or_outside', $employee->inside_country_or_outside) === '1' ? 'selected' : ''); ?>>Outside</option>
                  </select>
                </div>
              </div>
              ...
              <div class="col-lg-6" id="incident_type_wrap">
                ...
                <div class="input-group">
                  ...
                  <select class="form-select" name="incident_type" id="incident_type">
                    <option value="" <?php echo e(old('incident_type', $employee->incident_type) ? '' : 'selected'); ?>>Select incident type</option>
                    <option value="RUNAWAY" <?php echo e(old('incident_type', $employee->incident_type) === 'RUNAWAY' ? 'selected' : ''); ?>>Runaway</option>
                    <option value="REPATRIATION" <?php echo e(old('incident_type', $employee->incident_type) === 'REPATRIATION' ? 'selected' : ''); ?>>Repatriation</option>
                    <option value="UNFIT" <?php echo e(old('incident_type', $employee->incident_type) === 'UNFIT' ? 'selected' : ''); ?>>Unfit</option>
                    <option value="REFUSED" <?php echo e(old('incident_type', $employee->incident_type) === 'REFUSED' ? 'selected' : ''); ?>>Refused</option>
                    <option value="PSYCHIATRIC" <?php echo e(old('incident_type', $employee->incident_type) === 'PSYCHIATRIC' ? 'selected' : ''); ?>>Psychiatric</option>
                  </select>
                </div>
              </div>
              ...
              <div class="col-lg-6" id="incident_date_wrap">
                ...
                <div class="input-group">
                  <span class="input-group-text"><i class="fas fa-calendar-times"></i></span>
                  <input type="text" class="form-control date-field" name="incident_date" id="incident_date" value="<?php echo e(old('incident_date', $employee->incident_date)); ?>">
                </div>
              </div>
              ...
              <div class="col-lg-6">
                ...
                <div class="input-group">
                  ...
                  <input type="text" class="form-control" name="foreign_partner" value="<?php echo e(old('foreign_partner', $employee->foreign_partner)); ?>">
                </div>
              </div>
              ...
              <div class="col-lg-6">
                ...
                <div class="input-group">
                  ...
                  <input type="text" class="form-control" name="uid_no" value="<?php echo e(old('uid_no', $employee->uid_no)); ?>">
                </div>
              </div>

              <div class="col-lg-6">
                <label class="form-label">Remarks</label>
                <textarea class="form-control" name="remarks" rows="2"><?php echo e(old('remarks', $employee->remarks)); ?></textarea>
              </div>

              <div class="col-lg-6">
                <label class="form-label">Comments</label>
                <textarea class="form-control" name="comments" rows="2"><?php echo e(old('comments', $employee->comments)); ?></textarea>
              </div>
                    ...
                    <tbody id="attachment-container">
                      <?php $__currentLoopData = $attachments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $attachment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr class="attachment-row">
                          <td>
                            <select class="form-select attachment-type" name="attachment_type_existing[<?php echo e($attachment->id); ?>]" required>
                              <option disabled value="">Select Document Type...</option>
                              <?php $__currentLoopData = $docTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $t): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($t); ?>" <?php echo e(old('attachment_type_existing.'.$attachment->id, $attachment->attachment_type) == $t ? 'selected' : ''); ?>><?php echo e($t); ?></option>
                              <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                          </td>
                          <td>
                            <input type="text" name="attachment_number_existing[<?php echo e($attachment->id); ?>]" class="form-control" placeholder="Document Number" value="<?php echo e(old('attachment_number_existing.'.$attachment->id, $attachment->attachment_number)); ?>">
                          </td>
                          <td>
                            <input type="text" name="issued_on_existing[<?php echo e($attachment->id); ?>]" class="form-control date-field" value="<?php echo e(old('issued_on_existing.'.$attachment->id, $attachment->issued_on)); ?>">
                          </td>
                          <td>
                            <input type="text" name="expired_on_existing[<?php echo e($attachment->id); ?>]" class="form-control date-field" value="<?php echo e(old('expired_on_existing.'.$attachment->id, $attachment->expired_on)); ?>">
                          </td>
                          <td>
                            <?php if($attachment->attachment_file): ?>
                              <a href="<?php echo e(Storage::url($attachment->attachment_file)); ?>" target="_blank" class="btn btn-sm btn-info"><i class="fas fa-eye"></i></a>
                            <?php endif; ?>
                            <input type="file" name="attachment_file_existing[<?php echo e($attachment->id); ?>]" class="form-control mt-1">
                          </td>
                          <td>
                            <button type="button" class="btn btn-sm btn-danger remove-attachment-existing" data-id="<?php echo e($attachment->id); ?>"><i class="fas fa-trash"></i></button>
                          </td>
                        </tr>
                      <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="table-responsive">
                  <table class="table table-bordered table-gradient" id="visa-stages-table">
                    ...
                    <tbody id="visa-stages-container">
                      <?php $__currentLoopData = $visaStages->sortBy('step_id'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $stage): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php
                        ...
                        <tr class="stage-group hr-row" data-existing="1" data-id="<?php echo e($stage->id); ?>">
                          <td>
                            <select class="form-select stage-select" name="stages_existing[<?php echo e($stage->id); ?>][step_id]" required>
                              <option value="" disabled>Select Stage</option>
                              <?php $__currentLoopData = $steps; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $step): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php if($step->title !== 'Arrival Status'): ?>
                                  <?php $selectedId = old('stages_existing.'.$stage->id.'.step_id', $stage->step_id); ?>
                                  <option value="<?php echo e($step->id); ?>" <?php echo e((int)$selectedId === (int)$step->id ? 'selected' : ''); ?>><?php echo e($step->id); ?> - <?php echo e($step->title); ?></option>
                                <?php endif; ?>
                              <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                          </td>
                          <td>
                            <input type="text" class="form-control date-field" name="stages_existing[<?php echo e($stage->id); ?>][hr_issue_date]" value="<?php echo e(old('stages_existing.'.$stage->id.'.hr_issue_date', $stage->hr_issue_date)); ?>" required>
                          </td>
                          <td>
                            <input type="text" class="form-control" name="stages_existing[<?php echo e($stage->id); ?>][hr_file_number]" value="<?php echo e(old('stages_existing.'.$stage->id.'.hr_file_number', $stage->hr_file_number)); ?>" placeholder="File Number">
                          </td>
                          <td>
                            <input type="text" class="form-control date-field" name="stages_existing[<?php echo e($stage->id); ?>][hr_expiry_date]" value="<?php echo e(old('stages_existing.'.$stage->id.'.hr_expiry_date', $stage->hr_expiry_date)); ?>" required>
                          </td>
                          <td>
                            <?php if(!empty($stage->ica_proof)): ?>
                              <a href="<?php echo e(Storage::url($stage->ica_proof)); ?>" target="_blank" class="btn btn-sm btn-info"><i class="fas fa-eye"></i></a>
                            <?php endif; ?>
                            <input type="file" class="form-control mt-1" name="stages_existing[<?php echo e($stage->id); ?>][ica_proof]">
                          </td>
                          <td>
                            <?php if(!empty($stage->hr_attach_file)): ?>
                              <a href="<?php echo e(Storage::url($stage->hr_attach_file)); ?>" target="_blank" class="btn btn-sm btn-info"><i class="fas fa-eye"></i></a>
                            <?php endif; ?>
                            <input type="file" class="form-control mt-1" name="stages_existing[<?php echo e($stage->id); ?>][hr_attach_file]">
                          </td>
                          <td class="stage-action text-center">
                            ...
                            <button type="button" class="btn btn-sm btn-danger remove-stage-group" data-existing="1" data-id="<?php echo e($stage->id); ?>"><i class="fas fa-minus"></i></button>
                          </td>
                        </tr>

                        <tr class="stage-group finance-row" data-existing="1" data-id="<?php echo e($stage->id); ?>">
                          <td>
                          ...
                          <td colspan="5">
                            <div class="finance-grid">
                              <div>
                                ...
                                <input type="number" step="0.01" class="form-control" name="stages_existing[<?php echo e($stage->id); ?>][fin_paid_amount]" value="<?php echo e(old('stages_existing.'.$stage->id.'.fin_paid_amount', $stage->fin_paid_amount)); ?>">
                              </div>
                              <div>
                                <label class="form-label mb-1">Zoho Payment Proof</label>
                                <?php if(!empty($stage->fin_zoho_proof)): ?>
                                  <a href="<?php echo e(Storage::url($stage->fin_zoho_proof)); ?>" target="_blank" class="btn btn-sm btn-info"><i class="fas fa-eye"></i></a>
                                <?php endif; ?>
                                <input type="file" class="form-control mt-1" name="stages_existing[<?php echo e($stage->id); ?>][fin_zoho_proof]">
                              </div>
                              <div>
                                <label class="form-label mb-1">Gov’t Invoice Proof</label>
                                <?php if(!empty($stage->fin_gov_invoice_proof)): ?>
                                  <a href="<?php echo e(Storage::url($stage->fin_gov_invoice_proof)); ?>" target="_blank" class="btn btn-sm btn-info"><i class="fas fa-eye"></i></a>
                                <?php endif; ?>
                                <input type="file" class="form-control mt-1" name="stages_existing[<?php echo e($stage->id); ?>][fin_gov_invoice_proof]">
                              </div>
                              <div>
                                <label class="form-label mb-1">
                                  Additional Files
                                  <?php if(count($extraList)): ?>
                                    <button type="button" class="btn btn-sm btn-info ms-1 btn-view-extra" data-title="Stage <?php echo e($stage->step_id); ?> Additional Files" data-files='<?php echo json_encode($extraList, 15, 512) ?>'>
                                      <i class="fas fa-eye"></i>
                                    </button>
                                  <?php endif; ?>
                                </label>
                                <input type="file" class="form-control" name="stages_existing[<?php echo e($stage->id); ?>][fin_extra_files][]" multiple>
                              </div>
                            </div>
                          </td>
                          <td></td>
                        ...
                        <tr class="stage-group hr-row" data-existing="0" data-index="0">
                          <td>
                            <select class="form-select stage-select" name="stages_new[0][step_id]" required>
                              ...
                              <?php $__currentLoopData = $steps; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $step): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php if($step->title !== 'Arrival Status'): ?>
                                  <option value="<?php echo e($step->id); ?>" <?php echo e((string)$step->id === (string)$firstStepId ? 'selected' : ''); ?>><?php echo e($step->id); ?> - <?php echo e($step->title); ?></option>
                                <?php endif; ?>
                              <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                          </td>
                ...
                <div class="table-responsive">
                  <table class="table table-bordered table-gradient">
                    ...
                    <tbody>
                      <tr>
                        <td>
                          <?php if(!empty($employee->arrival_ticket_attachment)): ?>
                            <a href="<?php echo e(Storage::url($employee->arrival_ticket_attachment)); ?>" target="_blank" class="btn btn-sm btn-info mb-1">
                              <i class="fas fa-eye"></i>
                            </a>
                          <?php endif; ?>
                        ...
                        <td>
                          <?php if(!empty($employee->arrival_entry_stamp_attachment)): ?>
                            <a href="<?php echo e(Storage::url($employee->arrival_entry_stamp_attachment)); ?>" target="_blank" class="btn btn-sm btn-info mb-1">
                              <i class="fas fa-eye"></i>
                            </a>
                          <?php endif; ?>
                        ...
                        <td>
                          <?php if(!empty($employee->arrival_icp_proof_attachment)): ?>
                            <a href="<?php echo e(Storage::url($employee->arrival_icp_proof_attachment)); ?>" target="_blank" class="btn btn-sm btn-info mb-1">
                              <i class="fas fa-eye"></i>
                            </a>
                          <?php endif; ?>
                        ...
                        <td>
                          <input type="text" class="form-control date-field" name="arrival_date" value="<?php echo e(old('arrival_date', $employee->arrival_date)); ?>">
                        </td>
                        <td>
                          <input type="text" class="form-control date-field" name="arrival_expiry_date" value="<?php echo e(old('arrival_expiry_date', $employee->arrival_expiry_date)); ?>">
                        </td>
                      </tr>
                    </tbody>
                  </table>
...
<script>
    ...
    return `<tr class="stage-group hr-row" data-existing="0" data-index="${i}">
      <td>
        <select class="form-select stage-select" name="stages_new[${i}][step_id]" required>
          ...
          <?php $__currentLoopData = $steps; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $step): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php if($step->title !== 'Arrival Status'): ?>
              <option value="<?php echo e($step->id); ?>"><?php echo e($step->id); ?> - <?php echo e($step->title); ?></option>
            <?php endif; ?>
          <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </select>
      </td>
  ...
  $(document).ready(function(){
    window.stageIndex = <?php echo e($visaStages->count() == 0 ? 1 : $visaStages->count()); ?>;
    initFlatpickr();
    renumberStageButtons();
    refreshStageOptions();
    lockNewestStageToNext();
...
<?php /**PATH /var/www/developmentoneso-project/resources/views/employee/edit.blade.php ENDPATH**/ ?>