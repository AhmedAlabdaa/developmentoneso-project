...
<body>
  <div class="contract-container">
    <div class="button-container no-print">
      <a href="<?php echo e(route('agreements.insideDownload', ['reference_no' => $agreement->reference_no])); ?>" class="btn-download">
    ...
    <div class="header">
      <img src="<?php echo e(asset('assets/img/'.$headerFileName)); ?>" alt="Header">
    </div>
    ...
    <table class="solid-table-container">
      ...
      <tr>
        <td><?php echo e($agreement->client->passport_number); ?></td>
    ...
    <table class="clause-table">
      <tr>
        <td class="eng">
          ...
          It was agreed that the second party would pay to the first party the recruitment fees, amounting to <strong><?php echo e($totalAmount); ?> AED</strong> in the following manner:<br>
          Two payments: the first payment upon receipt of the worker: <strong><?php echo e($received); ?></strong>. The second payment: <strong><?php echo e($remaining); ?></strong> before the end of the probationary period (four days from the date of receiving the worker).
        </td>
        <td class="ara">
          <span class="clause-title">البند الأول: "التعاقد ونفقات مكتب الاستقدام"</span><br>
          تم الاتفاق على أن يدفع الطرف الثاني إلى الطرف الأول رسوم الاستقدام وقدرها <strong><?php echo e($totalAmount); ?> درهم</strong> بالطريقة التالية:<br>
          دفعتين: الدفعة الأولى عند تسلم العامل: <strong><?php echo e($received); ?></strong>. الدفعة الثانية: <strong><?php echo e($remaining); ?></strong> قبل نهاية فترة التجربة (أربعة أيام من تاريخ استلام العامل).
        </td>
      </tr>
      <tr>
        <td class="eng">
          <span class="clause-title">The second clause: "trial period"</span><br>
          The worker shall be placed under probation for a period of 4 days, starting from <strong><?php echo e($agreementStart); ?></strong> the date the worker received it until the date of <strong><?php echo e($agreementEnd); ?></strong>.
        </td>
        <td class="ara">
          <span class="clause-title">البند الثاني: "فترة التجربة"</span><br>
          يوضع العامل تحت التجربة لمدة 4 أيام بدءًا من <strong><?php echo e($agreementStart); ?></strong> تسلم العامل إلى غايته <strong><?php echo e($agreementEnd); ?></strong>.
        </td>
      </tr>
      <tr>
        <td class="eng">
    ...
    <table class="sign-table">
      ...
      <tr>
        <td>
          ...
          <span class="sig-name"><?php echo e($agreement->client->first_name); ?> <?php echo e($agreement->client->last_name); ?></span>
        </td>
        <td>
...
<?php /**PATH /var/www/developmentoneso-project/resources/views/agreements/trial_agreement.blade.php ENDPATH**/ ?>