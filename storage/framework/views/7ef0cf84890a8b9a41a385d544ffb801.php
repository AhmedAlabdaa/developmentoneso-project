        ...
        <div class="card flex-fill">
          <div class="card-body">
            ...
            <div class="d-flex justify-content-between align-items-center mb-3">
              ...
              <div>
                <!-- <a href="<?php echo e(route('employees.create')); ?>" class="btn btn-primary btn-sm gap-2">
                  <i class="fas fa-plus-circle"></i> Add Employee
                </a>
                <a href="<?php echo e(route('employees.upload-employees-csv-file')); ?>" class="btn btn-primary btn-sm gap-2">
                  <i class="fas fa-upload"></i> Upload CSV File
                </a> -->
                <a href="<?php echo e(url('candidates/inside?emp=1')); ?>" class="btn btn-primary btn-sm gap-2">
...
<script>
  ...
  function loadEmployees(status='all', page=1) {
    ...
    $.get("<?php echo e(route('employees.index')); ?>", {
      package: status,
...
<?php /**PATH /var/www/developmentoneso-project/resources/views/employee/index.blade.php ENDPATH**/ ?>