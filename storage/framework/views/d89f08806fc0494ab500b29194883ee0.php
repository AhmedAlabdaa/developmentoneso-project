      ...
      <?php else: ?>
        <?php $__currentLoopData = $packages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $trial): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          ...
          <tr style="<?php echo e($rowStyle); ?>">
            ...
            <td>
              <button type="button" style="font-size:8px!important" class="btn btn-outline-primary btn-sm js-open-sales-modal" data-can-change="<?php echo e($canChange ? '1':'0'); ?>" data-candidate-id="<?php echo e($trial->candidate_id); ?>" data-trial-id="<?php echo e($trial->trials_id); ?>" data-current-id="<?php echo e($currentSalesId); ?>" data-current-label="<?php echo e($currentSalesDisplay); ?>">
            ...
            <td>
              <div class="icon-bar">
                ...
                <?php if($trial->trial_status === 'Trial Return'): ?>
                  <a class="icon-btn" href="<?php echo e(route('packages.trialReturnForm', [ 'client_id' => $trial->client_id, 'candidate_id' => $trial->candidate_id, 'stage' => 'trial_return',])); ?>" target="_blank" data-bs-toggle="tooltip" title="Trial Return Form">
                    <i class="fas fa-file-invoice"></i>
                  </a>
                <?php endif; ?>
                <button class="icon-btn" data-bs-toggle="tooltip" title="Change Status" onclick="openDropdown('<?php echo e($trial->trials_id); ?>')"><i class="fas fa-train"></i></button>
              </div>
              <div class="dropdown-container" id="dropdownContainer-<?php echo e($trial->trials_id); ?>">
                ...
                <select class="form-control status-dropdown" onchange="trialChangeStatus(this,<?php echo e($trial->trials_id); ?>,<?php echo e($trial->candidate_id); ?>,<?php echo e($trial->client_id); ?>)">
                  <?php if($trial->trial_status==='Active'): ?>
...
<?php /**PATH /var/www/developmentoneso-project/resources/views/package/package/partials/trial_table.blade.php ENDPATH**/ ?>