          ...
          <div class="card-body">
            <div class="row mt-2">
              <div class="col-lg-4 d-flex justify-content-end align-items-center mt-2 ms-auto">
                <div class="d-flex justify-content-end align-items-center gap-3 mb-2">
                  <a href="<?php echo e(route('candidates.index')); ?>" class="btn btn-primary btn-sm gap-2">
                        ...
                        <div class="mb-2">
                          <select id="nationality" name="nationality" class="form-control">
                            ...
                            <?php $__currentLoopData = $nationalities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $nationality): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                              <option value="<?php echo e($nationality->name); ?>"><?php echo e($nationality->name); ?></option>
            ...
            <div class="row mt-2">
              <div class="col-lg-9" id="statistics_container">
                <?php echo $__env->make('candidates.partials.inside_counts_emp', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
              </div>
              <div class="col-lg-3">
            ...
            <?php if(session('alert')): ?>
              <div class="alert alert-warning mt-3"><?php echo e(session('alert')); ?></div>
            <?php endif; ?>
...
function updateTable(params = {}){
  ...
  showPreloader();
  let url = '<?php echo e(route("candidates.inside")); ?>';
  $.ajax({
    url: url,
    type: 'GET',
...
$(document).ready(function(){
  ...
  $('#export_excel').on('click', function(){
    const url = '<?php echo e(route("candidates.inside")); ?>';
...
<?php /**PATH /var/www/developmentoneso-project/resources/views/candidates/inside_emp.blade.php ENDPATH**/ ?>