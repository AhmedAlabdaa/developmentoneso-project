...
<div class="container">
    <div style="text-align: center; margin: 10px 0;">
        <a href="<?php echo e(route('wc_contract.pdf.download', ['candidate' => $candidate->reference_no])); ?>" class="btn btn-primary" title="Download Contract">
            <i class="bi bi-download me-2"></i> Download
        </a>
        <a href="<?php echo e(route('wc_contract.pdf.view', ['candidate' => $candidate->reference_no])); ?>" class="btn btn-primary" title="View PDF">
            <i class="bi bi-file-pdf me-2"></i> View PDF
        </a>
        <a href="<?php echo e(route('candidates.index')); ?>" class="btn btn-primary" title="Back to Candidates">
    ...
    <div class="row">
        ...
        <div class="col-md-4" style="border-top: 1px solid;border-bottom: 1px solid;text-align: left;">
            ...
            <p>Name: <?php echo e($candidate->client ? $candidate->client->first_name . ' ' . $candidate->client->last_name : 'N/A'); ?></p>
            <p>Address:  <?php echo e($candidate->client ? $candidate->client->address : 'N/A'); ?></p>
            <p>Phone No: <?php echo e($candidate->client ? $candidate->client->mobile : 'N/A'); ?></p>
            <p>ID: <?php echo e($candidate->client ? $candidate->client->emirates_id : 'N/A'); ?></p>
            ...
            <p>Name: <?php echo e($candidate->candidate_name); ?></p>
            <p>Age: <?php echo e($candidate->age); ?></p>
            <p>Sex: <?php echo e($candidate->gender); ?></p>
            <p>Social Status: <?php echo e($candidate->marital_status); ?></p>
            <p>Passport: <?php echo e($candidate->passport_no); ?></p>
            <p>Education: <?php echo e($candidate->education_level); ?></p>
            <p>Occupation: </p>
...
<?php echo $__env->make('../layout.footer', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/developmentoneso-project/resources/views/candidates/wc_contract.blade.php ENDPATH**/ ?>