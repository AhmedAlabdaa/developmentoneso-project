        ...
        <tbody>
            ...
            <?php $__currentLoopData = $candidates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $candidate): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr class="<?php echo e($candidate->appeal == 1 ? 'table-warning appeal-row' : ''); ?>">
                    ...
                    <td>
                        <?php switch($candidate->coc_status):
                            case ('Pulled'): ?>
                                <button style="font-size:12px;" class="btn btn-success">Pulled</button>
                                <?php break; ?>

                            <?php case ('On Training'): ?>
                                <button style="font-size:12px;" class="btn btn-primary">On Training</button>
                                <?php break; ?>

                            <?php case ('Not Online'): ?>
                                <button style="font-size:12px;" class="btn btn-warning">Not Online</button>
                                <?php break; ?>
                    ...
                    <?php
                        ...
                        if (in_array($userRole, ['Admin', 'Operations Manager','Managing Director'], true)) {
...
<?php /**PATH /var/www/developmentoneso-project/resources/views/candidates/partials/candidates_table_10.blade.php ENDPATH**/ ?>