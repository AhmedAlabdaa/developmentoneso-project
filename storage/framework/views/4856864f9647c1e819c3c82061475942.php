    ...
    <table class="table table-striped table-hover">
        <thead>
            <tr>
                ...
                <th title="Candidate #">CN #</th>
                <th title="Client #">CL #</th>
                <th title="Agreement #">Agreement #</th>
        ...
        <tbody>
            ...
            <?php $__currentLoopData = $candidates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $candidate): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr class="<?php echo e($candidate->appeal == 1 ? 'table-warning appeal-row' : ''); ?>">
                    ...
                    <td>
                        <?php if($candidate->agreement): ?>
                            <a style="color: #007bff !important;" href="<?php echo e(route('candidates.show', $candidate->reference_no)); ?>" target="_blank" class="text-decoration-none text-dark">
                                <?php echo e(strtoupper($candidate->agreement->CN_Number)); ?>
                    ...
                    <td>
                        <?php if($candidate->agreement): ?>
                            <a style="color: #007bff !important;" href="<?php echo e(route('crm.show', $candidate->agreement->client->slug ?? '')); ?>" target="_blank" class="text-decoration-none text-dark">
                                <?php echo e(strtoupper($candidate->agreement->CL_Number)); ?>
                    ...
                    <td><a href="<?php echo e(route('agreements.show', $candidate->agreement->reference_no ?? '')); ?>"><?php echo e(strtoupper($candidate->agreement->reference_no ?? 'N/A')); ?></a></td>
                    <td>
                        <a style="color: #007bff !important;" href="<?php echo e(route('candidates.show', $candidate->reference_no)); ?>" target="_blank" class="text-decoration-none text-dark">
...
<?php /**PATH /var/www/developmentoneso-project/resources/views/candidates/partials/candidates_table_4.blade.php ENDPATH**/ ?>