...
<head>
    ...
    <style>
        ...
        .solid-table-container td {
            border: 1px solid #000;
            padding: 10px;
            text-align: center;
        }
        .solid-table-container input {
            width: 90%;
            padding: 5px;
            font-size: 12px;
            border: 1px solid #ccc;
    ...
    <div class="contract-container">
        ...
        <table class="table-container">
            <tr>
                <td>
                    <input type="text" 
                           value="<?php echo e($agreement->created_at ? $agreement->created_at->format('d-m-Y') : ''); ?>">
                </td>
                <td>
                ...
                <td>
                    <input type="text" readonly value="<?php echo e($agreement->reference_no); ?>">
                </td>
                <td>
        ...
        <table class="solid-table-container">
            <tr>
                <td><input type="text" value="<?php echo e($agreement->client->name); ?>"></td>
                <td><strong>اسم العميل<br>CUSTOMER&nbsp;NAME</strong></td>
                <td rowspan="8" class="vertical-text">Second&nbsp;Party<br>الطرف&nbsp;الثاني</td>
                <td><input type="text" value="مركز الابداع لخدمات العمالة المساعدة"></td>
            ...
            <tr>
                <td><input style="width:200px;" type="text" value="<?php echo e($agreement->client->email); ?>"></td>
                <td><strong>البريد الإلكتروني<br>EMAIL</strong></td>
        ...
        <div class="terms-container">
            <div class="terms">
                <ul>
                    ...
                    <li>The First Party commits to providing a domestic helper service under the sponsorship of the First Party, who will handle the work permit and residency for the domestic helper for a period of two years in exchange for an upfront fee agreed upon as: <?php echo e($totalAmount); ?> AED.</li>
                    <li>The parties agree that the duration of this contract shall extend from the date <?php echo e(\Carbon\Carbon::parse($agreement->agreement_start_date)->format('d-m-Y')); ?> to <?php echo e(\Carbon\Carbon::parse($agreement->agreement_end_date)->format('d-m-Y')); ?></li>
                    ...
                    <li>In cases of worker absconding or refusal to work, the second party commits to informing the first party within a maximum of 5 working days, and the first party commits to providing a replacement worker within 48 hours. If this is not possible, the second party has the right to cancel the contract.</li>
                    <li>If the second party wishes to terminate this agreement, it undertakes to formally notify the first party one month before the date of its cancellation. Or in the event of immediate termination, pay the month’s fees in cash.</li>
                ...
                <ul class="rtl">
                    ...
                    <li>يتعهد الطرف الأول بتقديم خدمة مساعد منزلي تحت كفالته، الذي سيتولى تصريح العمل والإقامة للعامل المساعد لمدة سنتين مقابل رسوم مسبقة يتم الاتفاق عليها بمبلغ: <?php echo e($totalAmount); ?> درهم إماراتي.</li>
                    <li>يتفق الطرفان على أن مدة هذا العقد تمتد من التاريخ <?php echo e(\Carbon\Carbon::parse($agreement->agreement_start_date)->format('d-m-Y')); ?> إلى <?php echo e(\Carbon\Carbon::parse($agreement->agreement_end_date)->format('d-m-Y')); ?></li>
                    ...
                    <li>يتعهد الطرف الأول بإيداع راتب العامل المساعد شهريًا من خلال نظام حماية الأجور.</li>
                    ...
                    <li>في حالة تأخر الطرف الثاني في دفع الرسوم، سيتم اتخاذ الإجراءات القانونية اللازمة، بما في ذلك استخدام الشيكات الضامنة.</li>
                    ...
                    <li>يتعهد الطرف الثاني بضمان استلام العامل لرواتبه المودعة من الطرف الأول من خلال مكتب الصرافة.</li>
                    <li>في حالة هروب العامل أو رفضه العمل، يلتزم الطرف الثاني بإبلاغ الطرف الأول بحد أقصى 5 أيام عمل، ويتعهد الطرف الأول بتوفير عامل بديل خلال 48 ساعة. وإذا لم يكن ذلك ممكنًا، يحق للطرف الثاني إلغاء العقد.</li>
                    <li>إذا رغب الطرف الثاني في إنهاء هذه الاتفاقية، يتعهد بإخطار الطرف الأول رسميًا قبل شهر من تاريخ الإلغاء. أو في حالة الإنهاء الفوري، دفع الرسوم الشهرية نقدًا.</li>
                    <li>يتعهد الطرف الأول بتوفير تأمين صحي للعامل، ويتعهد الطرف الثاني بضمان تلقي العامل الرعاية الطبية طوال مدة عمله.</li>
                    <li>يتمتع العامل بكافة الحقوق العمالية التي يضمنها قانون العمل الإماراتي، ويعمل لدى الطرف الثاني على أساس الإعارة، ويقيم معه باتفاق متبادل.</li>
                    <li>يتعهد الطرف الثاني بتشغيل العامل في التخصص المتفق عليه وفقًا لقوانين الدولة وتوفير السكن المناسب وظروف معيشية ملائمة.</li>
                    <li>إذا سافر العامل مع صاحب العمل خارج الدولة، يجب على الطرف الثاني إخطار الطرف الأول، والحصول على رسالة موافقة السفر، وإيداع شيك ضمان، حيث سيتم تحديد المبلغ لاحقًا بناءً على مدة العقد وجنسية العامل.</li>
                    <li>يتعهد الطرفان بالامتثال لجميع الشروط والأحكام المنصوص عليها في هذه الاتفاقية.</li>
                    <li>تنتهي هذه الاتفاقية تلقائيًا عند انتهاء مدتها المحددة ما لم يتم تمديدها وفقًا للشروط المنصوص عليها.</li>
                    ...
                    <li>فيما لم يرد به نص في هذا العقد، تسري أحكام القانون الاتحادي رقم (10) لسنة 2017 بشأن عمال الخدمة المساعدة، ولائحته التنفيذية، وباقي الأنظمة القانونية الصادرة عن وزارة الموارد البشرية والتوطين. وتكون محاكم الإمارات هي الجهة القضائية المختصة بالنظر في أي منازعات تتعلق بهذا العقد.</li>
                    <li>دون الإخلال بحق الوزارة في اتخاذ الإجراءات القانونية ضد الطرف المخالف للعقد، في حالة حدوث خلاف بين الطرفين، يجب اللجوء إلى الوزارة لتسوية الموضوع وديًا واتخاذ الإجراءات المناسبة.</li>
                </ul>
            </div>
        </div>
        <div class="signature-section">
            <div class="signature-box">
                ...
                <p>Name: <span class="signature-line"><?php echo e($agreement->client->name); ?></span></p>
...
<?php /**PATH /var/www/developmentoneso-project/resources/views/agreements/package2_agreement_download.blade.php ENDPATH**/ ?>