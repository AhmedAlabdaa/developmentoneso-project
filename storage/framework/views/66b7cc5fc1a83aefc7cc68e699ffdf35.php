...
<body>
  <div class="container">
    <div class="top-buttons">
      ...
      <button class="btn btn-sm btn-outline-success" onclick="shareInvoice('<?php echo e($invoice->invoice_number); ?>')">
        ...
        <td>
          <table class="inner-table w-100">
            ...
            <tr><th>Contract Type</th>
                <td>
                  <?php if($invoice->agreement->status==5): ?> CT-<?php echo e($invoice->CN_Number); ?>

                  <?php else: ?> <?php echo e($invoice->agreement->agreement_type); ?>
            ...
            <tr><th>Nationality</th>
                <td>
                  <?php switch($invoice->agreement->nationality):
                    case (1): ?> Ethiopia <?php break; ?>
                    <?php case (2): ?> Uganda <?php break; ?>
                    <?php case (3): ?> Philippines <?php break; ?>
                    <?php case (4): ?> Indonesia <?php break; ?>
                    <?php case (5): ?> Sri Lanka <?php break; ?>
                    <?php case (6): ?> Myanmar <?php break; ?>
                    <?php default: ?> <?php echo e($invoice->agreement->nationality); ?>
    ...
    <table class="totals-table">
      <tr><td>Subtotal</td><td><?php echo e(number_format($net,2)); ?></td></tr>
      <tr><td>VAT (5%)</td><td><?php echo e(number_format($vat,2)); ?></td></tr>
      <tr><td>Total</td><td><?php echo e(number_format($total,2)); ?></td></tr>
      <tr><td>Received</td><td><?php echo e(number_format($received,2)); ?></td></tr>
      <tr><td>Balance</td><td><?php echo e(number_format($balance,2)); ?></td></tr>
    </table>
    ...
    <?php if(isset($receiptVouchers) && $receiptVouchers->count() > 0): ?>
    <div class="mb-3">
      <h3 style="font-size:14px;font-weight:bold;margin-bottom:10px;"><i class="fas fa-receipt"></i> Receipt Vouchers</h3>
      <?php $__currentLoopData = $receiptVouchers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rv): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
      <div style="border:1px solid #ddd;padding:10px;margin-bottom:10px;border-radius:5px;">
        <div style="display:flex;justify-content:space-between;margin-bottom:8px;">
          <span><strong><?php echo e($rv->serial_number); ?></strong></span>
          <span class="badge <?php echo e($rv->status == 'posted' ? 'bg-success' : 'bg-secondary'); ?>"><?php echo e(ucfirst($rv->status ?? 'Pending')); ?></span>
        </div>
        <?php if($rv->journal && $rv->journal->lines->count() > 0): ?>
        <table class="table table-sm table-bordered" style="font-size:11px;margin-bottom:0;">
          ...
          <tbody>
            <?php $__currentLoopData = $rv->journal->lines; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $line): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php if($line->debit > 0): ?>
            <tr>
              <td><?php echo e($line->ledger->name ?? 'N/A'); ?></td>
              <td class="text-end"><?php echo e(number_format($line->debit, 2)); ?></td>
    ...
    <div class="text-center mb-3">
      <img src="<?php echo e(asset('assets/img/' . $footerFileName)); ?>" class="img-fluid">
    </div>
  </div>
        ...
        <div class="modal-body modal-body-scroll">
          <form id="edit_invoice_form" enctype="multipart/form-data">
            ...
            <div class="mb-3">
              ...
              <input type="number" name="total_amount" class="form-control form-control-sm" value="<?php echo e(number_format($total,2,'.','')); ?>" step="0.01" required>
            </div>
            <div class="mb-3">
              <label><i class="fas fa-money-bill-wave"></i> Received Amount</label>
              <input type="number" name="received_amount" class="form-control form-control-sm" value="<?php echo e(number_format($received,2,'.','')); ?>" step="0.01" required>
            </div>
            <div class="mb-3">
...
<?php /**PATH /var/www/developmentoneso-project/resources/views/invoices/show1.blade.php ENDPATH**/ ?>