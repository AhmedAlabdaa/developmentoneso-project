...
<body>
<?php
  $crm = data_get($cont, 'primaryContract.crm') ?? data_get($cont, 'primary_contract.crm');
  $employee = data_get($cont, 'employee');
  $customerName = trim(($crm?->first_name ?? '') . ' ' . ($crm?->last_name ?? ''));
  $contractNumber = $cont?->serial_no ?? data_get($cont, 'primaryContract.serial_no') ?? data_get($cont, 'primary_contract.serial_no');
  $contractDate = $cont?->date ?? $cont?->created_at;
  $customerIdNo = $crm?->CL_Number;
  $customerMobile = $crm?->mobile;
  $customerNationality = $crm?->nationality;
  $customerAddress = $crm?->address;
  $customerPassportNo = $crm?->passport_number;
  $customerEmiratesId = $crm?->emirates_id;
  $employeeNationality = $employee?->nationality;
  $employeePassportNo = $employee?->passport_no;
  $employeeEmiratesId = $employee?->emirates_id;
  $employeeMaritalStatus = $employee?->maritial_status ?? $employee?->marital_status;
  $contractEndDate = data_get($cont, 'primaryContract.end_date') ?? data_get($cont, 'primary_contract.end_date');
  $maidSalary = $employee?->salary;
?>


<div class="container">
  <div class="row" style="width: 210mm;border: 1px solid;text-align: center;margin-left: auto;margin-right: auto;">
    <a href="/get/arabic-p4/<?php echo e($cont?->id); ?>" class="btn btn-xs btn-danger no-print pull-right" style="width: 100%;margin-top: 10px;margin-bottom: 10px;">
  ...
  <div class="row" style="border: 1px solid">
      ...
      <table class="table" border="1">
          <tbody><tr>
            <td align="left" class="bordertop" colspan="3">
              Contract Number: <?php echo e($contractNumber ?? 'NA'); ?>         </td>
          </tr>

          <tr>
       
            <td align="left" class="bordertop">The Date : <?php echo e($contractDate ?? 'NA'); ?></td>
            <td align="left" class="bordertop">The Emirate : <?php echo e(env('company_emirate') ?? "Dubai"); ?></td>
          </tr>
      ...
      <table class="table" style="margin-top: -21px;width: 94%;float: left;position: relative;left: 6px;" border="1">
        <tbody><tr style="border-left: 1px solid #FFF;">
          <td colspan="2" class="bordertop" style="border-left: #FFF;"> alebdaa workers employment services center</td>
        </tr>

        <tr style="border-left: 1px solid #FFF;">
          <td colspan="2" class="bordertop" style="border-left: #FFF;">Represented by : <?php echo e($cont?->created_by); ?></td>
        </tr>

        <tr style="border-left: 1px solid #FFF;">
 
          <td class="bordertop" width="50%" style="border-left: #FFF;">License No.: <?php echo e(env('company_License_no') ?? "NA"); ?> </td>
        </tr>

        <tr style="border-left: 1px solid #FFF;">
          
          <td class="bordertop" width="50%" style="border-left: #FFF;">Mobile:<?php echo e(env('company_phone') ?? "NA"); ?>  </td>
        </tr>

        <tr style="border-left: 1px solid #FFF;">
          <td class="bordertop" width="50%" style="border-left: #FFF;">P.O box : <?php echo e(env('company_po_box') ?? "NA"); ?> </td>
          <td class="bordertop" width="50%" style="border-left: #FFF;">E-mail : <?php echo e(env('company_email') ?? "NA"); ?> </td>
        </tr>
        ...
        <tr style="border-left: 1px solid #FFF;">
          <td colspan="2" class="bordertop" style="border-left: #FFF;">Name: <?php echo e($customerName ?: 'NA'); ?></td>
        </tr>

        <tr style="border-left: 1px solid #FFF;">
          <td class="bordertop" width="50%" style="border-left: #FFF;">Gender: </td>
          <td class="bordertop" width="50%" style="border-left: #FFF;">Nationality: <?php echo e($customerNationality ?? 'NA'); ?></td>
        </tr>

        <tr style="border-left: 1px solid #FFF;">
          <td class="bordertop" width="50%" style="border-left: #FFF;">Passport No.: <?php echo e($customerPassportNo ?? 'NA'); ?></td>
          <td class="bordertop" width="50%" style="border-left: #FFF;">ID No.: <?php echo e($customerEmiratesId ?? $customerIdNo ?? 'NA'); ?></td>
        </tr>

        <tr style="border-left: 1px solid #FFF;">
          <td class="bordertop" width="50%" style="border-left: #FFF;">Email: NA</td>
          <td class="bordertop" width="50%" style="border-left: #FFF;">Mobile: <?php echo e($customerMobile ?? 'NA'); ?></td>
        </tr>

        <tr style="border-left: 1px solid #FFF;">
          <td colspan="2" class="bordertop" style="border-left: #FFF;">Address: <?php echo e($customerAddress ?? 'NA'); ?></td>
        </tr>
      </tbody></table>
      ...
      <table class="table" border="1">
          <tbody><tr>
            <td class="bordertop" colspan="3">Name: <?php echo e($employee?->name ?? 'NA'); ?></td>
          </tr>

          <tr>
            <td align="left" class="bordertop" width="45%">Nationality : <?php echo e($employeeNationality ?? 'NA'); ?></td>
            <td align="left" class="bordertop">Gender : Female</td>
            <td align="left" class="bordertop">Age : NA</td>
          ...
          <tr>
            <td class="bordertop" colspan="2">Languages: 
              English              -Arabic                                        </td>
            <td class="bordertop">Marital status: <?php echo e($employeeMaritalStatus ?? 'NA'); ?></td>
          </tr>
         <tr>
      ...
      <table class="table" style="margin-top: 2px;">
          ...
          <tr>
            <td align="left" style="border-top: none;">1. Pay the First Party the cost of the: hour/day/week/month in consideration for the provision of the services referred to above;according to the value of the hour/day/week/ month being ( AED <?php echo e($maidSalary ?? '0.00'); ?>), 
          </tr>
      ...
      <table class="table" border="1">
          ...
          <tr>
            <td align="left" class="bordertop" width="50%">Name : alebdaa workers employment services center </td>
            <td align="left" class="bordertop">Name : <?php echo e($customerName ?: 'NA'); ?></td>
          </tr>

          <tr>
            <td class="bordertop">Signature</td>
            <td class="bordertop">Signature  <img src="<?php echo e($cont?->signature); ?>" style="width: 50%; max-width: 200px;"></td>
          </tr>
         
      </tbody></table>
      Date: <?php echo e($contractDate ?? 'NA'); ?> </div>
</div>
...
<?php /**PATH /var/www/developmentoneso-project/resources/views/monthly_contracts/ministry_contract.blade.php ENDPATH**/ ?>