    ...
    <table class="table table-striped table-hover">
        <thead>
            <tr>
                ...
                <th title="MOL Submitted Date">MOL-Submitted</th>
        ...
        <tbody>
            ...
            <?php $__currentLoopData = $candidates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $candidate): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr class="<?php echo e($candidate->appeal == 1 ? 'table-warning appeal-row' : ''); ?>">
                    ...
                    <td><button class="btn btn-primary"><?php echo e(strtoupper(\Carbon\Carbon::parse($candidate->mol_submitted_date)->format('d M Y'))); ?></button></td>
                    ...
                    <?php
                        ...
                        if ($userRole === 'Admin') {
                            $dropdownStatuses = $adminStatuses;
                        } elseif (in_array($userRole, ['Customer Service', 'Sales Coordinator', 'Sales Officer'])) {
                            if ($candidateStatus == 1) {
                                $dropdownStatuses = [
                                    1 => 'Available',
                                    3 => 'Hold'
...
<?php /**PATH /var/www/developmentoneso-project/resources/views/candidates/partials/candidates_table_11.blade.php ENDPATH**/ ?>