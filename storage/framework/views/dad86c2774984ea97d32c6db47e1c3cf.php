                      ...
                      <?php
                        ...
                        <select id="gf_status" name="gf_status" class="form-control form-control-sm">
                          ...
                          <?php $__currentLoopData = $statusOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($value); ?>" <?php if((string)$current === (string)$value): echo 'selected'; endif; ?>><?php echo e($label); ?></option>
...
<script>
  $(function(){
    function loadContracts(status = 'all', url = "<?php echo e(route('contracts.index')); ?>") {
      $('.preloader').show();
      const data = {
        status,
    ...
    $('#filter_export').click(() => {
      ...
      window.location = '<?php echo e(route("contracts.index")); ?>?' + params;
    });
...
<?php /**PATH /var/www/developmentoneso-project/resources/views/contracts/index.blade.php ENDPATH**/ ?>