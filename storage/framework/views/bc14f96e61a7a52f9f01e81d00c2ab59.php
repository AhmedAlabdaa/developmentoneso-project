            ...
            <div class="card-body">
                <div class="row g-2 align-items-center">
                    ...
                    <div class="col-lg-8 col-md-7 text-end">
                        ...
                        <?php if(auth()->user()->role === 'Operations Manager' || auth()->user()->role === 'Admin' || auth()->user()->role === 'Sales Officer'): ?>
...
<form id="exportForm" method="GET" action="<?php echo e(route('package.index')); ?>" target="_blank" style="display:none;">
...
$(function(){
    ...
    function loadCandidates(url='<?php echo e(route("package.index")); ?>') {
...
<?php /**PATH /var/www/developmentoneso-project/resources/views/package/package/index.blade.php ENDPATH**/ ?>