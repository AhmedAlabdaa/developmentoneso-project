            ...
            <tbody>
              @foreach($employees as $e)
                ...
                <tr id="emp-row-{{ $e->id }}">
                  ...
                  <td class="cell-slug">{{ $e->slug }}</td>
                  <td class="cell-title">
                    <div><span class="lang-chip">EN</span> <span class="val-en">{{ $e->meta_title }}</span></div>
                    <div class="mt-1"><span class="lang-chip ar">AR</span> <span class="val-ar">{{ $e->meta_title_ar }}</span></div>
                  </td>
                  <td class="cell-keywords">
                    <div class="text-truncate"><span class="lang-chip">EN</span> <span class="val-en">{{ $e->meta_keywords }}</span></div>
                    <div class="text-truncate mt-1"><span class="lang-chip ar">AR</span> <span class="val-ar">{{ $e->meta_keywords_ar }}</span></div>
                  </td>
                  <td class="cell-description">
                    <div class="text-truncate"><span class="lang-chip">EN</span> <span class="val-en">{{ $e->meta_description }}</span></div>
                    <div class="text-truncate mt-1"><span class="lang-chip ar">AR</span> <span class="val-ar">{{ $e->meta_description_ar }}</span></div>
                  </td>
                  <td class="text-center">
                    <button
                      ...
                      data-id="{{ $e->id }}"
                      data-row="#emp-row-{{ $e->id }}"
                      data-ref="{{ $ref }}"
                      data-name="{{ $name }}"
                      data-slug="{{ e($e->slug) }}"
                      data-title-en="{{ e($e->meta_title) }}"
                      data-title-ar="{{ e($e->meta_title_ar) }}"
                      data-keywords-en="{{ e($e->meta_keywords) }}"
                      data-keywords-ar="{{ e($e->meta_keywords_ar) }}"
                      data-description-en="{{ e($e->meta_description) }}"
                      data-description-ar="{{ e($e->meta_description_ar) }}"
                      title="Edit SEO/Slug"
                    >
...
<script>
  ...
  const updateUrlTemplate = "{{ route('available-employees.update', ':id') }}";
  let dt;
