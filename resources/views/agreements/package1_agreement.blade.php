...
<body>
  <div class="contract-container">
    ...
    <table class="solid-table-container">
      ...
      <tr>
        <td>{{ $agreement->client->nationality ?? $agreement->nationality }}</td>
    ...
    <div class="terms-container">
      <div class="terms">
        <ul>
          ...
          <li>The First Party commits to providing a domestic helper service under its sponsorship, handling the work permit and residency for the domestic helper for two years in exchange for an upfront fee of {{ $totalAmount }} AED.</li>
          <li>The parties agree that the duration of this contract shall extend from the date {{ $agreementStartDate }} to {{ $agreementToDate }}.</li>
        ...
        <ul class="rtl">
          ...
          <li>يتعهد الطرف الأول بتقديم خدمة مساعد منزلي تحت كفالته، ويتولى تصريح العمل والإقامة للعامل المساعد لمدة سنتين مقابل رسوم مسبقة بمبلغ {{ $totalAmount }} درهم إماراتي.</li>
          <li>يتفق الطرفان على أن مدة هذا العقد تمتد من التاريخ {{ $agreementStartDate }} إلى {{ $agreementToDate }}.</li>
