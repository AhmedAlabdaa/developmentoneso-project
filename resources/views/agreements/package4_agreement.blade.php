...
<body>
    <div class="contract-container">
        ...
        <table class="solid-table-container">
            <tr>
                <td>
                    <input type="text" value="{{ $agreement->client->first_name }} {{ $agreement->client->last_name }}">
                </td>
            ...
            <tr>
                <td>
                    <input type="text" value="{{ $agreement->client->emirates_id }}">
                </td>
            ...
            <tr>
                <td>
                    <input type="text" value="{{ $agreement->client->address }}">
                </td>
            ...
            <tr>
                <td>
                    <input type="text" value="{{ $agreement->client->passport_number }}">
                </td>
            ...
            <tr>
                <td>
                    <input type="text" value="{{ $agreement->client->nationality }}">
                </td>
            ...
            <tr>
                <td>
                    <input type="text" value="{{ $agreement->client->mobile }}">
                </td>
                <td><strong>رقم الهاتف<br>PHONE NUMBER</strong></td>
            ...
            <tr>
                <td>
                    <input style="width:200px;" type="text" value="{{ $agreement->client->email }}">
                </td>
        ...
        <div class="terms-container">
            <div class="terms">
                <ul>
                    ...
                    <li>The First Party commits to providing a domestic helper registration service under the sponsorship of the First Party, who will handle the work permit and residency for the domestic helper for a period of two years in exchange for an upfront fee agreed upon as: {{ $totalAmount }} AED.</li>
                ...
                <ul class="rtl">
                    ...
                    <li>يتعهد الطرف الأول بتقديم خدمة تسجيل مساعد منزلي تحت كفالته، الذي سيتولى تصريح العمل والإقامة للعامل المساعد لمدة سنتين مقابل رسوم مسبقة يتم الاتفاق عليها بمبلغ: {{ $totalAmount }}درهم إماراتي.</li>
                    ...
                    <li>يتعهد الطرف الأول بدفع راتب العامل المساعد، والذي يبلغ  {{ $agreement->salary }} درهم إماراتي شهريًا من خلال نظام حماية الأجور.</li>
