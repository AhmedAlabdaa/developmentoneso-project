    ...
    <div class="contract-container">
        ...
        <table class="table-container">
            <tr>
                <td>
                    <input type="text" 
                           value="{{ $agreement->created_at ? $agreement->created_at->format('d-m-Y') : '' }}">
                </td>
                <td>
                ...
                <td>
                    <input type="text" readonly value="{{ $agreement->reference_no }}">
                </td>
                <td>
        ...
        <table class="solid-table-container">
            <tr>
                <td><input type="text" value="{{ $agreement->client->name }}"></td>
            ...
            <tr>
                ...
                <td><input type="text" value="{{ $agreement->candidate_name }}"></td>
            ...
            <tr>
                <td><input type="text" value="{{ \Carbon\Carbon::parse($agreement->agreement_start_date)->format('d-m-Y') }}"></td>
                <td><strong>تاريخ بدء الاتفاقية<br>Agreement&nbsp;Start&nbsp;Date</strong></td>
                <td><input type="text" value="{{ \Carbon\Carbon::parse($agreement->agreement_end_date)->format('d-m-Y') }}"></td>
        ...
        <div class="terms-container">
            <div class="terms">
                <ul>
                    ...
                    <li>The First Party commits to providing a domestic helper service under the sponsorship of the First Party, who will handle the work permit and residency for the domestic helper for a period of two years in exchange for an upfront fee agreed upon as: {{ $totalAmount }} AED.</li>
                    <li>The parties agree that the duration of this contract shall extend from the date {{ \Carbon\Carbon::parse($agreement->agreement_start_date)->format('d-m-Y') }} to {{ \Carbon\Carbon::parse($agreement->agreement_end_date)->format('d-m-Y') }}</li>
                ...
                <ul class="rtl">
                    ...
                    <li>يتعهد الطرف الأول بتقديم خدمة مساعد منزلي تحت كفالته، الذي سيتولى تصريح العمل والإقامة للعامل المساعد لمدة سنتين مقابل رسوم مسبقة يتم الاتفاق عليها بمبلغ: {{ $totalAmount }} درهم إماراتي.</li>
                    <li>يتفق الطرفان على أن مدة هذا العقد تمتد من التاريخ {{ \Carbon\Carbon::parse($agreement->agreement_start_date)->format('d-m-Y') }} إلى {{ \Carbon\Carbon::parse($agreement->agreement_end_date)->format('d-m-Y') }}</li>
        ...
        <div class="signature-section">
            <div class="signature-box">
                ...
                <p>Name: <span class="signature-line">{{ $agreement->client->name }}</span></p>
