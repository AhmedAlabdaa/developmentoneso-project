                ...
                <tr>
                  ...
                  <td class="text-center">
                    <button
                      ...
                      data-name-ar="{{ $s->service_name_arabic }}"
                      data-govt="{{ $s->govt_fee }}"
                      data-center="{{ $s->center_fee }}"
                    >
...
<script>
  ...
  const storeUrl          = "{{ route('services.store') }}";
  const updateUrlTemplate = "{{ route('services.update', ':id') }}";
