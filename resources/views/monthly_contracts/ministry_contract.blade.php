...
<div class="container">
  <div class="row" style="width: 210mm;border: 1px solid;text-align: center;margin-left: auto;margin-right: auto;">
    <a href="/get/arabic-p4/{{$cont?->id}}" class="btn btn-xs btn-danger no-print pull-right" style="width: 100%;margin-top: 10px;margin-bottom: 10px;">
  ...
  <div class="row" style="border: 1px solid">
      ...
      <table class="table" border="1">
          <tbody><tr>
            <td align="left" class="bordertop" colspan="3">
              Contract Number: {{$contractNumber ?? 'NA'}}         </td>
          </tr>

          <tr>
       
            <td align="left" class="bordertop">The Date : {{$contractDate ?? 'NA'}}</td>
      ...
      <table class="table" style="margin-top: -21px;width: 94%;float: left;position: relative;left: 6px;" border="1">
        ...
        <tr style="border-left: 1px solid #FFF;">
          <td colspan="2" class="bordertop" style="border-left: #FFF;">Represented by : {{$cont?->created_by}}</td>
        </tr>
        ...
        <tr style="border-left: 1px solid #FFF;">
          <td colspan="2" class="bordertop" style="border-left: #FFF;">Name: {{$customerName ?: 'NA'}}</td>
        </tr>

        <tr style="border-left: 1px solid #FFF;">
          <td class="bordertop" width="50%" style="border-left: #FFF;">Gender: </td>
          <td class="bordertop" width="50%" style="border-left: #FFF;">Nationality: {{$customerNationality ?? 'NA'}}</td>
        </tr>

        <tr style="border-left: 1px solid #FFF;">
          <td class="bordertop" width="50%" style="border-left: #FFF;">Passport No.: {{$customerPassportNo ?? 'NA'}}</td>
          <td class="bordertop" width="50%" style="border-left: #FFF;">ID No.: {{$customerEmiratesId ?? $customerIdNo ?? 'NA'}}</td>
        </tr>

        <tr style="border-left: 1px solid #FFF;">
          <td class="bordertop" width="50%" style="border-left: #FFF;">Email: NA</td>
          <td class="bordertop" width="50%" style="border-left: #FFF;">Mobile: {{$customerMobile ?? 'NA'}}</td>
        </tr>

        <tr style="border-left: 1px solid #FFF;">
          <td colspan="2" class="bordertop" style="border-left: #FFF;">Address: {{$customerAddress ?? 'NA'}}</td>
        </tr>
      </tbody></table>
      ...
      <table class="table" border="1">
          <tbody><tr>
            <td class="bordertop" colspan="3">Name: {{$employee?->name ?? 'NA'}}</td>
          </tr>

          <tr>
            <td align="left" class="bordertop" width="45%">Nationality : {{$employeeNationality ?? 'NA'}}</td>
          ...
          <tr>
            <td class="bordertop" colspan="2">Languages: 
              English              -Arabic                                        </td>
            <td class="bordertop">Marital status: {{$employeeMaritalStatus ?? 'NA'}}</td>
          </tr>
         <tr>
      ...
      <table class="table" style="margin-top: 2px;">
          ...
          <tr>
            <td align="left" style="border-top: none;">1. Pay the First Party the cost of the: hour/day/week/month in consideration for the provision of the services referred to above;according to the value of the hour/day/week/ month being ( AED {{$maidSalary ?? '0.00'}}), 
          </tr>
      ...
      <table class="table" border="1">
          ...
          <tr>
            ...
            <td align="left" class="bordertop">Name : {{$customerName ?: 'NA'}}</td>
          </tr>

          <tr>
            <td class="bordertop">Signature</td>
            <td class="bordertop">Signature  <img src="{{$cont?->signature}}" style="width: 50%; max-width: 200px;"></td>
          </tr>
         
      </tbody></table>
      Date: {{$contractDate ?? 'NA'}} </div>
</div>
