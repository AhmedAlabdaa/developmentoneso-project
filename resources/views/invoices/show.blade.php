...
<body>
  <div class="container">
    <div class="top-buttons">
      ...
      <button class="btn btn-sm btn-outline-info" onclick="shareInvoice('{{ $invoice->invoice_number }}')">
    ...
    <table class="outer-table">
      <tr>
        ...
        <td style="width:50%;padding-left:10px">
          <table class="inner-table w-100">
            <tr><th>Contract Ref.</th><td>{{ $invoice->agreement->reference_no }}</td></tr>
            <tr><th>Contract Type</th><td>{{ $invoice->agreement->agreement_type }}</td></tr>
            <tr><th>Maid Name</th><td>{{ $invoice->agreement->candidate_name }}</td></tr>
    ...
    <table class="totals-table">
      <tr><td><strong>Subtotal</strong></td><td>{{ number_format($net,2) }} AED</td></tr>
      <tr><td><strong>VAT (5%)</strong></td><td>{{ number_format($vat,2) }} AED</td></tr>
      <tr><td><strong>Total</strong></td><td>{{ number_format($total,2) }}  AED</td></tr>
      <tr><td><strong>Received</strong></td><td>{{ number_format($received,2) }}  AED</td></tr>
      <tr><td><strong>Balance</strong></td><td>{{ number_format($balance,2) }} AED</td></tr>
    </table>
    ...
    <div class="footer"><img src="{{ asset('assets/img/' . $footerFileName) }}" class="img-fluid"></div>
  </div>
        ...
        <div class="modal-body scrollable-modal-body">
          <form id="edit_invoice_form" enctype="multipart/form-data">
            ...
            <div class="mb-3">
              ...
              <input type="number" name="total_amount" class="form-control form-control-sm" value="{{ number_format($invoice->total_amount,2,'.','') }}" step="0.01" required>
            </div>
            <div class="mb-3">
              <label><i class="fas fa-money-bill-wave"></i> Received Amount</label>
              <input type="number" name="received_amount" class="form-control form-control-sm" value="{{ number_format($invoice->received_amount,2,'.','') }}" step="0.01" required>
            </div>
            <div class="mb-3">
