...
{{-- Include Select2 CSS (adjust the version/path as needed) --}}
                        ...
                        <form action="{{ route('invoices.store') }}" method="POST" class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="invoice_number" id="invoice_number" class="form-control" value="{{ old('invoice_number', $nextInvoiceNumber ?? 'INV-0001') }}" placeholder="INV-0001" required readonly>
                                </div>
                            </div>
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <select name="customer_id" id="customer_id" class="form-select" style="width:90%" required>
                                        ...
                                        @foreach ($customers as $customer)
                                            ...
                                            > {{ $customer->first_name }} {{ $customer->last_name }} - {{ $customer->CN_Number ?? 'N/A' }}
                                            </option>
                                        @endforeach
                                    </select>
                                </div>
