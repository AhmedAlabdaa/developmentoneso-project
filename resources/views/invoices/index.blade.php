...
<script>
const routes={
  invoicesIndex:"{{ route('invoices.index') }}",
  invoicesExport:"{{ route('invoices.export') }}",
  updateStatus:"{{ route('invoices.updateStatus', ':id') }}",
  deleteInvoice:"{{ route('invoices.destroy', ':id') }}"
};
...
$(function(){
  ...
  $('#btn_reset_filters').on('click',()=>window.location="{{ route('invoices.index') }}");
