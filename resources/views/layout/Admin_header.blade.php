        ...
        <ul class="sidebar-nav" id="sidebar-nav">
            ...
            <li class="nav-item">
                ...
                <ul id="packages-nav" class="nav-content collapse {{ $activePackages ? 'show' : '' }}" data-bs-parent="#sidebar-nav">
                    @foreach ($pkgs as $pkg => $href)
                        @php
                            $isPkg1 = $pkg === 'PKG-1';
                            $active =
                                ($isPkg1 && request()->is('candidates/inside')) ||
                                (!$isPkg1 && request()->is('employee-with-information') && request('package') === $pkg);
                        @endphp
                        <li>
            ...
            <li class="nav-item">
                ...
                <ul id="reports-nav" class="nav-content collapse {{ $activeReports ? 'show' : '' }}" data-bs-parent="#sidebar-nav">
                    @foreach ($reportRoutes as $label => $href)
                        @php
          ...
          <div class="col-lg-12">
            <nav class="horizontal-nav card flex-fill">
              <ul class="nav justify-content-center">
                ...
                <li class="nav-item">
                  <a
                    class="nav-link text-center {{ request()->is('gov-transactions') ? 'active' : '' }}"
                    href="{{ url('gov-transactions') }}"
                  >
                    <i class="bi bi-file-earmark-text-fill display-6"></i>
                ...
                <li class="nav-item">
                  <a class="nav-link text-center {{ request()->is('finance*') ? 'active' : '' }}" href="{{ url('finance') }}" title="Finance">
