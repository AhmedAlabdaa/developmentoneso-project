                ...
                <div class="col-lg-12">
                    <nav class="horizontal-nav card flex-fill">
                        <ul class="nav justify-content-center">
                            ...
                            <li class="nav-item">
                                <a class="nav-link text-center {{ request()->is('candidates/new') ? 'active' : '' }}" href="{{ url('candidates/outside') }}">
                                    <i class="bi bi-people display-6"></i>
                                    <span class="d-block">Candidates</span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link text-center {{ request()->is('package') ? 'active' : '' }}" href="{{ url('package') }}">
                            ...
                            <li class="nav-item">
                                <a class="nav-link text-center {{ request()->is('invoices') ? 'active' : '' }}" href="{{ url('invoices') }}">
