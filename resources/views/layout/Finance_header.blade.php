...
<body class="toggle-sidebar">
    ...
    <aside id="sidebar" class="sidebar">
        ...
        <ul class="sidebar-nav" id="sidebar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link {{ $activePackages ? '' : 'collapsed' }}" data-bs-target="#packages-nav" data-bs-toggle="collapse" href="#">
                    <i class="bi bi-box-seam"></i>
                    <span>Packages</span>
                    <i class="bi bi-chevron-down ms-auto"></i>
                </a>
                <ul id="packages-nav" class="nav-content collapse {{ $activePackages ? 'show' : '' }}" data-bs-parent="#sidebar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link {{ $activeReports ? '' : 'collapsed' }}" data-bs-target="#reports-nav" data-bs-toggle="collapse" href="#">
                    <i class="bi bi-file-earmark-text"></i>
                    <span>Reports</span>
                    <i class="bi bi-chevron-down ms-auto"></i>
                </a>
                <ul id="reports-nav" class="nav-content collapse {{ $activeReports ? 'show' : '' }}" data-bs-parent="#sidebar-nav">
                    @foreach ($reportLinks as $label => $href)
                        @php $isActive = ($currentUrl === $href); @endphp
                        <li>
                            <a href="{{ $href }}" class="{{ $isActive ? 'active' : '' }}">
                                <i class="bi bi-dot"></i>
                                <span>{{ $label }}</span>
          ...
          <div class="col-lg-12">
            <nav class="horizontal-nav card flex-fill">
              <ul class="nav justify-content-center">
                ...
                <li class="nav-item">
                  <a
                    class="nav-link text-center {{ request()->is('settings') ? 'active' : '' }}"
                    href="{{ url('settings') }}"
                  >
