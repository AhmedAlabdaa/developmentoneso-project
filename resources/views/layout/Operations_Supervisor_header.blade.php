...
<head>
  ...
  <title>Dashboard - Operation Supervisor</title>
  <meta content="Dashboard page for Operation Supervisor application" name="description">
  <meta content="dashboard, Operation Supervisor" name="keywords">
...
<body class="toggle-sidebar">
    ...
    <aside id="sidebar" class="sidebar">
        <ul class="sidebar-nav" id="sidebar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link {{ request()->is('agents*') ? '' : 'collapsed' }}" data-bs-target="#agents-nav" data-bs-toggle="collapse" href="#">
                    <i class="bi bi-person-lines-fill"></i>
                    <span>Agents</span>
                    <i class="bi bi-chevron-down ms-auto"></i>
                </a>
                <ul id="agents-nav" class="nav-content collapse {{ request()->is('agents*') ? 'show' : '' }}" data-bs-parent="#sidebar-nav">
                    <li>
