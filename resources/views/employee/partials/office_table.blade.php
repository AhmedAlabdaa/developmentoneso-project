          ...
          <tr>
            ...
            <td>
              ...
              @else
                ...
                @endphp
                <button class="btn-icon-only btn-info btn-sm" type="button"><i class="fas {{ $ico }}"></i> {{ $lbl }}</button>
              @endif
            </td>
            ...
            <td>
              <button type="button" class="btn-icon-only btn-primary btn-view-proof"
                data-proof-url="{{ $e->ica_proof ? asset('storage/'.$e->ica_proof) : '' }}">
            ...
            <td>
              ...
              @if(in_array($e->inside_status, [1]))
                <a href="{{ route('employee.exit', $e->reference_no) }}" class="btn-icon-only btn-warning">
