                ...
                <div class="card-body card-soft-inner p-3 p-md-4">
                    <div class="d-flex justify-content-between align-items-center header-top mb-3">
                        <div>
                            ...
                            <div class="header-subtitle">{{ $now }}</div>
                        </div>
                        <div class="d-flex align-items-center">
                            <button type="button" class="btn-status-main {{ $statusClass }} me-2" id="currentStatusButton">
                    ...
                    @else
                        <div class="stage-accordion"
                             id="stageAccordion"
                             data-wc-done="{{ $newCandidate->wc_date ? 1 : 0 }}"
                             data-visa-done="{{ $newCandidate->visa_date ? 1 : 0 }}">
                            <div class="stage-row" data-stage="wc">
                                <div class="stage-header" data-bs-toggle="collapse" data-bs-target="#stageBody-wc">
                                    ...
                                    <span class="stage-status badge badge-{{ !empty($newCandidate->wc_date) ? 'success' : 'secondary' }} ms-auto" id="wcStatusBadge">
                                        {{ !empty($newCandidate->wc_date) ? 'COMPLETED' : 'PENDING' }}
                                    </span>
                                ...
                                <div id="stageBody-wc" class="collapse show">
                                    <div class="stage-body">
                                        <div class="stage-body-inner">
                                            ...
                                            <div class="table-responsive mt-2 {{ $newCandidate->wc_date ? '' : 'd-none' }}" id="wcTableWrapper">
                                                <table class="table stage-table" id="wcTable">
                                                    ...
                                                    <tr>
                                                        <td class="wc-date-cell">
                                                            {{ $newCandidate->wc_date ? fmtDate($newCandidate->wc_date) : 'N/A' }}
                                                        </td>
                                                        <td class="wc-dw-cell">
                                                            {{ $newCandidate->wc_dw_number ?? 'N/A' }}
                                                        </td>
                                                        <td class="wc-contract-cell">
                                                            @if($newCandidate->wc_contract_file)
                                                                {{ basename($newCandidate->wc_contract_file) }}
                                                            @else
                                                                N/A
                                                            @endif
                                                        </td>
                                                        <td class="wc-remarks-cell">
                                                            {{ $newCandidate->wc_remarks ?? 'N/A' }}
                                                        </td>
                            ...
                            <div class="stage-row" data-stage="incidentBeforeVisa">
                                <div class="stage-header" data-bs-toggle="collapse" data-bs-target="#stageBody-incidentBeforeVisa">
                                    ...
                                    <span class="stage-status badge ms-auto badge-{{ !empty($newCandidate->ibv_reason) ? 'danger' : 'secondary' }}" id="ibvStatusBadge">
                                        {{ !empty($newCandidate->ibv_reason) ? 'RECORDED' : 'NONE' }}
                                    </span>
                                    <i class="fas fa-chevron-down stage-chevron"></i>
                                </div>
                                <div id="stageBody-incidentBeforeVisa" class="collapse">
                                    <div class="stage-body">
                                        <div class="stage-body-inner">
                                            ...
                                            <div class="table-responsive mt-2 {{ $newCandidate->ibv_date ? '' : 'd-none' }}" id="incidentBeforeVisaTableWrapper">
                                                <table class="table stage-table" id="incidentBeforeVisaTable">
                                                    ...
                                                    <tr>
                                                        <td class="ibv-date-cell">
                                                            {{ $newCandidate->ibv_date ? fmtDate($newCandidate->ibv_date) : 'N/A' }}
                                                        </td>
                                                        <td class="ibv-reason-cell">
                                                            {{ $newCandidate->ibv_reason ?? 'N/A' }}
                                                        </td>
                                                        <td class="ibv-proof-cell">
                                                            @if($newCandidate->ibv_proof)
                                                                {{ basename($newCandidate->ibv_proof) }}
                                                            @else
                                                                N/A
                                                            @endif
                                                        </td>
                                                        <td class="ibv-remarks-cell">
                                                            {{ $newCandidate->ibv_remarks ?? 'N/A' }}
                                                        </td>
                                                        <td class="text-end table-actions">
                                                            <button type="button"
                                                                    class="btn btn-outline-info btn-xs"
                            ...
                            <div class="stage-row" data-stage="visa">
                                <div class="stage-header" data-bs-toggle="collapse" data-bs-target="#stageBody-visa">
                                    ...
                                    <span class="stage-status badge badge-{{ !empty($newCandidate->visa_date) ? 'success' : 'secondary' }} ms-auto" id="visaStatusBadge">
                                        {{ !empty($newCandidate->visa_date) ? 'COMPLETED' : 'PENDING' }}
                                    </span>
                                    <i class="fas fa-chevron-down stage-chevron"></i>
                                </div>
                                <div id="stageBody-visa" class="collapse">
                                    <div class="stage-body">
                                        <div class="stage-body-inner">
                                            ...
                                            <div class="table-responsive mt-2 {{ $newCandidate->visa_date ? '' : 'd-none' }}" id="visaTableWrapper">
                                                <table class="table stage-table" id="visaTable">
                                                    ...
                                                    <tr>
                                                        <td class="visa-date-cell">
                                                            {{ $newCandidate->visa_date ? fmtDate($newCandidate->visa_date) : 'N/A' }}
                                                        </td>
                                                        <td class="visa-number-cell">
                                                            {{ $newCandidate->visa_number ?? 'N/A' }}
                                                        </td>
                                                        <td class="visa-expiry-cell">
                                                            {{ $newCandidate->visa_expiry_date ? fmtDate($newCandidate->visa_expiry_date) : 'N/A' }}
                                                        </td>
                                                        <td class="visa-uid-cell">
                                                            {{ $newCandidate->visa_uid_no ?? 'N/A' }}
                                                        </td>
                                                        <td class="visa-entry-permit-cell">
                                                            {{ $newCandidate->visa_entry_permit_no ?? 'N/A' }}
                                                        </td>
                                                        <td class="text-end table-actions">
                                                            <button type="button"
                                                                    class="btn btn-outline-info btn-xs"
                            ...
                            <div class="stage-row" data-stage="arrival">
                                <div class="stage-header" data-bs-toggle="collapse" data-bs-target="#stageBody-arrival">
                                    ...
                                    <span class="stage-status badge badge-{{ !empty($newCandidate->arrival_date) ? 'success' : 'secondary' }} ms-auto" id="arrivalStatusBadge">
                                        {{ !empty($newCandidate->arrival_date) ? 'COMPLETED' : 'PENDING' }}
                                    </span>
                                    <i class="fas fa-chevron-down stage-chevron"></i>
                                </div>
                                <div id="stageBody-arrival" class="collapse">
                                    <div class="stage-body">
                                        <div class="stage-body-inner">
                                            ...
                                            <div class="table-responsive mt-2 {{ $newCandidate->arrival_date ? '' : 'd-none' }}" id="arrivalTableWrapper">
                                                <table class="table stage-table" id="arrivalTable">
                                                    ...
                                                    <tr>
                                                        <td class="arrival-date-cell">
                                                            {{ $newCandidate->arrival_date ? fmtDate($newCandidate->arrival_date) : 'N/A' }}
                                                        </td>
                                                        <td class="arrival-passport-cell">
                                                            @if($newCandidate->arrival_passport_stamp_file)
                                                                {{ basename($newCandidate->arrival_passport_stamp_file) }}
                                                            @else
                                                                N/A
                                                            @endif
                                                        </td>
                                                        <td class="arrival-remarks-cell">
                                                            {{ $newCandidate->arrival_remarks ?? 'N/A' }}
                                                        </td>
                                                        <td class="text-end table-actions">
                                                            <button type="button"
                                                                    class="btn btn-outline-info btn-xs"
                            ...
                            <div class="stage-row" data-stage="incidentAfterArrival">
                                <div class="stage-header" data-bs-toggle="collapse" data-bs-target="#stageBody-incidentAfterArrival">
                                    ...
                                    <span class="stage-status badge ms-auto badge-{{ !empty($newCandidate->iaa_reason) ? 'danger' : 'secondary' }}" id="iaaStatusBadge">
                                        {{ !empty($newCandidate->iaa_reason) ? 'RECORDED' : 'NONE' }}
                                    </span>
                                    <i class="fas fa-chevron-down stage-chevron"></i>
                                </div>
                                <div id="stageBody-incidentAfterArrival" class="collapse">
                                    <div class="stage-body">
                                        <div class="stage-body-inner">
                                            ...
                                            <div class="table-responsive mt-2 {{ $newCandidate->iaa_reason ? '' : 'd-none' }}" id="incidentAfterArrivalTableWrapper">
                                                <table class="table stage-table" id="incidentAfterArrivalTable">
                                                    ...
                                                    <tr>
                                                        <td class="iaa-reason-cell">
                                                            {{ $newCandidate->iaa_reason ?? 'N/A' }}
                                                        </td>
                                                        <td class="iaa-proof-cell">
                                                            @if($newCandidate->iaa_proof)
                                                                {{ basename($newCandidate->iaa_proof) }}
                                                            @else
                                                                N/A
                                                            @endif
                                                        </td>
                                                        <td class="iaa-remarks-cell">
                                                            {{ $newCandidate->iaa_remarks ?? 'N/A' }}
                                                        </td>
                                                        <td class="text-end table-actions">
                                                            <button type="button"
                                                                    class="btn btn-outline-info btn-xs"
                            ...
                            <div class="stage-row" data-stage="transfer">
                                <div class="stage-header" data-bs-toggle="collapse" data-bs-target="#stageBody-transfer">
                                    ...
                                    <span class="stage-status badge badge-{{ !empty($newCandidate->transfer_date) ? 'success' : 'secondary' }} ms-auto" id="transferStatusBadge">
                                        {{ !empty($newCandidate->transfer_date) ? 'COMPLETED' : 'PENDING' }}
                                    </span>
                                    <i class="fas fa-chevron-down stage-chevron"></i>
                                </div>
                                <div id="stageBody-transfer" class="collapse">
                                    <div class="stage-body">
                                        <div class="stage-body-inner">
                                            ...
                                            <div class="table-responsive mt-2 {{ $newCandidate->transfer_date ? '' : 'd-none' }}" id="transferTableWrapper">
                                                <table class="table stage-table" id="transferTable">
                                                    ...
                                                    <tr>
                                                        <td class="transfer-date-cell">
                                                            {{ $newCandidate->transfer_date ? fmtDate($newCandidate->transfer_date) : 'N/A' }}
                                                        </td>
                                                        <td class="transfer-remarks-cell">
                                                            {{ $newCandidate->transfer_remarks ?? 'N/A' }}
                                                        </td>
                                                        <td class="text-end table-actions">
                                                            <button type="button"
                                                                    class="btn btn-outline-info btn-xs"
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
                <form id="wcForm" class="needs-validation" novalidate
                      method="POST"
                      action="{{ route('boa.wc.save', $employee->reference_no) }}"
                      enctype="multipart/form-data">
                    @csrf
                    <input type="hidden" name="candidate_id" value="{{ $newCandidate->id }}">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="date" class="form-control" id="wcDate" name="wc_date" value="{{ $newCandidate->wc_date }}" required>
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="text" class="form-control" id="dwNumber" name="wc_dw_number" value="{{ $newCandidate->wc_dw_number }}" placeholder="Enter DW number" required>
                            ...
                            <div class="col-12 mb-3">
                                ...
                                <textarea class="form-control" id="wcRemarks" name="wc_remarks" rows="2" placeholder="Add any notes">{{ $newCandidate->wc_remarks }}</textarea>
                            </div>
                        </div>
                    </div>
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
                <form id="incidentBeforeVisaForm" class="needs-validation" novalidate
                      method="POST"
                      action="{{ route('boa.ibv.save', $employee->reference_no) }}"
                      enctype="multipart/form-data">
                    @csrf
                    <input type="hidden" name="candidate_id" value="{{ $newCandidate->id }}">
                    <div class="modal-header">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="date" class="form-control" id="incidentBeforeVisaDate" name="ibv_date" value="{{ $newCandidate->ibv_date }}" required>
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <select class="form-control" id="incidentBeforeVisaReason" name="ibv_reason" required>
                                    ...
                                    <option value="Behaviour" {{ $newCandidate->ibv_reason === 'Behaviour' ? 'selected' : '' }}>Behaviour</option>
                                    <option value="Medical" {{ $newCandidate->ibv_reason === 'Medical' ? 'selected' : '' }}>Medical</option>
                                    <option value="Documentation" {{ $newCandidate->ibv_reason === 'Documentation' ? 'selected' : '' }}>Documentation</option>
                                    <option value="Other" {{ $newCandidate->ibv_reason === 'Other' ? 'selected' : '' }}>Other</option>
                                </select>
                            ...
                            <div class="col-12 mb-3">
                                <label class="small-label">REMARKS</label>
                                <textarea class="form-control" id="incidentBeforeVisaRemarks" name="ibv_remarks" rows="2" placeholder="Add remarks">{{ $newCandidate->ibv_remarks }}</textarea>
                            </div>
                        </div>
                    </div>
                    <div class="modal-footer">
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
                <form id="visaForm" class="needs-validation" novalidate
                      method="POST"
                      action="{{ route('boa.visa.save', $employee->reference_no) }}"
                      enctype="multipart/form-data">
                    @csrf
                    <input type="hidden" name="candidate_id" value="{{ $newCandidate->id }}">
                    <div class="modal-header">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="date" class="form-control" id="visaDate" name="visa_date" value="{{ $newCandidate->visa_date }}" required>
                                <div class="invalid-feedback">VISA DATE IS REQUIRED.</div>
                            </div>
                            <div class="col-md-4 mb-3">
                                <label class="small-label">VISA NUMBER (OPTIONAL)</label>
                                <input type="text" class="form-control" id="visaNumber" name="visa_number" value="{{ $newCandidate->visa_number }}" placeholder="Enter visa number">
                            </div>
                            <div class="col-md-4 mb-3">
                                <label class="small-label">VISA EXPIRY DATE <span class="required-asterisk">*</span></label>
                                <input type="date" class="form-control" id="visaExpiry" name="visa_expiry_date" value="{{ $newCandidate->visa_expiry_date }}" required>
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="text" class="form-control" id="uidNo" name="visa_uid_no" value="{{ $newCandidate->visa_uid_no }}" placeholder="Enter UID number" required>
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="text" class="form-control" id="entryPermitNo" name="visa_entry_permit_no" value="{{ $newCandidate->visa_entry_permit_no }}" placeholder="Enter entry permit number" required>
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="file" class="form-control" id="visaCopy" name="visa_copy_file" accept=".pdf,.jpg,.jpeg,.png" {{ $newCandidate->visa_copy_file ? '' : 'required' }}>
                            ...
                            <div class="col-12 mb-2">
                                ...
                                <textarea class="form-control" id="visaRemarks" name="visa_remarks" rows="2" placeholder="Add remarks">{{ $newCandidate->visa_remarks }}</textarea>
                            </div>
                            <div class="col-12">
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
                <form id="arrivalForm" class="needs-validation" novalidate
                      method="POST"
                      action="{{ route('boa.arrival.save', $employee->reference_no) }}"
                      enctype="multipart/form-data">
                    @csrf
                    <input type="hidden" name="candidate_id" value="{{ $newCandidate->id }}">
                    <div class="modal-header">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="date" class="form-control" id="arrivalDate" name="arrival_date" value="{{ $newCandidate->arrival_date }}" required>
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="file" class="form-control" id="arrivalPassportStamp" name="arrival_passport_stamp_file" accept=".pdf,.jpg,.jpeg,.png" {{ $newCandidate->arrival_passport_stamp_file ? '' : 'required' }}>
                            ...
                            <div class="col-12 mb-3">
                                <label class="small-label">REMARKS</label>
                                <textarea class="form-control" id="arrivalRemarks" name="arrival_remarks" rows="2" placeholder="Add remarks">{{ $newCandidate->arrival_remarks }}</textarea>
                            </div>
                        </div>
                    </div>
                    <div class="modal-footer">
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
                <form id="incidentAfterArrivalForm" class="needs-validation" novalidate
                      method="POST"
                      action="{{ route('boa.iaa.save', $employee->reference_no) }}"
                      enctype="multipart/form-data">
                    @csrf
                    <input type="hidden" name="candidate_id" value="{{ $newCandidate->id }}">
                    <div class="modal-header">
                        ...
                        <div class="row">
                            <div class="col-md-4 mb-3">
                                ...
                                <select class="form-control" id="incidentAfterArrivalReason" name="iaa_reason" required>
                                    <option value="">Select reason</option>
                                    <option value="Absconding" {{ $newCandidate->iaa_reason === 'Absconding' ? 'selected' : '' }}>Absconding</option>
                                    <option value="Misconduct" {{ $newCandidate->iaa_reason === 'Misconduct' ? 'selected' : '' }}>Misconduct</option>
                                    <option value="Medical" {{ $newCandidate->iaa_reason === 'Medical' ? 'selected' : '' }}>Medical</option>
                                    <option value="Other" {{ $newCandidate->iaa_reason === 'Other' ? 'selected' : '' }}>Other</option>
                                </select>
                                <div class="invalid-feedback">REASON IS REQUIRED.</div>
                            </div>
                            <div class="col-md-4 mb-3">
                                <label class="small-label">PROOF <span class="required-asterisk">*</span></label>
                                <input type="file" class="form-control" id="incidentAfterArrivalProof" name="iaa_proof" accept=".pdf,.jpg,.jpeg,.png" {{ $newCandidate->iaa_proof ? '' : 'required' }}>
                                <small class="text-muted d-block mt-1" style="font-size:0.65rem;">
                            ...
                            <div class="col-12 mb-3">
                                <label class="small-label">REMARKS</label>
                                <textarea class="form-control" id="incidentAfterArrivalRemarks" name="iaa_remarks" rows="2" placeholder="Add remarks">{{ $newCandidate->iaa_remarks }}</textarea>
                            </div>
                        </div>
                    </div>
                    <div class="modal-footer">
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
                <form id="transferForm" class="needs-validation" novalidate
                      method="POST"
                      action="{{ route('boa.transfer.save', $employee->reference_no) }}">
                    @csrf
                    <input type="hidden" name="candidate_id" value="{{ $newCandidate->id }}">
                    <div class="modal-header">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="date" class="form-control" id="transferDate" name="transfer_date" value="{{ $newCandidate->transfer_date }}" required>
                                <div class="invalid-feedback">TRANSFER DATE IS REQUIRED.</div>
                            </div>
                            <div class="col-12 mb-3">
                                <label class="small-label">REMARKS</label>
                                <textarea class="form-control" id="transferRemarks" name="transfer_remarks" rows="2" placeholder="Add remarks">{{ $newCandidate->transfer_remarks }}</textarea>
                            </div>
                        </div>
                    </div>
                    <div class="modal-footer">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <dl class="row mb-0">
                        ...
                        <dd class="col-sm-8 view-dd" id="viewWcDate">{{ fmtDate($newCandidate->wc_date ?? null) }}</dd>

                        <dt class="col-sm-4 view-dt">DW NUMBER</dt>
                        <dd class="col-sm-8 view-dd" id="viewWcDwNumber">{{ $newCandidate->wc_dw_number ?? 'N/A' }}</dd>

                        <dt class="col-sm-4 view-dt">CONTRACT FILE</dt>
                        <dd class="col-sm-8 view-dd" id="viewWcContractFile">
                            @if(!empty($newCandidate->wc_contract_file))
                                <a href="{{ asset('storage/'.$newCandidate->wc_contract_file) }}" target="_blank" id="viewWcContractFileLink">
                                    View Contract
                                </a>
                            @else
                        ...
                        <dd class="col-sm-8 view-dd" id="viewWcRemarks">{{ $newCandidate->wc_remarks ?? 'N/A' }}</dd>
                    </dl>
                </div>
                <div class="modal-footer">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <dl class="row mb-0">
                        ...
                        <dd class="col-sm-8 view-dd" id="viewIbvDate">{{ fmtDate($newCandidate->ibv_date ?? null) }}</dd>

                        <dt class="col-sm-4 view-dt">REASON</dt>
                        <dd class="col-sm-8 view-dd" id="viewIbvReason">{{ $newCandidate->ibv_reason ?? 'N/A' }}</dd>

                        <dt class="col-sm-4 view-dt">PROOF</dt>
                        <dd class="col-sm-8 view-dd" id="viewIbvProof">
                            @if(!empty($newCandidate->ibv_proof))
                                <a href="{{ asset('storage/'.$newCandidate->ibv_proof) }}" target="_blank" id="viewIbvProofLink">
                                    View Proof
                                </a>
                            @else
                        ...
                        <dt class="col-sm-4 view-dt">REMARKS</dt>
                        <dd class="col-sm-8 view-dd" id="viewIbvRemarks">{{ $newCandidate->ibv_remarks ?? 'N/A' }}</dd>
                    </dl>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-sm btn-primary" data-bs-dismiss="modal">CLOSE</button>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <dl class="row mb-0">
                        ...
                        <dd class="col-sm-8 view-dd" id="viewVisaDate">{{ fmtDate($newCandidate->visa_date ?? null) }}</dd>

                        <dt class="col-sm-4 view-dt">VISA NUMBER</dt>
                        <dd class="col-sm-8 view-dd" id="viewVisaNumber">{{ $newCandidate->visa_number ?? 'N/A' }}</dd>

                        <dt class="col-sm-4 view-dt">VISA EXPIRY</dt>
                        <dd class="col-sm-8 view-dd" id="viewVisaExpiry">{{ fmtDate($newCandidate->visa_expiry_date ?? null) }}</dd>

                        <dt class="col-sm-4 view-dt">UID NO</dt>
                        <dd class="col-sm-8 view-dd" id="viewVisaUid">{{ $newCandidate->visa_uid_no ?? 'N/A' }}</dd>

                        <dt class="col-sm-4 view-dt">ENTRY PERMIT NO</dt>
                        <dd class="col-sm-8 view-dd" id="viewVisaEntryPermit">{{ $newCandidate->visa_entry_permit_no ?? 'N/A' }}</dd>

                        <dt class="col-sm-4 view-dt">VISA COPY</dt>
                        <dd class="col-sm-8 view-dd" id="viewVisaCopy">
                            @if(!empty($newCandidate->visa_copy_file))
                                <a href="{{ asset('storage/'.$newCandidate->visa_copy_file) }}" target="_blank" id="viewVisaCopyLink">
                                    View Visa
                                </a>
                            @else
                        ...
                        <dt class="col-sm-4 view-dt">REMARKS</dt>
                        <dd class="col-sm-8 view-dd" id="viewVisaRemarks">{{ $newCandidate->visa_remarks ?? 'N/A' }}</dd>
                    </dl>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-sm btn-primary" data-bs-dismiss="modal">CLOSE</button>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <dl class="row mb-0">
                        ...
                        <dd class="col-sm-8 view-dd" id="viewArrivalDate">{{ fmtDate($newCandidate->arrival_date ?? null) }}</dd>

                        <dt class="col-sm-4 view-dt">PASSPORT STAMP</dt>
                        <dd class="col-sm-8 view-dd" id="viewArrivalPassport">
                            @if(!empty($newCandidate->arrival_passport_stamp_file))
                                <a href="{{ asset('storage/'.$newCandidate->arrival_passport_stamp_file) }}" target="_blank" id="viewArrivalPassportLink">
                                    View Passport
                                </a>
                            @else
                        ...
                        <dt class="col-sm-4 view-dt">REMARKS</dt>
                        <dd class="col-sm-8 view-dd" id="viewArrivalRemarks">{{ $newCandidate->arrival_remarks ?? 'N/A' }}</dd>
                    </dl>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-sm btn-primary" data-bs-dismiss="modal">CLOSE</button>
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <dl class="row mb-0">
                        <dt class="col-sm-4 view-dt">REASON</dt>
                        <dd class="col-sm-8 view-dd" id="viewIaaReason">{{ $newCandidate->iaa_reason ?? 'N/A' }}</dd>

                        <dt class="col-sm-4 view-dt">PROOF</dt>
                        <dd class="col-sm-8 view-dd" id="viewIaaProof">
                            @if(!empty($newCandidate->iaa_proof))
                                <a href="{{ asset('storage/'.$newCandidate->iaa_proof) }}" target="_blank" id="viewIaaProofLink">
                                    View Proof
                                </a>
                            @else
                        ...
                        <dt class="col-sm-4 view-dt">REMARKS</dt>
                        <dd class="col-sm-8 view-dd" id="viewIaaRemarks">{{ $newCandidate->iaa_remarks ?? 'N/A' }}</dd>
                    </dl>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-sm btn-primary" data-bs-dismiss="modal">CLOSE</button>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <dl class="row mb-0">
                        ...
                        <dd class="col-sm-8 view-dd" id="viewTransferDate">{{ fmtDate($newCandidate->transfer_date ?? null) }}</dd>

                        <dt class="col-sm-4 view-dt">REMARKS</dt>
                        <dd class="col-sm-8 view-dd" id="viewTransferRemarks">{{ $newCandidate->transfer_remarks ?? 'N/A' }}</dd>
                    </dl>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-sm btn-primary" data-bs-dismiss="modal">CLOSE</button>
