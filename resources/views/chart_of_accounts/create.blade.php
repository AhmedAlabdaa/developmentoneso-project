            ...
            <div class="col-lg-12">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{ route('chart-of-accounts.store') }}" method="POST" class="row g-3" id="coaForm">
                            @csrf
                                    ...
                                    <select name="parent_account_code" class="form-select" id="parent_account_code">
                                        ...
                                        @foreach($parentAccounts as $p)
                                            <option value="{{ $p->account_code }}"
                                                {{ old('parent_account_code') == $p->account_code ? 'selected' : '' }}>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <select name="account_type" class="form-select" id="account_type" required>
                                        <option disabled {{ old('account_type') ? '' : 'selected' }} value="">Choose...</option>
                                        @foreach(['ASSET','LIABILITY','EQUITY','INCOME','EXPENSE'] as $t)
                                            <option value="{{ $t }}" {{ old('account_type') == $t ? 'selected' : '' }}>
                                                {{ $t }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="hidden" name="normal_balance" id="normal_balance" value="{{ old('normal_balance') }}">
                            </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="form-check form-switch mt-2">
                                    <input class="form-check-input" type="checkbox" role="switch" id="is_posting"
                                           name="is_posting" value="1" {{ old('is_posting', 1) ? 'checked' : '' }}>
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="form-check form-switch mt-2">
                                    <input class="form-check-input" type="checkbox" role="switch" id="is_control"
                                           name="is_control" value="1" {{ old('is_control', 0) ? 'checked' : '' }}>
