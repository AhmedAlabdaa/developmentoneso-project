    ...
    <div class="card flex-fill">
      <div class="card-body">
        ...
        <div id="statistics_container" class="mb-2">
          @include('candidates.partials.inside_counts')
        </div>
...
(function(){
  ...
  window.updateTable = function(params){
    ...
    showPreloader();
    $.get('{{ route("candidates.inside") }}', Object.assign({ status: window.currentStatus }, f, params))
      .done(function(res){
  ...
  $(function(){
    ...
    $('#export_excel').on('click', function(){
      ...
      window.location = '{{ route("candidates.inside") }}?' + q;
    });
