        ...
        <tbody>
            ...
            @foreach ($candidates as $candidate)
                <tr class="{{ $candidate->appeal == 1 ? 'table-warning appeal-row' : '' }}">
                    ...
                    <td>
                        @if ($candidate->agreement)
                            <a style="color: #007bff !important;" href="{{ route('candidates.show', $candidate->reference_no) }}" target="_blank" class="text-decoration-none text-dark">
                                {{ strtoupper($candidate->agreement->CN_Number) }}
                            </a>
                        @else
                            N/A
                        @endif
                    ...
                    <td>
                        @if ($candidate->agreement)
                            <a style="color: #007bff !important;" href="{{ route('crm.show', $candidate->agreement->client->slug ?? '') }}" target="_blank" class="text-decoration-none text-dark">
                                {{ strtoupper($candidate->agreement->CL_Number) }}
                            </a>
                        @else
                            N/A
                        @endif
                    </td>
                    <td><a href="{{ route('agreements.show', $candidate->agreement->reference_no ?? '') }}">{{ strtoupper($candidate->agreement->reference_no ?? 'N/A') }}</a></td>
                    <td>
                        <a style="color: #007bff !important;" href="{{ route('candidates.show', $candidate->reference_no) }}" target="_blank" class="text-decoration-none text-dark">
