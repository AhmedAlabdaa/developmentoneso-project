            ...
            <div class="col-lg-12">
                <div class="cansidebar-content card custom-card">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-8">
                                <div class="card-text">
                                    ...
                                    <div class="card-info">{{ $candidate->passport_no }}</div>
                                </div>
                            </div>
                            <div class="col-lg-2">
                                <div class="card-button-wrapper">
                                    <button class="card-button" style="text-transform: uppercase;">
                                        <span class="card-icon">&#x2714;</span> {{ $candidate->currentStatus->status_name }}
                                    </button>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="modal-navigation-tabs">
                        ...
                        <button class="modal-navigation-item" data-tab="modal-documents" onclick="loadDocuments({{ $candidate->id }})">
                            <span>&#x1F4C3;</span> Documents
                        </button>
                        <button class="modal-navigation-item" data-tab="modal-experiences" onclick="loadExperiences({{ $candidate->id }})">
                            <span>&#x1F4BC;</span> Experiences
                        </button>
                        <button class="modal-navigation-item" data-tab="modal-work-skills" onclick="loadWorkSkills({{ $candidate->id }})">
                            <span>&#x2699;</span> Work Skills
                        </button>
                        <button class="modal-navigation-item" data-tab="modal-desired-countries" onclick="loadDesiredCountries({{ $candidate->id }})">
                            <span>&#x1F30F;</span> Desired Countries
                        </button>
                        <button class="modal-navigation-item" data-tab="modal-work-contract" onclick="loadWorkContract({{ $candidate->id }})">
                            <span>&#x1F4DC;</span> Work Contract
                        </button>
                        <button class="modal-navigation-item" data-tab="modal-agreements" onclick="loadAgreements({{ $candidate->id }})">
                            <span>&#x1F4D1;</span> Agreements
                        </button>
                        <button class="modal-navigation-item" data-tab="modal-contracts" onclick="loadContracts({{ $candidate->id }})">
                            <span>&#x1F4DD;</span> Contracts
                        </button>
                        <button class="modal-navigation-item" data-tab="modal-incidents" onclick="loadIncidents({{ $candidate->id }})">
                            <span>&#x1F6A8;</span> Incidents
                        </button>
                        ...
                        <div class="modal-tab-content active" id="modal-information">
                            <div class="profile-details">
                                ...
                                <div class="detail-row">
                                    ...
                                    <span class="detail-value">{{ $candidate->CN_Number ?? 'N/A' }}</span>
                                </div>
                                <div class="detail-row">
                                    <span class="detail-label"><i class="fas fa-hashtag"></i> Reference No:</span>
                                    <span class="detail-value">{{ $candidate->reference_no ?? 'N/A' }}</span>
                                </div>
                                <div class="detail-row">
                                    <span class="detail-label"><i class="fas fa-hashtag"></i> Ref No:</span>
                                    <span class="detail-value">{{ $candidate->ref_no ?? 'N/A' }}</span>
                                </div>
                                <div class="detail-row">
                                    <span class="detail-label"><i class="fas fa-hashtag"></i> Candidate Name:</span>
                                    <span class="detail-value">{{ $candidate->candidate_name ?? 'N/A' }}</span>
                                </div>
                                <div class="detail-row">
                                    <span class="detail-label"><i class="fas fa-hashtag"></i> Passport No:</span>
                                    <span class="detail-value">{{ $candidate->passport_no ?? 'N/A' }}</span>
                                </div>
                                <div class="detail-row">
                                    <span class="detail-label"><i class="fas fa-hashtag"></i> Passport Issue Date:</span>
                                    <span class="detail-value">{{ $candidate->passport_issue_date ? \Carbon\Carbon::parse($candidate->passport_issue_date)->format('d F Y') : 'N/A' }}</span>
                                </div>
                                <div class="detail-row">
                                    <span class="detail-label"><i class="fas fa-hashtag"></i> Passport Issue Place:</span>
                                    <span class="detail-value">{{ $candidate->passport_issue_place ?? 'N/A' }}</span>
                                </div>
                                <div class="detail-row">
                                    <span class="detail-label"><i class="fas fa-hashtag"></i> Nationality:</span>
                                    <span class="detail-value">{{ $candidate->Nationality->name ?? 'N/A' }}</span>
                                </div>
                                <div class="detail-row">
                                    <span class="detail-label"><i class="fas fa-hashtag"></i> Passport Expiry Date:</span>
                                    <span class="detail-value">{{ $candidate->passport_expiry_date ? \Carbon\Carbon::parse($candidate->passport_expiry_date)->format('d F Y') : 'N/A' }}</span>
                                </div>
                                <div class="detail-row">
                                    <span class="detail-label"><i class="fas fa-hashtag"></i> Date of Birth:</span>
                                    <span class="detail-value">{{ $candidate->date_of_birth ? \Carbon\Carbon::parse($candidate->date_of_birth)->format('d F Y') : 'N/A' }}</span>
                                </div>
                                <div class="detail-row">
                                    <span class="detail-label"><i class="fas fa-hashtag"></i> Foreign Partner:</span>
                                    <span class="detail-value">{{ $candidate->foreign_partner ?? 'N/A' }}</span>
                                </div>
                                <div class="detail-row">
                                    <span class="detail-label"><i class="fas fa-hashtag"></i> Age:</span>
                                    <span class="detail-value">{{ $candidate->age ?? 'N/A' }}</span>
                                </div>
                                <div class="detail-row">
                                    <span class="detail-label"><i class="fas fa-hashtag"></i> Gender:</span>
                                    <span class="detail-value">{{ $candidate->gender ?? 'N/A' }}</span>
                                </div>
                                <div class="detail-row">
                                    <span class="detail-label"><i class="fas fa-hashtag"></i> Salary:</span>
                                    <span class="detail-value">{{ $candidate->salary ?? 'N/A' }}</span>
                                </div>
                                <div class="detail-row">
                                    <span class="detail-label"><i class="fas fa-hashtag"></i> Sponsorship:</span>
                                    <span class="detail-value">{{ $candidate->sponsorship ?? 'N/A' }}</span>
                                </div>
                                <div class="detail-row">
                                    <span class="detail-label"><i class="fas fa-hashtag"></i> Work Skill General Description:</span>
                                    <span class="detail-value">{{ $candidate->work_skill_general_description ?? 'N/A' }}</span>
                                </div>
                                <div class="detail-row">
                                    <span class="detail-label"><i class="fas fa-hashtag"></i> Contract Duration:</span>
                                    <span class="detail-value">{{ $candidate->contract_duration ?? 'N/A' }}</span>
                                </div>
                                <div class="detail-row">
                                    <span class="detail-label"><i class="fas fa-hashtag"></i> Religion:</span>
                                    <span class="detail-value">{{ $candidate->religion ?? 'N/A' }}</span>
                                </div>
                                <div class="detail-row">
                                    <span class="detail-label"><i class="fas fa-hashtag"></i> English Skills:</span>
                                    <span class="detail-value">{{ $candidate->english_skills ?? 'N/A' }}</span>
                                </div>
                                <div class="detail-row">
                                    <span class="detail-label"><i class="fas fa-hashtag"></i> Arabic Skills:</span>
                                    <span class="detail-value">{{ $candidate->arabic_skills ?? 'N/A' }}</span>
                                </div>
                                <div class="detail-row">
                                    <span class="detail-label"><i class="fas fa-hashtag"></i> Applied Position:</span>
                                    <span class="detail-value">{{ $candidate->appliedPosition->position_name ?? 'N/A' }}</span>
                                </div>
                                <div class="detail-row">
                                    <span class="detail-label"><i class="fas fa-hashtag"></i> Work Skill:</span>
                                    <span class="detail-value">{{ $candidate->work_skill ?? 'N/A' }}</span>
                                </div>
                                <div class="detail-row">
                                    <span class="detail-label"><i class="fas fa-hashtag"></i> Skill Description:</span>
                                    <span class="detail-value">{{ $candidate->skill_description ?? 'N/A' }}</span>
                                </div>
                                <div class="detail-row">
                                    <span class="detail-label"><i class="fas fa-hashtag"></i> Education Level:</span>
                                    <span class="detail-value">{{ $candidate->educationLevel->level_name ?? 'N/A' }}</span>
                                </div>
                                <div class="detail-row">
                                ...
                                <div class="detail-row">
                                    ...
                                    <span class="detail-value">{{ $candidate->number_of_children ?? 'N/A' }}</span>
                                </div>
                                <div class="detail-row">
                                    <span class="detail-label"><i class="fas fa-hashtag"></i> Height:</span>
                                    <span class="detail-value">{{ $candidate->height ?? 'N/A' }}</span>
                                </div>
                                <div class="detail-row">
                                    <span class="detail-label"><i class="fas fa-hashtag"></i> Weight:</span>
                                    <span class="detail-value">{{ $candidate->weight ?? 'N/A' }}</span>
                                </div>
                                <div class="detail-row">
                                    <span class="detail-label"><i class="fas fa-hashtag"></i> Preferred Package:</span>
                                    <span class="detail-value">{{ $candidate->preferred_package ?? 'N/A' }}</span>
                                </div>
                                <div class="detail-row">
                                ...
                                <div class="detail-row">
                                    ...
                                    <span class="detail-value"><button type="button" class="btn btn-primary">{{ $candidate->coc_status ?? 'N/A' }}</button></span>
                                </div>
                                <div class="detail-row">
                                    <span class="detail-label"><i class="fas fa-hashtag"></i> Place of Birth:</span>
                                    <span class="detail-value">{{ $candidate->place_of_birth ?? 'N/A' }}</span>
                                </div>
                                <div class="detail-row">
                                    <span class="detail-label"><i class="fas fa-hashtag"></i> Candidate Current Address:</span>
                                    <span class="detail-value">{{ $candidate->candidate_current_address ?? 'N/A' }}</span>
                                </div>
                                <div class="detail-row">
                                    <span class="detail-label"><i class="fas fa-hashtag"></i> Labour ID Date:</span>
                                    <span class="detail-value">{{ $candidate->labour_id_date ? \Carbon\Carbon::parse($candidate->labour_id_date)->format('d F Y') : 'N/A' }}</span>
                                </div>
                                <div class="detail-row">
                                    <span class="detail-label"><i class="fas fa-hashtag"></i> Labour ID Number:</span>
                                    <span class="detail-value">{{ $candidate->labour_id_number ?? 'N/A' }}</span>
                                </div>
                                <div class="detail-row">
                                    <span class="detail-label"><i class="fas fa-hashtag"></i> Family Name:</span>
                                    <span class="detail-value">{{ $candidate->family_name ?? 'N/A' }}</span>
                                </div>
                                <div class="detail-row">
                                    <span class="detail-label"><i class="fas fa-hashtag"></i> Family Contact Number 1:</span>
                                    <span class="detail-value">{{ $candidate->family_contact_number_1 ?? 'N/A' }}</span>
                                </div>
                                <div class="detail-row">
                                    <span class="detail-label"><i class="fas fa-hashtag"></i> Family Contact Number 2:</span>
                                    <span class="detail-value">{{ $candidate->family_contact_number_2 ?? 'N/A' }}</span>
                                </div>
                                <div class="detail-row">
                                    <span class="detail-label"><i class="fas fa-hashtag"></i> Relationship with Candidate:</span>
                                    <span class="detail-value">{{ $candidate->relationship_with_candidate ?? 'N/A' }}</span>
                                </div>
                                <div class="detail-row">
                                    <span class="detail-label"><i class="fas fa-hashtag"></i> Family Current Address:</span>
                                    <span class="detail-value">{{ $candidate->family_current_address ?? 'N/A' }}</span>
                                </div>
                                <div class="detail-row">
                                    <span class="detail-label"><i class="fas fa-hashtag"></i> Current Status:</span>
                                    <span class="detail-value">{{ $candidate->current_status ?? 'N/A' }}</span>
                                </div>
                                <div class="detail-row">
                                    <span class="detail-label"><i class="fas fa-hashtag"></i> Visa Status:</span>
                                    <span class="detail-value">{{ $candidate->visa_status ?? 'N/A' }}</span>
                                </div>
                                <div class="detail-row">
                                    <span class="detail-label"><i class="fas fa-hashtag"></i> Hold Date:</span>
                                    <span class="detail-value">{{ $candidate->hold_date ? \Carbon\Carbon::parse($candidate->hold_date)->format('d F Y') : 'N/A' }}</span>
                                </div>
                                <div class="detail-row">
                                    <span class="detail-label"><i class="fas fa-hashtag"></i> Selected Date:</span>
                                    <span class="detail-value">{{ $candidate->selected_date ? \Carbon\Carbon::parse($candidate->selected_date)->format('d F Y') : 'N/A' }}</span>
                                </div>
                                <div class="detail-row">
                                    <span class="detail-label"><i class="fas fa-hashtag"></i> WC Date:</span>
                                    <span class="detail-value">{{ $candidate->wc_date ? \Carbon\Carbon::parse($candidate->wc_date)->format('d F Y') : 'N/A' }}</span>
                                </div>
                                <div class="detail-row">
                                    <span class="detail-label"><i class="fas fa-hashtag"></i> WC Added Date:</span>
                                    <span class="detail-value">{{ $candidate->wc_added_date ? \Carbon\Carbon::parse($candidate->wc_added_date)->format('d F Y') : 'N/A' }}</span>
                                </div>
                                <div class="detail-row">
                                    <span class="detail-label"><i class="fas fa-hashtag"></i> Visa Date:</span>
                                    <span class="detail-value">{{ $candidate->visa_date ? \Carbon\Carbon::parse($candidate->visa_date)->format('d F Y') : 'N/A' }}</span>
                                </div>
                                <div class="detail-row">
                                    <span class="detail-label"><i class="fas fa-hashtag"></i> Visa Added Date:</span>
                                    <span class="detail-value">{{ $candidate->visa_added_date ? \Carbon\Carbon::parse($candidate->visa_added_date)->format('d F Y') : 'N/A' }}</span>
                                </div>
                                <div class="detail-row">
                                    <span class="detail-label"><i class="fas fa-hashtag"></i> UID Number:</span>
                                    <span class="detail-value">{{ $candidate->uid_number ?? 'N/A' }}</span>
                                </div>
                                <div class="detail-row">
                                    <span class="detail-label"><i class="fas fa-hashtag"></i> Entry Permit Number:</span>
                                    <span class="detail-value">{{ $candidate->entry_permit_number ?? 'N/A' }}</span>
                                </div>
                                <div class="detail-row">
                                    <span class="detail-label"><i class="fas fa-hashtag"></i> Visa Number:</span>
                                    <span class="detail-value">{{ $candidate->visa_number ?? 'N/A' }}</span>
                                </div>
                                <div class="detail-row">
                                ...
                                <div class="detail-row">
                                    ...
                                    <span class="detail-value">{{ $candidate->arrived_date ? \Carbon\Carbon::parse($candidate->arrived_date)->format('d F Y') : 'N/A' }}</span>
                                </div>
                                <div class="detail-row">
                                    <span class="detail-label"><i class="fas fa-hashtag"></i> Arrived Added Date:</span>
                                    <span class="detail-value">{{ $candidate->arrived_added_date ? \Carbon\Carbon::parse($candidate->arrived_added_date)->format('d F Y') : 'N/A' }}</span>
                                </div>
                                <div class="detail-row">
                                    <span class="detail-label"><i class="fas fa-hashtag"></i> Transfer Date:</span>
                                    <span class="detail-value">{{ $candidate->transfer_date ? \Carbon\Carbon::parse($candidate->transfer_date)->format('d F Y') : 'N/A' }}</span>
                                </div>
                                <div class="detail-row">
                                    <span class="detail-label"><i class="fas fa-hashtag"></i> Transfer Added Date:</span>
                                    <span class="detail-value">{{ $candidate->transfer_added_date ? \Carbon\Carbon::parse($candidate->transfer_added_date)->format('d F Y') : 'N/A' }}</span>
                                </div>
                                <div class="detail-row">
                                    <span class="detail-label"><i class="fas fa-hashtag"></i> Office Date:</span>
                                    <span class="detail-value">{{ $candidate->office_date ? \Carbon\Carbon::parse($candidate->office_date)->format('d F Y') : 'N/A' }}</span>
                                </div>
                                <div class="detail-row">
                                    <span class="detail-label"><i class="fas fa-hashtag"></i> Trial Date:</span>
                                    <span class="detail-value">{{ $candidate->trial_date ? \Carbon\Carbon::parse($candidate->trial_date)->format('d F Y') : 'N/A' }}</span>
                                </div>
                                <div class="detail-row">
                                    <span class="detail-label"><i class="fas fa-hashtag"></i> Confirmed Date:</span>
                                    <span class="detail-value">{{ $candidate->confirmed_date ? \Carbon\Carbon::parse($candidate->confirmed_date)->format('d F Y') : 'N/A' }}</span>
                                </div>
                                <div class="detail-row">
                                    <span class="detail-label"><i class="fas fa-hashtag"></i> Change Status Date:</span>
                                    <span class="detail-value">{{ $candidate->change_status_date ? \Carbon\Carbon::parse($candidate->change_status_date)->format('d F Y') : 'N/A' }}</span>
                                </div>
                                <div class="detail-row">
                                    <span class="detail-label"><i class="fas fa-hashtag"></i> Sales Name:</span>
                                    <span class="detail-value">{{ $candidate->sales_name ?? 'N/A' }}</span>
                                </div>
                                <div class="detail-row">
                                    <span class="detail-label"><i class="fas fa-hashtag"></i> Visa Type:</span>
                                    <span class="detail-value">{{ $candidate->visa_type ?? 'N/A' }}</span>
                                </div>
                                <div class="detail-row">
                                    <span class="detail-label"><i class="fas fa-hashtag"></i> Rejected Date:</span>
                                    <span class="detail-value">{{ $candidate->rejected_date ? \Carbon\Carbon::parse($candidate->rejected_date)->format('d F Y') : 'N/A' }}</span>
                                </div>
                                <div class="detail-row">
                                    <span class="detail-label"><i class="fas fa-hashtag"></i> Remarks:</span>
                                    <span class="detail-value">{{ $candidate->remarks ?? 'N/A' }}</span>
                                </div>
                                <div class="detail-row">
                                    <span class="detail-label"><i class="fas fa-hashtag"></i> Created At:</span>
                                    <span class="detail-value">{{ $candidate->created_at ? \Carbon\Carbon::parse($candidate->created_at)->format('d F Y') : 'N/A' }}</span>
                                </div>
                                <div class="detail-row">
                                    <span class="detail-label"><i class="fas fa-hashtag"></i> Updated At:</span>
                                    <span class="detail-value">{{ $candidate->updated_at ? \Carbon\Carbon::parse($candidate->updated_at)->format('d F Y') : 'N/A' }}</span>
                                </div>
                                <div class="detail-row">
                                    <span class="detail-label"><i class="fas fa-hashtag"></i> Updated By:</span>
                                    <span class="detail-value">{{ $candidate->updated_by ?? 'N/A' }}</span>
                                </div>
                                <div class="detail-row">
                                    <span class="detail-label"><i class="fas fa-hashtag"></i> Inside Status:</span>
                                    <span class="detail-value">{{ $candidate->inside_status ?? 'N/A' }}</span>
                                </div>
                                <div class="detail-row">
                                    <span class="detail-label"><i class="fas fa-hashtag"></i> Arrived in Office Date:</span>
                                    <span class="detail-value">{{ $candidate->arrived_in_office_date ? \Carbon\Carbon::parse($candidate->arrived_in_office_date)->format('d F Y') : 'N/A' }}</span>
                                </div>
                                <div class="detail-row">
                                    <span class="detail-label"><i class="fas fa-hashtag"></i> Medical Status:</span>
                                    <span class="detail-value"><a href="#"><a href="#" class="btn btn-primary">{{ $candidate->medical_status ? $candidate->medical_status : 'N/A' }}</a></a></span>
                                </div>
                                <div class="detail-row">
                                    <span class="detail-label"><i class="fas fa-hashtag"></i> Medical Date:</span>
                                    <span class="detail-value"><a href="#"><a href="#" class="btn btn-primary">{{ $candidate->medical_date ? \Carbon\Carbon::parse($candidate->medical_date)->format('d F Y') : 'N/A' }}</a></a></span>
                                </div>
                                <div class="detail-row">
                                    <span class="detail-label"><i class="fas fa-hospital"></i> Hospital Name:</span>
                                    <span class="detail-value">{{ $candidate->hospital_name ?? 'N/A' }}</span>
                                </div>
                                <div class="detail-row">
                                    <span class="detail-label"><i class="fas fa-hashtag"></i> COC Status Date:</span>
                                    <span class="detail-value"><a href="#"><a href="#" class="btn btn-primary">{{ $candidate->coc_status_date ? \Carbon\Carbon::parse($candidate->coc_status_date)->format('d F Y') : 'N/A' }}</a></a></span>
                                </div>
                                <div class="detail-row">
                                    <span class="detail-label"><i class="fas fa-hashtag"></i> L Submitted Date:</span>
                                    <span class="detail-value"><a href="#" class="btn btn-primary">{{ $candidate->l_submitted_date ? \Carbon\Carbon::parse($candidate->l_submitted_date)->format('d F Y') : 'N/A' }}</a></span>
                                </div>
                                <div class="detail-row">
                                    <span class="detail-label"><i class="fas fa-hashtag"></i> L Issued Date:</span>
                                    <span class="detail-value"><a href="#" class="btn btn-primary">{{ $candidate->l_issued_date ? \Carbon\Carbon::parse($candidate->l_issued_date)->format('d F Y') : 'N/A' }}</a></span>
                                </div>
                                <div class="detail-row">
                                    <span class="detail-label"><i class="fas fa-hashtag"></i> Departure Date:</span>
                                    <span class="detail-value">{{ $candidate->departure_date ? \Carbon\Carbon::parse($candidate->departure_date)->format('d F Y') : 'N/A' }}</span>
                                </div>
                                <div class="detail-row">
                                    <span class="detail-label"><i class="fas fa-hashtag"></i> Incident After Departure Date:</span>
                                    <span class="detail-value">{{ $candidate->incident_after_departure_date ? \Carbon\Carbon::parse($candidate->incident_after_departure_date)->format('d F Y') : 'N/A' }}</span>
                                </div>
                                <div class="detail-row">
                                    <span class="detail-label"><i class="fas fa-hashtag"></i> Incident After Arrival Date:</span>
                                    <span class="detail-value">{{ $candidate->incident_after_arrival_date ? \Carbon\Carbon::parse($candidate->incident_after_arrival_date)->format('d F Y') : 'N/A' }}</span>
                                </div>
                                <div class="detail-row">
                                    <span class="detail-label"><i class="fas fa-hashtag"></i> Appeal:</span>
                                    <span class="detail-value">{{ $candidate->appeal ?? 'N/A' }}</span>
                                </div>
                                <div class="detail-row">
                                    <span class="detail-label"><i class="fas fa-hashtag"></i> Appeal Date:</span>
                                    <span class="detail-value">{{ $candidate->appeal_date ? \Carbon\Carbon::parse($candidate->appeal_date)->format('d F Y') : 'N/A' }}</span>
                                </div>
                                <div class="detail-row">
                                    <span class="detail-label"><i class="fas fa-hashtag"></i> Medical Remarks:</span>
                                    <span class="detail-value">{{ $candidate->medical_remarks ?? 'N/A' }}</span>
                                </div>
                                <div class="detail-row">
                                    <span class="detail-label"><i class="fas fa-hashtag"></i> COC Remarks:</span>
                                    <span class="detail-value">{{ $candidate->coc_remarks ?? 'N/A' }}</span>
                                </div>
                                <div class="detail-row">
                                    <span class="detail-label"><i class="fas fa-hashtag"></i> L Submitted Date Remarks:</span>
                                    <span class="detail-value">{{ $candidate->l_submitted_date_remarks ?? 'N/A' }}</span>
                                </div>
                                <div class="detail-row">
                                    <span class="detail-label"><i class="fas fa-hashtag"></i> L Issued Date Remarks:</span>
                                    <span class="detail-value">{{ $candidate->l_issued_date_remarks ?? 'N/A' }}</span>
                                </div>
                                <div class="detail-row">
                                    <span class="detail-label"><i class="fas fa-hashtag"></i> Departure Date Remarks:</span>
                                    <span class="detail-value">{{ $candidate->departure_date_remarks ?? 'N/A' }}</span>
                                </div>
                                <div class="detail-row">
                                    <span class="detail-label"><i class="fas fa-hashtag"></i> L Submission Date:</span>
                                    <span class="detail-value">{{ $candidate->l_submission_date ? \Carbon\Carbon::parse($candidate->l_submission_date)->format('d F Y') : 'N/A' }}</span>
                                </div>
                                <div class="detail-row">
                                    <span class="detail-label"><i class="fas fa-hashtag"></i> Pulled Date:</span>
                                    <span class="detail-value">{{ $candidate->pulled_date ? \Carbon\Carbon::parse($candidate->pulled_date)->format('d F Y') : 'N/A' }}</span>
                                </div>
                                <div class="detail-row">
                                    <span class="detail-label"><i class="fas fa-hashtag"></i> Insurance Approved Date:</span>
                                    <span class="detail-value">{{ $candidate->insurance_approved_date ? \Carbon\Carbon::parse($candidate->insurance_approved_date)->format('d F Y') : 'N/A' }}</span>
                                </div>
                                <div class="detail-row">
                                ...
                                <div class="detail-row">
                                    ...
                                    <span class="detail-value">{{ $candidate->vp_number ?? 'N/A' }}</span>
                                </div>
                            </div>
                        </div>
...
<script>
    ...
    function loadDocuments(candidate_id) {
        ...
        $.ajax({
            url: '{{ route("candidates.loadimages1") }}',
            type: 'GET',
    ...
    function loadExperiences(candidate_id) {
        ...
        $('body').append(loadingSpinner);
        $.ajax({
            url: '{{ route("candidates.loadExperiences") }}',
            type: 'GET',
            data: { id: candidate_id },
            success: function(response) {
                if (response.success) {
