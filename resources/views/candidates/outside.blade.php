            ...
            <div class="row mt-2 align-items-center">
              ...
              <div class="col-lg-4 d-flex justify-content-end align-items-center mt-2">
                <div class="d-flex justify-content-end align-items-center gap-3 mb-2">
                  <a href="{{ route('candidates.inside') }}" title="Inside" class="btn btn-primary btn-sm d-flex align-items-center gap-2" style="font-size:12px"><i class="bi bi-door-open"></i>Inside</a>
                  <div class="dropdown">
                            ...
                            <div class="col-md-6 mb-2">
                              <select id="education" name="education" class="form-control">
                                ...
                                @foreach($educationLevels as $education)
                                  <option value="{{ $education->id }}"> {{ $education->level_name }}</option>
                                @endforeach
                              </select>
                            </div>
                            <div class="col-md-6 mb-2">
              ...
              <div class="col-lg-12">
                <ul class="nav nav-tabs" id="statusTabs" role="tablist">
                  <li class="nav-item" role="presentation">
                    <a class="nav-link active" id="tab-all" data-bs-toggle="tab" href="#tabpane-all" role="tab" aria-controls="tabpane-all" aria-selected="true"><i class="bi bi-list"></i>All <span class="badge bg-info"> {{ $c['all'] ?? 0 }}</span></a>
                  </li>
                  <li class="nav-item" role="presentation">
                    <a class="nav-link active" id="tab-draft" data-bs-toggle="tab" href="#tabpane-draft" role="tab" aria-controls="tabpane-draft" aria-selected="true">
                      ...
                      Draft
                      <span class="badge bg-info">{{ $c['Draft'] ?? ($c['draft'] ?? 0) }}</span>
                    </a>
                  </li>
                  <li class="nav-item" role="presentation">
                    <a class="nav-link" id="tab-available" data-bs-toggle="tab" href="#tabpane-available" role="tab" aria-controls="tabpane-available" aria-selected="false"><i class="bi bi-check-circle"></i>Available <span class="badge bg-info"> {{ $c['Available'] ?? 0 }}</span></a>
                  </li>
                  <li class="nav-item" role="presentation">
                    <a class="nav-link" id="tab-backout" data-bs-toggle="tab" href="#tabpane-backout" role="tab" aria-controls="tabpane-backout" aria-selected="false"><i class="bi bi-x-circle"></i>Back Out <span class="badge bg-info"> {{ $c['Back Out'] ?? 0 }}</span></a>
                  </li>
                  <li class="nav-item" role="presentation">
                    <a class="nav-link" id="tab-hold" data-bs-toggle="tab" href="#tabpane-hold" role="tab" aria-controls="tabpane-hold" aria-selected="false"><i class="bi bi-pause-circle"></i>Hold <span class="badge bg-info"> {{ $c['Hold'] ?? 0 }}</span></a>
                  </li>
                  <li class="nav-item" role="presentation">
                    <a class="nav-link" id="tab-onprocess" data-bs-toggle="tab" href="#tabpane-onprocess" role="tab" aria-controls="tabpane-onprocess" aria-selected="false"><i class="bi bi-hourglass-split"></i>On Process <span class="badge bg-info"> {{ $sumOnProcess }}</span></a>
                  </li>
                  <li class="nav-item" role="presentation">
                    <a class="nav-link" id="tab-arriveddate" data-bs-toggle="tab" href="#tabpane-arriveddate" role="tab" aria-controls="tabpane-arriveddate" aria-selected="false"><i class="bi bi-geo-alt"></i>Arrived Date <span class="badge bg-info"> {{ $c['Arrived Date'] ?? 0 }}</span></a>
                  </li>
                  <li class="nav-item" role="presentation">
                    <a class="nav-link" id="tab-incident-after-arrival" data-bs-toggle="tab" href="#tabpane-incident-after-arrival" role="tab" aria-controls="tabpane-incident-after-arrival" aria-selected="false"><i class="bi bi-exclamation-triangle-fill"></i>Incident After Arrival <span class="badge bg-info"> {{ $c['Incident After Arrival (IAA)'] ?? 0 }}</span></a>
                  </li>
                  <li class="nav-item" role="presentation">
                    <a class="nav-link" id="tab-transferdate" data-bs-toggle="tab" href="#tabpane-transferdate" role="tab" aria-controls="tabpane-transferdate" aria-selected="false"><i class="bi bi-arrow-left-right"></i>Transfer Date <span class="badge bg-info"> {{ $c['Transfer Date'] ?? 0 }}</span></a>
                  </li>
                </ul>

                <div class="subtabs-wrap" id="onProcessSubTabsWrap">
                  <ul class="nav" id="onProcessSubTabs" role="tablist">
                    <li class="nav-item"><a class="nav-link active" data-sub="Selected" id="sub-selected" href="#"><i class="bi bi-check-circle-fill"></i> Selected <span class="badge bg-secondary ms-1"> {{ $c['Selected'] ?? 0 }}</span></a></li>
                    <li class="nav-item"><a class="nav-link" data-sub="WC-Date" id="sub-wc-date" href="#"><i class="bi bi-calendar-date"></i> WC Date <span class="badge bg-secondary ms-1"> {{ $c['WC-Date'] ?? 0 }}</span></a></li>
                    <li class="nav-item"><a class="nav-link" data-sub="Incident Before Visa (IBV)" id="sub-ibv" href="#"><i class="bi bi-exclamation-circle"></i> Incident Before Visa <span class="badge bg-secondary ms-1"> {{ $c['Incident Before Visa (IBV)'] ?? 0 }}</span></a></li>
                    <li class="nav-item"><a class="nav-link" data-sub="Visa Date" id="sub-visa-date" href="#"><i class="bi bi-calendar-check"></i> Visa Date <span class="badge bg-secondary ms-1"> {{ $c['Visa Date'] ?? 0 }}</span></a></li>
                    <li class="nav-item"><a class="nav-link" data-sub="Incident After Visa (IAV)" id="sub-iav" href="#"><i class="bi bi-exclamation-diamond"></i> Incident After Visa <span class="badge bg-secondary ms-1"> {{ $c['Incident After Visa (IAV)'] ?? 0 }}</span></a></li>
                    <li class="nav-item"><a class="nav-link" data-sub="Medical Status" id="sub-medical" href="#"><i class="bi bi-heart-pulse"></i> Medical Status <span class="badge bg-secondary ms-1"> {{ $c['Medical Status'] ?? 0 }}</span></a></li>
                    <li class="nav-item"><a class="nav-link" data-sub="COC-Status" id="sub-coc" href="#"><i class="bi bi-briefcase"></i> COC Status <span class="badge bg-secondary ms-1"> {{ $c['COC-Status'] ?? 0 }}</span></a></li>
                    <li class="nav-item"><a class="nav-link" data-sub="MoL Submitted Date" id="sub-mol-sub" href="#"><i class="bi bi-upload"></i> MOL Submitted Date <span class="badge bg-secondary ms-1"> {{ $c['MoL Submitted Date'] ?? 0 }}</span></a></li>
                    <li class="nav-item"><a class="nav-link" data-sub="MoL Issued Date" id="sub-mol-iss" href="#"><i class="bi bi-file-earmark-check"></i> MOL Issued Date <span class="badge bg-secondary ms-1"> {{ $c['MoL Issued Date'] ?? 0 }}</span></a></li>
                    <li class="nav-item">
                      <a class="nav-link" id="sub-departure-date" data-sub="Departure Date" href="#" title="Departure Date">
                        ...
                        <span class="badge bg-secondary ms-2">{{ $c['Departure Date'] ?? 0 }}</span>
                      </a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link" id="sub-iad" data-sub="Incident After Departure (IAD)" href="#" title="Incident After Departure (IAD)">
                        ...
                        <span class="badge bg-secondary ms-2">{{ $c['Incident After Departure (IAD)'] ?? 0 }}</span>
                      </a>
                    </li>
              ...
              <div class="card-body">
                ...
                <div class="row g-3 mb-3">
                  <div class="col-lg-6">
                    ...
                    <input type="date" id="expectedArrivalDateOutside" name="expected_arrival_date" class="form-control" min="{{ date('Y-m-d') }}">
                  </div>
        ...
        <div class="modal-body">
          ...
          <div class="row g-3 mb-3">
            <div class="col-lg-6">
              ...
              <input type="date" id="wcDate" class="form-control" name="wc_date" value="{{ \Carbon\Carbon::now()->format('Y-m-d') }}">
            </div>
        ...
        <div class="modal-body">
          ...
          <div class="row g-3 mb-3">
            <div class="col-lg-6">
              ...
              <input type="date" id="visaDate" value="{{ \Carbon\Carbon::now()->format('Y-m-d') }}" class="form-control" name="visa_date" required>
            </div>
      ...
      <form id="transferDateForm" method="POST" enctype="multipart/form-data">
        ...
        <div class="modal-body">
          ...
          <div class="mb-3">
            ...
            <input type="date" id="transferDate" name="transfer_date" class="form-control" value="{{ \Carbon\Carbon::now()->format('Y-m-d') }}">
          </div>
...
(function ($) {
  ...
  window.updateStatus = function (selectElement, candidateId) {
    ...
    const updateStatusUrl = "{{ route('candidates.update-status',['candidate'=>':reference_no']) }}".replace(":reference_no", candidateId);
  ...
  window.loadimages = function (candidate_id) {
    ...
    $.ajax({
      url: '{{ route("candidates.loadimages") }}',
      type: "GET",
  ...
  $(function () {
    ...
    $("#export_excel")
      ...
      .on("click.exportExcel", function () {
        ...
        data._token = data._token || "{{ csrf_token() }}";
        ...
        $.ajax({
          ...
          if (!filename) filename = "{{ date('d-m-Y') }}_candidates.xlsx";
  ...
  $(function () {
    $("#save_wc_date")
      ...
      .on("click.saveWcDate", function () {
        ...
        $.ajax({
          url: '{{ route("candidates.update-wc-date") }}',
          type: "POST",
          data: formData,
          processData: false,
          contentType: false,
    ...
    $("#saveIncident")
      ...
      .on("click.saveIncidentBeforeVisa", function () {
        ...
        $.ajax({
          url: '{{ route("candidates.save-incident") }}',
          type: "POST",
          data: formData,
          processData: false,
          contentType: false,
    ...
    $("#saveVisaDetails")
      ...
      .on("click.saveVisaDetails", function () {
        ...
        $.ajax({
          url: '{{ route("candidates.update-visa-details") }}',
          type: "POST",
          data: formData,
          processData: false,
          contentType: false,
    ...
    $("#saveIncidentAfterVisa")
      ...
      .on("click.saveIncidentAfterVisa", function () {
        ...
        $.ajax({
          url: '{{ route("candidates.save-incident-after-visa") }}',
          type: "POST",
          data: formData,
          processData: false,
          contentType: false,
    ...
    $("#updateArrivedDateForm")
      ...
      .on("submit.updateArrivedDate", function (e) {
        ...
        $.ajax({
          url: '{{ route("candidates.update-arrived-date") }}',
          type: "POST",
          data: formData,
          processData: false,
          contentType: false,
    ...
    $("#saveIncidentAfterDeparture")
      ...
      .on("click.saveIncidentAfterDeparture", function () {
        ...
        $.ajax({
          url: '{{ route("candidates.save-incident-after-departure") }}',
          type: "POST",
          data: formData,
          processData: false,
          contentType: false
    ...
    $("#saveIncidentAfterArrival")
      ...
      .on("click.saveIncidentAfterArrival", function () {
        ...
        $.ajax({
          url: '{{ route("candidates.save-incident-after-arrival") }}',
          type: "POST",
          data: formData,
          processData: false,
          contentType: false,
    ...
    $("#saveTransferDateButton")
      ...
      .on("click.saveTransferDate", function () {
        ...
        $.ajax({
          url: '{{ route("candidates.saveTransferDate") }}',
          type: "POST",
          data: fd,
          processData: false,
          contentType: false
