                            ...
                            <div class="form-section">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="ref_no" class="form-control" id="inputRefNo" 
                                                   value="{{ old('ref_no', $refNo) }}" readonly>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    <div class="col-lg-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="first_name" class="form-control" id="inputFirstName" value="{{ old('first_name') }}" required>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        ...
                                        <div class="input-group">
                                            <span class="input-group-text"><i class="fas fa-user"></i></span>
                                            <input type="text" name="middle_name" class="form-control" id="inputMiddleName" value="{{ old('middle_name') }}">
                                        </div>
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <div class="col-lg-6">
                                        ...
                                        <div class="input-group">
                                            <span class="input-group-text"><i class="fas fa-user"></i></span>
                                            <input type="text" name="surname" class="form-control" id="inputSurname" value="{{ old('surname') }}" required>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="passport_number" class="form-control" id="inputPassportNo" value="{{ old('passport_number') }}" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <div class="col-lg-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="date" name="passport_expiry_date" class="form-control" id="inputPassportExpiry" value="{{ old('passport_expiry_date') }}" min="{{ date('Y-m-d') }}" required>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        ...
                                        <div class="input-group">
                                            <span class="input-group-text"><i class="fas fa-calendar"></i></span>
                                            <input type="date" name="date_of_birth" class="form-control" id="inputDateOfBirth" value="{{ old('date_of_birth') }}" max="{{ date('Y-m-d') }}" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <div class="col-lg-6">
                                        ...
                                        <div class="input-group">
                                            <span class="input-group-text"><i class="fas fa-calendar"></i></span>
                                            <input type="number" name="age" class="form-control" id="inputAge" value="{{ old('age') }}" readonly required>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="place_of_birth" class="form-control" id="inputPlaceOfBirth" value="{{ old('place_of_birth') }}" required>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <div class="input-group">
                                            <span class="input-group-text"><i class="fas fa-calendar"></i></span>
                                            <input type="date" name="labour_id_date" class="form-control" id="inputLabourIdDate" value="{{ old('labour_id_date') }}" min="{{ date('Y-m-d') }}" required>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    <div class="col-lg-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="labour_id_number" class="form-control" id="inputLabourIdNumber" placeholder="Enter labour ID number" value="{{ old('labour_id_number') }}" required>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <select class="form-select" name="english_skills" id="inputEnglishSkills">
                                                <option disabled value="">Choose...</option>
                                                <option value="Fluent" {{ old('english_skills') == 'Fluent' ? 'selected' : '' }}>Fluent</option>
                                                <option value="Good" {{ old('english_skills') == 'Good' ? 'selected' : '' }}>Good</option>
                                                <option value="Poor" {{ old('english_skills') == 'Poor' ? 'selected' : '' }}>Poor</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <select class="form-select" name="arabic_skills" id="inputArabicSkills">
                                                <option disabled value="">Choose...</option>
                                                <option value="Fluent" {{ old('arabic_skills') == 'Fluent' ? 'selected' : '' }}>Fluent</option>
                                                <option value="Good" {{ old('arabic_skills') == 'Good' ? 'selected' : '' }}>Good</option>
                                                <option value="Poor" {{ old('arabic_skills') == 'Poor' ? 'selected' : '' }}>Poor</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <select class="form-select" name="applied_position" id="inputAppliedPosition">
                                                ...
                                                @foreach ($appliedPositions as $position)
                                                    <option value="{{ $position->id }}" {{ old('applied_position') == $position->id ? 'selected' : '' }}>
                                        ...
                                        <div class="input-group">
                                            <select class="form-select select2" name="work_skill[]" id="inputWorkSkill" multiple>
                                                ...
                                                @foreach ($workSkills as $skill)
                                                    <option value="{{ $skill->id }}" {{ in_array($skill->id, old('work_skill', [])) ? 'selected' : '' }}>
                                                        {{ $skill->skill_name }}
                                                    </option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <select class="form-select" name="preferred_package" id="inputPreferredPackage">
                                                <option disabled value="">Choose...</option>
                                                <option value="PKG-1" {{ old('preferred_package') == 'PKG-1' ? 'selected' : '' }}>PKG-1</option>
                                                <option value="PKG-2" {{ old('preferred_package') == 'PKG-2' ? 'selected' : '' }}>PKG-2</option>
                                                <option value="PKG-3" {{ old('preferred_package') == 'PKG-3' ? 'selected' : '' }}>PKG-3</option>
                                                <option value="PKG-4" {{ old('preferred_package') == 'PKG-4' ? 'selected' : '' }}>PKG-4</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <div class="col-lg-6">
                                        ...
                                        <div class="input-group">
                                            <span class="input-group-text"><i class="fas fa-user"></i></span>
                                            <input type="text" name="number_of_children" value="{{ old('number_of_children', 0) }}" class="form-control" id="number_of_children" placeholder="Enter Number of children" required>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        ...
                                        <div class="input-group">
                                            <span class="input-group-text"><i class="fas fa-user"></i></span>
                                            <input type="text" name="sub_agent" value="{{ old('sub_agent') }}" class="form-control" id="sub_agent_field" placeholder="Enter Sub Agent" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="row mb-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <select name="current_status" id="current_status" class="form-select" required>
                                                ...
                                                @foreach ($currentStatuses as $status)
                                                    <option value="{{ $status->id }}" {{ old('current_status') == $status->id ? 'selected' : '' }}>
                                                        {{ $status->status_name }}
                                                    </option>
                                                @endforeach
                                            </select>
                                ...
                                <div class="row mb-3">
                                    <div class="col-lg-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="candidate_region" value="{{ old('candidate_region') }}" class="form-control" id="inputCandidateRegion" placeholder="Enter region" required>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="candidate_sub_city_zone" value="{{ old('candidate_sub_city_zone') }}" class="form-control" id="inputCandidateSubCityZone" placeholder="Enter sub city or zone" required>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    <div class="col-lg-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="candidate_woreda" value="{{ old('candidate_woreda') }}" class="form-control" id="inputCandidateWoreda" placeholder="Enter woreda" required>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="candidate_kebele" value="{{ old('candidate_kebele') }}" class="form-control" id="inputCandidateKebele" placeholder="Enter kebele" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <div class="col-lg-6">
                                        ...
                                        <div class="input-group">
                                            <span class="input-group-text"><i class="fas fa-home"></i></span>
                                            <input type="text" name="candidate_house_no" value="{{ old('candidate_house_no') }}" class="form-control" id="inputCandidateHouseNo" placeholder="Enter house number" required>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        ...
                                        <div class="input-group">
                                            <span class="input-group-text"><i class="fas fa-map-marker-alt"></i></span>
                                            <input type="text" name="candidate_current_address" value="{{ old('candidate_current_address') }}" class="form-control" id="inputCandidateCurrentAddress" placeholder="Enter current address" required>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="input-group">
                                            ...
                                            <select class="form-select" name="desired_country" id="inputDesiredCountry" onchange="fetchFraNames(this.value)" required>
                                                ...
                                                @foreach ($desiredCountries as $country)
                                                    <option value="{{ $country->id }}" {{ old('desired_country') == $country->id ? 'selected' : '' }}>
                                ...
                                <div class="row mb-3">
                                    <div class="col-lg-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="height" class="form-control" id="inputHeight" placeholder="Enter height in cm" required value="{{ old('height') }}">
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="weight" class="form-control" id="inputWeight" placeholder="Enter weight in kg" required value="{{ old('weight') }}">
                                        </div>
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <div class="col-lg-6">
                                        ...
                                        <div class="input-group">
                                            <span class="input-group-text"><i class="fas fa-calendar"></i></span>
                                            <input type="date" name="medical_date" class="form-control" id="inputMedicalDate" value="{{ old('medical_date') }}">
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <select class="form-select" name="medical_status" id="inputMedicalStatus">
                                                ...
                                                @foreach ($medicalStatuses as $status)
                                                    <option value="{{ $status->id }}" {{ old('medical_status') == $status->id ? 'selected' : '' }}>
                                                        {{ $status->status_name }}
                                                    </option>
                                                @endforeach
                                            </select>
                                ...
                                <div class="row mb-3">
                                    <div class="col-lg-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="hospital_name" class="form-control" id="inputHospitalName" placeholder="Enter hospital name" value="{{ old('hospital_name') }}">
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <select class="form-select" name="coc_status" id="inputCocStatus">
                                                ...
                                                @foreach ($cocStatuses as $status)
                                                    <option value="{{ $status->id }}" {{ old('coc_status') == $status->id ? 'selected' : '' }}>
                                                        {{ $status->status_name }}
                                                    </option>
                                                @endforeach
                                            </select>
                                ...
                                <div class="row mb-3">
                                    <div class="col-lg-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="date" name="pulled_date" class="form-control" id="inputPulledDate" value="{{ old('pulled_date') }}">
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        ...
                                        <div class="input-group">
                                            <span class="input-group-text"><i class="fas fa-calendar-check"></i></span>
                                            <input type="date" name="insurance_approved_date" class="form-control" id="inputInsuranceApprovedDate" value="{{ old('insurance_approved_date') }}">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    <div class="col-lg-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="family_name" class="form-control" id="inputFamilyName" placeholder="Enter family member's name" value="{{ old('family_name') }}" required>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="family_contact_number_1" class="form-control" id="inputFamilyContactNumber_1" placeholder="Enter contact number" value="{{ old('family_contact_number_1') }}" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <div class="col-lg-6">
                                        ...
                                        <div class="input-group">
                                            <span class="input-group-text"><i class="fas fa-phone"></i></span>
                                            <input type="text" name="family_contact_number_2" class="form-control" id="inputFamilyContactNumber_2" placeholder="Enter contact number" value="{{ old('family_contact_number_2') }}" required>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <select name="relationship_with_candidate" class="form-select" id="relationshipWithCandidate" required onchange="toggleOtherRelationshipField()">
                                                <option value="" disabled {{ old('relationship_with_candidate') ? '' : 'selected' }}>Select relationship</option>
                                                <optgroup label="Immediate Family">
                                                    <option value="Mother" {{ old('relationship_with_candidate') == 'Mother' ? 'selected' : '' }}>Mother</option>
                                                    <option value="Father" {{ old('relationship_with_candidate') == 'Father' ? 'selected' : '' }}>Father</option>
                                                    <option value="Brother" {{ old('relationship_with_candidate') == 'Brother' ? 'selected' : '' }}>Brother</option>
                                                    <option value="Sister" {{ old('relationship_with_candidate') == 'Sister' ? 'selected' : '' }}>Sister</option>
                                                    <option value="Husband" {{ old('relationship_with_candidate') == 'Husband' ? 'selected' : '' }}>Husband</option>
                                                </optgroup>
                                                <optgroup label="Extended Family">
                                                    <option value="Nephew" {{ old('relationship_with_candidate') == 'Nephew' ? 'selected' : '' }}>Nephew</option>
                                                    <option value="Sister in Law" {{ old('relationship_with_candidate') == 'Sister in Law' ? 'selected' : '' }}>Sister in Law</option>
                                                    <option value="Brother in Law" {{ old('relationship_with_candidate') == 'Brother in Law' ? 'selected' : '' }}>Brother in Law</option>
                                                    <option value="Grandma" {{ old('relationship_with_candidate') == 'Grandma' ? 'selected' : '' }}>Grandma</option>
                                                    <option value="Grandpa" {{ old('relationship_with_candidate') == 'Grandpa' ? 'selected' : '' }}>Grandpa</option>
                                                </optgroup>
                                                <option value="Other" {{ old('relationship_with_candidate') == 'Other' ? 'selected' : '' }}>Other</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                <div class="row mb-3" id="otherRelationshipField" style="display: {{ old('relationship_with_candidate') == 'Other' ? 'block' : 'none' }};">
                                    <div class="col-lg-6">
                                        <label for="otherRelationship" class="form-label">What is the other relation? <span style="color: red;">*</span></label>
                                        <div class="input-group">
                                            <span class="input-group-text"><i class="fas fa-question-circle"></i></span>
                                            <input type="text" name="other_relationship" class="form-control" id="otherRelationship" placeholder="Enter other relationship" value="{{ old('other_relationship') }}">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    <div class="col-lg-6">
                                        ...
                                        <div class="input-group">
                                            <span class="input-group-text"><i class="fas fa-map"></i></span>
                                            <input type="text" name="family_region" class="form-control" id="inputFamilyRegion" placeholder="Enter region" value="{{ old('family_region') }}" required>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        ...
                                        <div class="input-group">
                                            <span class="input-group-text"><i class="fas fa-city"></i></span>
                                            <input type="text" name="family_sub_city_zone" class="form-control" id="inputFamilySubCityZone" placeholder="Enter sub city or zone" value="{{ old('family_sub_city_zone') }}" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <div class="col-lg-6">
                                        ...
                                        <div class="input-group">
                                            <span class="input-group-text"><i class="fas fa-map-signs"></i></span>
                                            <input type="text" name="family_woreda" class="form-control" id="inputFamilyWoreda" placeholder="Enter woreda" value="{{ old('family_woreda') }}" required>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        ...
                                        <div class="input-group">
                                            <span class="input-group-text"><i class="fas fa-home"></i></span>
                                            <input type="text" name="family_kebele" class="form-control" id="inputFamilyKebele" placeholder="Enter kebele" value="{{ old('family_kebele') }}" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <div class="col-lg-6">
                                        ...
                                        <div class="input-group">
                                            <span class="input-group-text"><i class="fas fa-home"></i></span>
                                            <input type="text" name="family_house_no" class="form-control" id="inputFamilyHouseNo" placeholder="Enter house number" value="{{ old('family_house_no') }}" required>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        ...
                                        <div class="input-group">
                                            <span class="input-group-text"><i class="fas fa-map-marker-alt"></i></span>
                                            <input type="text" name="family_current_address" class="form-control" id="inputFamilyCurrentAddress" placeholder="Enter full address" value="{{ old('family_current_address') }}" required>
                                        </div>
                                    </div>
                                </div>
                            </div>
