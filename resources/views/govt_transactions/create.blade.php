      ...
      <div class="col-lg-12">
        <div class="card flex-fill">
          <div class="card-body" style="margin-top:10px">
            ...
            <form action="{{ route('govt-transactions.store') }}" method="POST" enctype="multipart/form-data" class="row g-3">
              @csrf
              ...
              <div class="col-md-4">
                ...
                <div class="input-group">
                  ...
                  <input type="text" class="form-control" value="{{ \Carbon\Carbon::now('Asia/Dubai')->format('d M Y') }}" readonly>
                  <input type="hidden" name="invoice_date" value="{{ \Carbon\Carbon::now('Asia/Dubai')->format('Y-m-d') }}">
                </div>
              </div>
              ...
              <div class="col-md-4">
                ...
                <div class="input-group">
                  ...
                  <select name="customer_type" id="customer_type" class="form-select" required>
                    ...
                    <option value="Indoor" {{ old('customer_type')=='Indoor'?'selected':'' }}>Indoor Customer</option>
                    <option value="Walking" {{ old('customer_type')=='Walking'?'selected':'' }}>Walking Customer</option>
                  </select>
                </div>
              </div>
