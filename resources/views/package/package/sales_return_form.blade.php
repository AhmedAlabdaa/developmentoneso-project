  ...
  <div class="content">
    ...
    <table class="table mt file-details">
      ...
      <tr>
        ...
        <td class="value">{{ $v($workDaysCount) }}</td>
        <td class="label">
      ...
      <tr>
        ...
        <td class="value">{{ $q($salaryDeductionNum) }}</td>
        <td class="label">
          CREDIT AVAILABLE
          <span style="font-weight:400;direction:rtl;text-align:right;font-size:10px;display:block">
        ...
        <td class="value money">{{ $q($refundAmountNum) }}</td>
      </tr>
      <tr>
        <td class="label">
          DUE DATE
        ...
        <td class="value">{{ $d($record->refund_replace_date ?? null) }}</td>
        <td class="label">
          VISA EXPIRY
          <span style="font-weight:400;direction:rtl;text-align:right;font-size:10px;display:block">
        ...
        <td class="value">{{ $d($record->visa_expiry ?? null) }}</td>
      </tr>
    </table>
